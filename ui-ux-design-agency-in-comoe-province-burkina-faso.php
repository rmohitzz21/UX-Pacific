...
$countrySlug = 'comoe-province-burkina-faso';
...
$pageTitle    = 'UI UX Design Agency in Comoé Province, Burkina Faso | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Comoé Province, Burkina Faso. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-comoe-province-burkina-faso';
$ogTitle      = 'UI UX Design Agency in Comoé Province, Burkina Faso | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Comoé Province, Burkina Faso? UX Pacific delivers modern, user-focused digital solutions.';
