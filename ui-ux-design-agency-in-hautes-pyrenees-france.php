...
$countrySlug = 'hautes-pyrenees-france';
...
$pageTitle    = 'UI UX Design Agency in Hautes-Pyrénées, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Hautes-Pyrénées, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-hautes-pyrenees-france';
$ogTitle      = 'UI UX Design Agency in Hautes-Pyrénées, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Hautes-Pyrénées, France? UX Pacific delivers modern, user-focused digital solutions.';
