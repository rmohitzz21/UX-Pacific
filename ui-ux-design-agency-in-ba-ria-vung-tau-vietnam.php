...
$countrySlug = 'ba-ria-vung-tau-vietnam';
...
$pageTitle    = 'UI UX Design Agency in Bà Rịa-Vũng Tàu, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Bà Rịa-Vũng Tàu, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ba-ria-vung-tau-vietnam';
$ogTitle      = 'UI UX Design Agency in Bà Rịa-Vũng Tàu, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Bà Rịa-Vũng Tàu, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
