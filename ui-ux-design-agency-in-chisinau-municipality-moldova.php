...
$countrySlug = 'chisinau-municipality-moldova';
...
$pageTitle    = 'UI UX Design Agency in Chișinău Municipality, Moldova | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Chișinău Municipality, Moldova. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-chisinau-municipality-moldova';
$ogTitle      = 'UI UX Design Agency in Chișinău Municipality, Moldova | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Chișinău Municipality, Moldova? UX Pacific delivers modern, user-focused digital solutions.';
