<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Eastern Province, Rwanda | UX Pacific';
$pageDesc        = 'Law 058/2021-aware UI/UX design for businesses in Eastern Province, Rwanda. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Eastern Province, UI UX Agency Eastern Province, UX Design Eastern Province Rwanda, UX Research Eastern Province, UX Audit Eastern Province, Usability Testing Eastern Province, UX Agency Eastern Province';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-eastern-province-rwanda';
$ogTitle         = 'UI UX Design Agency in Eastern Province, Rwanda | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving Eastern Province, Rwanda. Law 058/2021-compliant. UX research, usability testing, and product design. Get a free audit.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-eastern-province-rwanda';
$ogImage         = 'https://www.uxpacific.com/img/og-rwanda.jpg';
$ogLocale        = 'rw_RW';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Eastern Province, Rwanda?', 'a' => 'Yes. UX Pacific works with businesses in Eastern Province remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Rwanda, including Eastern Province.'],
  ['q' => 'How does Law 058/2021 affect UX design for businesses in Eastern Province?', 'a' => 'Law 058/2021 shapes how consent flows, privacy notices, and data collection forms are designed. We integrate Law 058/2021 requirements from day one, building user trust through transparent UX patterns rather than treating compliance as an afterthought.'],
  ...
  ['q' => 'How quickly do you respond to enquiries from Eastern Province?', 'a' => 'We respond to all qualified enquiries within one business day. We work across CAT (UTC+2) and are flexible on meeting times. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-eastern-province-rwanda#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-eastern-province-rwanda",
            "name": "UI UX Design Agency in Eastern Province, Rwanda | UX Pacific",
            "description": "Research-led UI/UX design agency serving Eastern Province, Rwanda with UX research, usability testing, and Law 058/2021-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Eastern Province",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-eastern-province-rwanda"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Eastern Province, Rwanda",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Eastern Province, Rwanda
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Eastern Province</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping businesses in Eastern Province, Rwanda make better product decisions through UX Research, Usability Testing, Product Discovery and Human-Centered UI Design. Law 058/2021-compliant. IST-friendly remote collaboration.</p>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Eastern Province, Rwanda</h2>
      <p class="t2-sub">Every engagement begins with users, evidence, and business goals. We serve companies in Eastern Province remotely — with structured UX research, usability testing, UI design, and Law 058/2021-compliant product design.</p>
    ...
    <div class="t2-wrap t2-section">
      ...
      <p class="t2-sub">Common questions from businesses in Eastern Province, Rwanda exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Eastern Province, Rwanda?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Eastern Province remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Rwanda, including Eastern Province.</div>
        </div>
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How does Law 058/2021 affect UX design for businesses in Eastern Province?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
