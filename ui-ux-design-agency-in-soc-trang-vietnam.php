...
$pageTitle    = 'UI UX Design Agency in Sóc Trăng, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Sóc Trăng, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-soc-trang-vietnam';
$ogTitle      = 'UI UX Design Agency in Sóc Trăng, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Sóc Trăng, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
