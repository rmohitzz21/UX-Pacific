...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Austria ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Austria</h2>
      <p class="hub-sub">We serve 9 regions, states, and cities in Austria. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
