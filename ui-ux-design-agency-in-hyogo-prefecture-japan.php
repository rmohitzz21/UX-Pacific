...
$countrySlug = 'hyogo-prefecture-japan';
...
$pageTitle    = 'UI UX Design Agency in Hyōgo Prefecture, Japan | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Hyōgo Prefecture, Japan. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-hyogo-prefecture-japan';
$ogTitle      = 'UI UX Design Agency in Hyōgo Prefecture, Japan | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Hyōgo Prefecture, Japan? UX Pacific delivers modern, user-focused digital solutions.';
