...
$countrySlug = 'western-division-fiji-islands';
...
$pageTitle    = 'UI UX Design Agency in Western Division, Fiji Islands | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Western Division, Fiji Islands. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-western-division-fiji-islands';
$ogTitle      = 'UI UX Design Agency in Western Division, Fiji Islands | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Western Division, Fiji Islands? UX Pacific delivers modern, user-focused digital solutions.';
