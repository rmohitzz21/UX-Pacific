...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Nigeria ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Nigeria</h2>
      <p class="hub-sub">We serve 37 regions, states, and cities in Nigeria. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
