...
$pageTitle    = 'UI UX Design Agency in Lạng Sơn, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Lạng Sơn, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-lang-son-vietnam';
$ogTitle      = 'UI UX Design Agency in Lạng Sơn, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Lạng Sơn, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
