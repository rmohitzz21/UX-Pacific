...
// Child locations in Timor-Leste
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Timor-Leste ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Timor-Leste</h2>
      <p class="hub-sub">We serve 12 regions, states, and cities in Timor-Leste. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
