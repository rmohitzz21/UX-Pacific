...
$countrySlug = 'andaman-and-nicobar-islands';
...
$pageTitle    = 'UI UX Design Agency in Andaman and Nicobar Islands | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Andaman and Nicobar Islands. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-andaman-and-nicobar-islands';
$ogTitle      = 'UI UX Design Agency in Andaman and Nicobar Islands | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Andaman and Nicobar Islands? UX Pacific delivers modern, user-focused digital solutions.';
