...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Liberia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Liberia</h2>
      <p class="hub-sub">We serve 15 regions, states, and cities in Liberia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
