...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Niger ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Niger</h2>
      <p class="hub-sub">We serve 7 regions, states, and cities in Niger. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
