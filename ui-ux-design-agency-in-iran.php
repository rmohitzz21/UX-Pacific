...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Iran ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Iran</h2>
      <p class="hub-sub">We serve 31 regions, states, and cities in Iran. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
