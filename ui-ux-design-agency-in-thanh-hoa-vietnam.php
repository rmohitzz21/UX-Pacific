...
$pageTitle    = 'UI UX Design Agency in Thanh Hóa, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Thanh Hóa, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-thanh-hoa-vietnam';
$ogTitle      = 'UI UX Design Agency in Thanh Hóa, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Thanh Hóa, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
