...
$pageTitle    = 'UI UX Design Agency in Ha\'il, Saudi Arabia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ha\'il, Saudi Arabia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-hail-saudi-arabia';
$ogTitle      = 'UI UX Design Agency in Ha\'il, Saudi Arabia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ha\'il, Saudi Arabia? UX Pacific delivers modern, user-focused digital solutions.';
