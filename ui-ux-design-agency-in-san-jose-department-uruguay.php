...
$countrySlug = 'san-jose-department-uruguay';
...
$pageTitle    = 'UI UX Design Agency in San José Department, Uruguay | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in San José Department, Uruguay. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-san-jose-department-uruguay';
$ogTitle      = 'UI UX Design Agency in San José Department, Uruguay | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in San José Department, Uruguay? UX Pacific delivers modern, user-focused digital solutions.';
