...
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Yazd, Iran. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-yazd-iran';
$ogTitle      = 'UI UX Design Agency in Yazd, Iran | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Yazd, Iran? UX Pacific delivers modern, user-focused digital solutions.';
