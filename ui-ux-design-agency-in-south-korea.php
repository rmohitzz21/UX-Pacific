...
// Child locations in South Korea
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in South Korea ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across South Korea</h2>
      <p class="hub-sub">We serve 17 regions, states, and cities in South Korea. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
