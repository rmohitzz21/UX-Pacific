...
$pageTitle    = 'UI UX Design Agency in Córdoba, Argentina | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Córdoba, Argentina. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-cordoba-argentina';
$ogTitle      = 'UI UX Design Agency in Córdoba, Argentina | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Córdoba, Argentina? UX Pacific delivers modern, user-focused digital solutions.';
