...
$countrySlug = 'baden-wurttemberg-germany';
...
$pageTitle    = 'UI UX Design Agency in Baden-Württemberg, Germany | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Baden-Württemberg, Germany. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-baden-wurttemberg-germany';
$ogTitle      = 'UI UX Design Agency in Baden-Württemberg, Germany | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Baden-Württemberg, Germany? UX Pacific delivers modern, user-focused digital solutions.';
