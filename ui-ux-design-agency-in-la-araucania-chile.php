...
$countrySlug = 'la-araucania-chile';
...
$pageTitle    = 'UI UX Design Agency in La Araucanía, Chile | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in La Araucanía, Chile. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-la-araucania-chile';
$ogTitle      = 'UI UX Design Agency in La Araucanía, Chile | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in La Araucanía, Chile? UX Pacific delivers modern, user-focused digital solutions.';
