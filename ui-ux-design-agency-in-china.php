...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in China ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across China</h2>
      <p class="hub-sub">We serve 34 regions, states, and cities in China. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
