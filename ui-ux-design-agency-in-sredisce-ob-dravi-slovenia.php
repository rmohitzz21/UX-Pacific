...
$countrySlug = 'sredisce-ob-dravi-slovenia';
...
$pageTitle    = 'UI UX Design Agency in Središče ob Dravi, Slovenia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Središče ob Dravi, Slovenia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-sredisce-ob-dravi-slovenia';
$ogTitle      = 'UI UX Design Agency in Središče ob Dravi, Slovenia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Središče ob Dravi, Slovenia? UX Pacific delivers modern, user-focused digital solutions.';
