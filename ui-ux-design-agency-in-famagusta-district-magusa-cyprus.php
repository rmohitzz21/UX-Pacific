...
$countrySlug = 'famagusta-district-magusa-cyprus';
...
$pageTitle    = 'UI UX Design Agency in Famagusta District (Mağusa), Cyprus | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Famagusta District (Mağusa), Cyprus. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-famagusta-district-magusa-cyprus';
$ogTitle      = 'UI UX Design Agency in Famagusta District (Mağusa), Cyprus | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Famagusta District (Mağusa), Cyprus? UX Pacific delivers modern, user-focused digital solutions.';
