...
$pageTitle    = 'UI UX Design Agency in Malé, Maldives | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Malé, Maldives. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-male-maldives';
$ogTitle      = 'UI UX Design Agency in Malé, Maldives | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Malé, Maldives? UX Pacific delivers modern, user-focused digital solutions.';
