...
$countrySlug = 'hawkes-bay-region-new-zealand';
...
$pageTitle    = 'UI UX Design Agency in Hawke\'s Bay Region, New Zealand | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Hawke\'s Bay Region, New Zealand. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-hawkes-bay-region-new-zealand';
$ogTitle      = 'UI UX Design Agency in Hawke\'s Bay Region, New Zealand | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Hawke\'s Bay Region, New Zealand? UX Pacific delivers modern, user-focused digital solutions.';
