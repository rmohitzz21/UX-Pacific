...
$pageTitle    = 'UI UX Design Agency in Khánh Hòa, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Khánh Hòa, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-khanh-hoa-vietnam';
$ogTitle      = 'UI UX Design Agency in Khánh Hòa, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Khánh Hòa, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
