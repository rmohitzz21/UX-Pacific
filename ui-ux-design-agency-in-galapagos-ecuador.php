...
$pageTitle    = 'UI UX Design Agency in Galápagos, Ecuador | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Galápagos, Ecuador. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-galapagos-ecuador';
$ogTitle      = 'UI UX Design Agency in Galápagos, Ecuador | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Galápagos, Ecuador? UX Pacific delivers modern, user-focused digital solutions.';
