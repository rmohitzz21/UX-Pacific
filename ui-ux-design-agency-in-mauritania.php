...
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Mauritania. We create user-friendly digital experiences for businesses.';
...
$ogDesc       = 'Looking for UI UX design services in Mauritania? UX Pacific delivers modern, user-focused digital solutions.';
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position: relative; overflow: hidden">
      ...
      <section class="hero">
        ...
        <p class="subtext">Professional UI UX Design Services in Mauritania for High-Converting Digital Products</p>
        <br />
    ...
    <div class="ux-content mt-5 mb-5">
      ...
      <p class="ux-description">
       We are a UI UX design agency offering services in Mauritania, helping startups and businesses build user-friendly digital products that improve engagement and conversions.
      </p>
    ...
    <div class="section-title" style="margin-top: 50px">
      ...
      <p class="ux-description">UI UX Design Services in Mauritania for Web, Mobile & Product Design.</p>
    </div>
    <style>
