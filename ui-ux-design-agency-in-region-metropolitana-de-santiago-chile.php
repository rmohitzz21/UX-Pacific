...
$countrySlug = 'region-metropolitana-de-santiago-chile';
...
$pageTitle    = 'UI UX Design Agency in Región Metropolitana de Santiago, Chile | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Región Metropolitana de Santiago, Chile. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-region-metropolitana-de-santiago-chile';
$ogTitle      = 'UI UX Design Agency in Región Metropolitana de Santiago, Chile | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Región Metropolitana de Santiago, Chile? UX Pacific delivers modern, user-focused digital solutions.';
