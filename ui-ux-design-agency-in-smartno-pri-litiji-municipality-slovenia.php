...
$countrySlug = 'smartno-pri-litiji-municipality-slovenia';
...
$pageTitle    = 'UI UX Design Agency in Šmartno pri Litiji Municipality, Slovenia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Šmartno pri Litiji Municipality, Slovenia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-smartno-pri-litiji-municipality-slovenia';
$ogTitle      = 'UI UX Design Agency in Šmartno pri Litiji Municipality, Slovenia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Šmartno pri Litiji Municipality, Slovenia? UX Pacific delivers modern, user-focused digital solutions.';
