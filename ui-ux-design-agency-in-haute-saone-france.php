...
$countrySlug = 'haute-saone-france';
...
$pageTitle    = 'UI UX Design Agency in Haute-Saône, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Haute-Saône, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-haute-saone-france';
$ogTitle      = 'UI UX Design Agency in Haute-Saône, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Haute-Saône, France? UX Pacific delivers modern, user-focused digital solutions.';
