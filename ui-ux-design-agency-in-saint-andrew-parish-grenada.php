<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Saint Andrew Parish, Grenada | UX Pacific';
$pageDesc        = 'ECSC Model Law-aware UI/UX design for businesses in Saint Andrew Parish, Grenada. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Saint Andrew Parish, UI UX Agency Saint Andrew Parish, UX Design Saint Andrew Parish Grenada, UX Research Saint Andrew Parish, UX Audit Saint Andrew Parish, Usability Testing Saint Andrew Parish, UX Agency Saint Andrew Parish';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-saint-andrew-parish-grenada';
$ogTitle         = 'UI UX Design Agency in Saint Andrew Parish, Grenada | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving Saint Andrew Parish, Grenada. ECSC Model Law-compliant. UX research, usability testing, and product design. Get a free ';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-saint-andrew-parish-grenada';
$ogImage         = 'https://www.uxpacific.com/img/og-grenada.jpg';
$ogLocale        = 'en_GD';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Saint Andrew Parish, Grenada?', 'a' => 'Yes. UX Pacific works with businesses in Saint Andrew Parish remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Grenada, including Saint Andrew Parish.'],
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-andrew-parish-grenada#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-andrew-parish-grenada",
            "name": "UI UX Design Agency in Saint Andrew Parish, Grenada | UX Pacific",
            "description": "Research-led UI/UX design agency serving Saint Andrew Parish, Grenada with UX research, usability testing, and ECSC Model Law-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Saint Andrew Parish",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-andrew-parish-grenada"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Saint Andrew Parish, Grenada",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Saint Andrew Parish, Grenada</h2>
    ...
    <div class="t2-wrap t2-section">
      ...
      <p class="t2-sub">Common questions from businesses in Saint Andrew Parish, Grenada exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Saint Andrew Parish, Grenada?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Saint Andrew Parish remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Grenada, including Saint Andrew Parish.</div>
        </div>
        <div class="t2-faq-item">
