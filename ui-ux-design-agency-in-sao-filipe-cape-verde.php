...
$countrySlug = 'sao-filipe-cape-verde';
...
$pageTitle    = 'UI UX Design Agency in São Filipe, Cape Verde | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in São Filipe, Cape Verde. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-sao-filipe-cape-verde';
$ogTitle      = 'UI UX Design Agency in São Filipe, Cape Verde | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in São Filipe, Cape Verde? UX Pacific delivers modern, user-focused digital solutions.';
