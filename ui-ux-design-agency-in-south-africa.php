...
// Child locations in South Africa
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in South Africa ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across South Africa</h2>
      <p class="hub-sub">We serve 9 regions, states, and cities in South Africa. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
