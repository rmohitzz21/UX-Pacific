...
$pageDesc    = 'UX Pacific delivers expert UI/UX design services across Germany. Browse our locations or book a free UX audit today.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-germany';
$ogTitle     = 'UI UX Design Agency in Germany | UX Pacific';
$ogDesc      = 'UX Pacific delivers expert UI/UX design services across Germany. Browse our locations or book a free UX audit today.';
...
// Child locations in Germany
$hubChildren = [
  ['name' => 'Baden-Württemberg', 'url' => '/ui-ux-design-agency-in-baden-wurttemberg-germany', 'basename' => 'ui-ux-design-agency-in-baden-wurttemberg-germany'],
  ['name' => 'Bavaria', 'url' => '/ui-ux-design-agency-in-bavaria-germany', 'basename' => 'ui-ux-design-agency-in-bavaria-germany'],
  ['name' => 'Berlin', 'url' => '/ui-ux-design-agency-in-berlin-germany', 'basename' => 'ui-ux-design-agency-in-berlin-germany'],
  ['name' => 'Brandenburg', 'url' => '/ui-ux-design-agency-in-brandenburg-germany', 'basename' => 'ui-ux-design-agency-in-brandenburg-germany'],
  ['name' => 'Bremen', 'url' => '/ui-ux-design-agency-in-bremen-germany', 'basename' => 'ui-ux-design-agency-in-bremen-germany'],
  ['name' => 'Hamburg', 'url' => '/ui-ux-design-agency-in-hamburg-germany', 'basename' => 'ui-ux-design-agency-in-hamburg-germany'],
  ['name' => 'Hesse', 'url' => '/ui-ux-design-agency-in-hesse-germany', 'basename' => 'ui-ux-design-agency-in-hesse-germany'],
  ['name' => 'Lower Saxony', 'url' => '/ui-ux-design-agency-in-lower-saxony-germany', 'basename' => 'ui-ux-design-agency-in-lower-saxony-germany'],
  ['name' => 'Mecklenburg-Vorpommern', 'url' => '/ui-ux-design-agency-in-mecklenburg-vorpommern-germany', 'basename' => 'ui-ux-design-agency-in-mecklenburg-vorpommern-germany'],
  ['name' => 'North Rhine-Westphalia', 'url' => '/ui-ux-design-agency-in-north-rhine-westphalia-germany', 'basename' => 'ui-ux-design-agency-in-north-rhine-westphalia-germany'],
  ['name' => 'Rhineland-Palatinate', 'url' => '/ui-ux-design-agency-in-rhineland-palatinate-germany', 'basename' => 'ui-ux-design-agency-in-rhineland-palatinate-germany'],
  ['name' => 'Saarland', 'url' => '/ui-ux-design-agency-in-saarland-germany', 'basename' => 'ui-ux-design-agency-in-saarland-germany'],
  ['name' => 'Saxony-Anhalt', 'url' => '/ui-ux-design-agency-in-saxony-anhalt-germany', 'basename' => 'ui-ux-design-agency-in-saxony-anhalt-germany'],
  ['name' => 'Saxony', 'url' => '/ui-ux-design-agency-in-saxony-germany', 'basename' => 'ui-ux-design-agency-in-saxony-germany'],
  ['name' => 'Schleswig-Holstein', 'url' => '/ui-ux-design-agency-in-schleswig-holstein-germany', 'basename' => 'ui-ux-design-agency-in-schleswig-holstein-germany'],
  ['name' => 'Thuringia', 'url' => '/ui-ux-design-agency-in-thuringia-germany', 'basename' => 'ui-ux-design-agency-in-thuringia-germany'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Germany ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Germany</h2>
      <p class="hub-sub">We serve 16 regions, states, and cities in Germany. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
