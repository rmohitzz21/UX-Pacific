...
$pageTitle    = 'UI UX Design Agency in Bình Định, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Bình Định, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-binh-inh-vietnam';
$ogTitle      = 'UI UX Design Agency in Bình Định, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Bình Định, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
