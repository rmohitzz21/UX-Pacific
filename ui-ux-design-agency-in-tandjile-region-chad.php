...
$countrySlug = 'tandjile-region-chad';
...
$pageTitle    = 'UI UX Design Agency in Tandjilé Region, Chad | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Tandjilé Region, Chad. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-tandjile-region-chad';
$ogTitle      = 'UI UX Design Agency in Tandjilé Region, Chad | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Tandjilé Region, Chad? UX Pacific delivers modern, user-focused digital solutions.';
