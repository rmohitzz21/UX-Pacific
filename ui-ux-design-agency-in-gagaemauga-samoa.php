...
$pageTitle    = 'UI UX Design Agency in Gaga\'emauga, Samoa | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Gaga\'emauga, Samoa. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-gagaemauga-samoa';
$ogTitle      = 'UI UX Design Agency in Gaga\'emauga, Samoa | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Gaga\'emauga, Samoa? UX Pacific delivers modern, user-focused digital solutions.';
