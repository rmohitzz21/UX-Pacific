...
$countrySlug = 'potosi-department-bolivia';
...
$pageTitle    = 'UI UX Design Agency in Potosí Department, Bolivia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Potosí Department, Bolivia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-potosi-department-bolivia';
$ogTitle      = 'UI UX Design Agency in Potosí Department, Bolivia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Potosí Department, Bolivia? UX Pacific delivers modern, user-focused digital solutions.';
