...
$pageTitle    = 'UI UX Design Agency in Birżebbuġa, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Birżebbuġa, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-birzebbuga-malta';
$ogTitle      = 'UI UX Design Agency in Birżebbuġa, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Birżebbuġa, Malta? UX Pacific delivers modern, user-focused digital solutions.';
