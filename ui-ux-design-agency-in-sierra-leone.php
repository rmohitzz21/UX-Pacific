...
// Child locations in Sierra Leone
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Sierra Leone ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Sierra Leone</h2>
      <p class="hub-sub">We serve 4 regions, states, and cities in Sierra Leone. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
