...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Finland ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Finland</h2>
      <p class="hub-sub">We serve 21 regions, states, and cities in Finland. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
