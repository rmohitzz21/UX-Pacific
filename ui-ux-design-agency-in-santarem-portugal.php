...
$pageTitle    = 'UI UX Design Agency in Santarém, Portugal | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Santarém, Portugal. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-santarem-portugal';
$ogTitle      = 'UI UX Design Agency in Santarém, Portugal | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Santarém, Portugal? UX Pacific delivers modern, user-focused digital solutions.';
