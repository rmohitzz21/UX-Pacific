...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Bulgaria ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Bulgaria</h2>
      <p class="hub-sub">We serve 28 regions, states, and cities in Bulgaria. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
