...
$countrySlug = 'thies-region-senegal';
...
$pageTitle    = 'UI UX Design Agency in Thiès Region, Senegal | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Thiès Region, Senegal. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-thies-region-senegal';
$ogTitle      = 'UI UX Design Agency in Thiès Region, Senegal | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Thiès Region, Senegal? UX Pacific delivers modern, user-focused digital solutions.';
