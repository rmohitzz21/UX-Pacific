...
$pageTitle    = 'UI UX Design Agency in Caquetá, Colombia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Caquetá, Colombia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-caqueta-colombia';
$ogTitle      = 'UI UX Design Agency in Caquetá, Colombia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Caquetá, Colombia? UX Pacific delivers modern, user-focused digital solutions.';
