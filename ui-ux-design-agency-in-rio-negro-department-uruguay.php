...
$countrySlug = 'rio-negro-department-uruguay';
...
$pageTitle    = 'UI UX Design Agency in Río Negro Department, Uruguay | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Río Negro Department, Uruguay. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-rio-negro-department-uruguay';
$ogTitle      = 'UI UX Design Agency in Río Negro Department, Uruguay | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Río Negro Department, Uruguay? UX Pacific delivers modern, user-focused digital solutions.';
