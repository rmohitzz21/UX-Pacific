...
$pageTitle    = 'UI UX Design Agency in Mġarr, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Mġarr, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-mgarr-malta';
$ogTitle      = 'UI UX Design Agency in Mġarr, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Mġarr, Malta? UX Pacific delivers modern, user-focused digital solutions.';
