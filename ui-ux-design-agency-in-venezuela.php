...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Venezuela ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Venezuela</h2>
      <p class="hub-sub">We serve 25 regions, states, and cities in Venezuela. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
