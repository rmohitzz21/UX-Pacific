...
$pageTitle    = 'UI UX Design Agency in Østfold, Norway | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Østfold, Norway. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-stfold-norway';
$ogTitle      = 'UI UX Design Agency in Østfold, Norway | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Østfold, Norway? UX Pacific delivers modern, user-focused digital solutions.';
