...
$countrySlug = 'koprivnica-krizevci-county-croatia';
...
$pageTitle    = 'UI UX Design Agency in Koprivnica-Križevci County, Croatia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Koprivnica-Križevci County, Croatia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-koprivnica-krizevci-county-croatia';
$ogTitle      = 'UI UX Design Agency in Koprivnica-Križevci County, Croatia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Koprivnica-Križevci County, Croatia? UX Pacific delivers modern, user-focused digital solutions.';
