...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Taiwan ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Taiwan</h2>
      <p class="hub-sub">We serve 22 regions, states, and cities in Taiwan. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
