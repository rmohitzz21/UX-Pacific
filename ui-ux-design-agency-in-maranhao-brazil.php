...
$pageTitle    = 'UI UX Design Agency in Maranhão, Brazil | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Maranhão, Brazil. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-maranhao-brazil';
$ogTitle      = 'UI UX Design Agency in Maranhão, Brazil | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Maranhão, Brazil? UX Pacific delivers modern, user-focused digital solutions.';
