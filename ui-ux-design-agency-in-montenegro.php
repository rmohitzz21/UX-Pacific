...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Montenegro ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Montenegro</h2>
      <p class="hub-sub">We serve 22 regions, states, and cities in Montenegro. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
