...
$countrySlug = 'me-imurje-county-croatia';
...
$pageTitle    = 'UI UX Design Agency in Međimurje County, Croatia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Međimurje County, Croatia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-me-imurje-county-croatia';
$ogTitle      = 'UI UX Design Agency in Međimurje County, Croatia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Međimurje County, Croatia? UX Pacific delivers modern, user-focused digital solutions.';
