...
$countrySlug = 'paijanne-tavastia-finland';
...
$pageTitle    = 'UI UX Design Agency in Päijänne Tavastia, Finland | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Päijänne Tavastia, Finland. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-paijanne-tavastia-finland';
$ogTitle      = 'UI UX Design Agency in Päijänne Tavastia, Finland | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Päijänne Tavastia, Finland? UX Pacific delivers modern, user-focused digital solutions.';
