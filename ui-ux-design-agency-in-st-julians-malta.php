...
$pageTitle    = 'UI UX Design Agency in St. Julian\'s, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in St. Julian\'s, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-st-julians-malta';
$ogTitle      = 'UI UX Design Agency in St. Julian\'s, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in St. Julian\'s, Malta? UX Pacific delivers modern, user-focused digital solutions.';
