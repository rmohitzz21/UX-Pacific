...
$pageTitle    = 'UI UX Design Agency in Bến Tre, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Bến Tre, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ben-tre-vietnam';
$ogTitle      = 'UI UX Design Agency in Bến Tre, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Bến Tre, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
