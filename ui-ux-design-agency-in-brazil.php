...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Brazil ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Brazil</h2>
      <p class="hub-sub">We serve 27 regions, states, and cities in Brazil. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
