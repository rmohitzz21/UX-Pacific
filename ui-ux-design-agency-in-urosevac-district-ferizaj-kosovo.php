...
$countrySlug = 'urosevac-district-ferizaj-kosovo';
...
$pageTitle    = 'UI UX Design Agency in Uroševac District (Ferizaj), Kosovo | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Uroševac District (Ferizaj), Kosovo. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-urosevac-district-ferizaj-kosovo';
$ogTitle      = 'UI UX Design Agency in Uroševac District (Ferizaj), Kosovo | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Uroševac District (Ferizaj), Kosovo? UX Pacific delivers modern, user-focused digital solutions.';
