...
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Sud, Haiti. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-sud-haiti';
$ogTitle      = 'UI UX Design Agency in Sud, Haiti | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Sud, Haiti? UX Pacific delivers modern, user-focused digital solutions.';
