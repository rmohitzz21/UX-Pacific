...
$countrySlug = 'chiriqui-province-panama';
...
$pageTitle    = 'UI UX Design Agency in Chiriquí Province, Panama | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Chiriquí Province, Panama. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-chiriqui-province-panama';
$ogTitle      = 'UI UX Design Agency in Chiriquí Province, Panama | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Chiriquí Province, Panama? UX Pacific delivers modern, user-focused digital solutions.';
