...
$pageTitle    = 'UI UX Design Agency in Żebbuġ Gozo, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Żebbuġ Gozo, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-zebbug-gozo-malta';
$ogTitle      = 'UI UX Design Agency in Żebbuġ Gozo, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Żebbuġ Gozo, Malta? UX Pacific delivers modern, user-focused digital solutions.';
