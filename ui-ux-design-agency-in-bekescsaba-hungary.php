...
$countrySlug = 'bekescsaba-hungary';
...
$pageTitle    = 'UI UX Design Agency in Békéscsaba, Hungary | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Békéscsaba, Hungary. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-bekescsaba-hungary';
$ogTitle      = 'UI UX Design Agency in Békéscsaba, Hungary | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Békéscsaba, Hungary? UX Pacific delivers modern, user-focused digital solutions.';
