...
$countrySlug = 'vastmanland-county-sweden';
...
$pageTitle    = 'UI UX Design Agency in Västmanland County, Sweden | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Västmanland County, Sweden. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-vastmanland-county-sweden';
$ogTitle      = 'UI UX Design Agency in Västmanland County, Sweden | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Västmanland County, Sweden? UX Pacific delivers modern, user-focused digital solutions.';
