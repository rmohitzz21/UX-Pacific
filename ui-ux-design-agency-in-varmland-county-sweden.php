...
$countrySlug = 'varmland-county-sweden';
...
$pageTitle    = 'UI UX Design Agency in Värmland County, Sweden | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Värmland County, Sweden. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-varmland-county-sweden';
$ogTitle      = 'UI UX Design Agency in Värmland County, Sweden | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Värmland County, Sweden? UX Pacific delivers modern, user-focused digital solutions.';
