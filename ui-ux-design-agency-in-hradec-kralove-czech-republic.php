...
$countrySlug = 'hradec-kralove-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Hradec Králové, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Hradec Králové, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-hradec-kralove-czech-republic';
$ogTitle      = 'UI UX Design Agency in Hradec Králové, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Hradec Králové, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
