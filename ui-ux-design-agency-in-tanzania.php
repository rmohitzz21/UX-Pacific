...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Tanzania ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Tanzania</h2>
      <p class="hub-sub">We serve 31 regions, states, and cities in Tanzania. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
