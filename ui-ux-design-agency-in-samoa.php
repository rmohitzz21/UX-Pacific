...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Samoa ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Samoa</h2>
      <p class="hub-sub">We serve 11 regions, states, and cities in Samoa. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
