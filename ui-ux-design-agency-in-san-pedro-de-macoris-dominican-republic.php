...
$countrySlug = 'san-pedro-de-macoris-dominican-republic';
...
$pageTitle    = 'UI UX Design Agency in San Pedro de Macorís, Dominican Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in San Pedro de Macorís, Dominican Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-san-pedro-de-macoris-dominican-republic';
$ogTitle      = 'UI UX Design Agency in San Pedro de Macorís, Dominican Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in San Pedro de Macorís, Dominican Republic? UX Pacific delivers modern, user-focused digital solutions.';
