...
// Child locations in Fiji Islands
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Fiji Islands ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Fiji Islands</h2>
      <p class="hub-sub">We serve 19 regions, states, and cities in Fiji Islands. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
