...
$countrySlug = 'cesky-krumlov-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Český Krumlov, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Český Krumlov, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-cesky-krumlov-czech-republic';
$ogTitle      = 'UI UX Design Agency in Český Krumlov, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Český Krumlov, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
