...
$pageTitle    = 'UI UX Design Agency in Pietà, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Pietà, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-pieta-malta';
$ogTitle      = 'UI UX Design Agency in Pietà, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Pietà, Malta? UX Pacific delivers modern, user-focused digital solutions.';
