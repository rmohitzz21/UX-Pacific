...
$countrySlug = 'jesenik-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Jeseník, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Jeseník, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-jesenik-czech-republic';
$ogTitle      = 'UI UX Design Agency in Jeseník, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Jeseník, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
