<?php
$countrySlug     = 'spain';
$pageTitle       = 'UI UX Design Agency in Spain | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Spain. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Spain, UI UX Agency Spain, UX Design Spain, UX Research Spain, UI Design Spain, Product Design Spain, UX Audit Spain, Usability Testing Spain, UX Consultant Spain, UX Company Spain, Design System Spain';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-spain';
$ogTitle         = 'UI UX Design Agency in Spain | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Spain. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-spain';
$ogImage         = 'https://www.uxpacific.com/img/og-spain.jpg';
$ogLocale        = 'es_ES';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Spain?', 'a' => 'Yes. UX Pacific supports Spain businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Spain.'],
  ['q' => 'How does GDPR / LOPDGDD affect UX design for Spain businesses?', 'a' => 'GDPR / LOPDGDD directly shapes consent flows, data collection forms, and privacy communications. We integrate GDPR / LOPDGDD requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Spain?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Spain?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Spain. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Spain business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Spain accessibility standards like UNE 139803 / WCAG 2.1?', 'a' => 'Yes. We design to UNE 139803 / WCAG 2.1 as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Spain. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Spain businesses expect.'],
  ['q' => 'How does remote collaboration work for Spain clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Spain clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Spain?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-spain#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-spain',
      'name'          => 'UI UX Design Agency in Spain | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Spain. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
      'datePublished' => '2026-06-26',
      'dateModified'  => '2026-06-29',
      'about'         => ['@type' => 'Country', 'name' => 'Spain'],
    ],
    [
      '@type'           => 'BreadcrumbList',
      'itemListElement' => [
        ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home',      'item' => 'https://www.uxpacific.com/'],
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Spain',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-spain'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Spain',
      'provider'    => ['@id' => 'https://www.uxpacific.com/#organization'],
      'areaServed'  => ['@type' => 'Country', 'name' => 'Spain'],
      'serviceType' => 'UI UX Design, UX Research, Usability Testing, UX Audit, Product Discovery, Design Systems, GDPR / LOPDGDD-Compliant UX',
      'url'         => 'https://www.uxpacific.com/ui-ux-design-agency-in-spain',
    ],
...
$hubChildren = [
  ['name' => 'Andalusia', 'url' => '/ui-ux-design-agency-in-andalusia-spain', 'basename' => 'ui-ux-design-agency-in-andalusia-spain'],
  ['name' => 'Aragon', 'url' => '/ui-ux-design-agency-in-aragon-spain', 'basename' => 'ui-ux-design-agency-in-aragon-spain'],
  ['name' => 'Asturias', 'url' => '/ui-ux-design-agency-in-asturias-spain', 'basename' => 'ui-ux-design-agency-in-asturias-spain'],
  ['name' => 'Ávila', 'url' => '/ui-ux-design-agency-in-avila-spain', 'basename' => 'ui-ux-design-agency-in-avila-spain'],
  ['name' => 'Balearic Islands', 'url' => '/ui-ux-design-agency-in-balearic-islands-spain', 'basename' => 'ui-ux-design-agency-in-balearic-islands-spain'],
  ['name' => 'Basque Country', 'url' => '/ui-ux-design-agency-in-basque-country-spain', 'basename' => 'ui-ux-design-agency-in-basque-country-spain'],
  ['name' => 'Burgos Province', 'url' => '/ui-ux-design-agency-in-burgos-province-spain', 'basename' => 'ui-ux-design-agency-in-burgos-province-spain'],
  ['name' => 'Canary Islands', 'url' => '/ui-ux-design-agency-in-canary-islands-spain', 'basename' => 'ui-ux-design-agency-in-canary-islands-spain'],
  ['name' => 'Cantabria', 'url' => '/ui-ux-design-agency-in-cantabria-spain', 'basename' => 'ui-ux-design-agency-in-cantabria-spain'],
  ['name' => 'Castile and León', 'url' => '/ui-ux-design-agency-in-castile-and-leon-spain', 'basename' => 'ui-ux-design-agency-in-castile-and-leon-spain'],
  ['name' => 'Castilla La Mancha', 'url' => '/ui-ux-design-agency-in-castilla-la-mancha-spain', 'basename' => 'ui-ux-design-agency-in-castilla-la-mancha-spain'],
  ['name' => 'Catalonia', 'url' => '/ui-ux-design-agency-in-catalonia-spain', 'basename' => 'ui-ux-design-agency-in-catalonia-spain'],
  ['name' => 'Ceuta', 'url' => '/ui-ux-design-agency-in-ceuta-spain', 'basename' => 'ui-ux-design-agency-in-ceuta-spain'],
  ['name' => 'Extremadura', 'url' => '/ui-ux-design-agency-in-extremadura-spain', 'basename' => 'ui-ux-design-agency-in-extremadura-spain'],
  ['name' => 'Galicia', 'url' => '/ui-ux-design-agency-in-galicia-spain', 'basename' => 'ui-ux-design-agency-in-galicia-spain'],
  ['name' => 'La Rioja', 'url' => '/ui-ux-design-agency-in-la-rioja-spain', 'basename' => 'ui-ux-design-agency-in-la-rioja-spain'],
  ['name' => 'Léon', 'url' => '/ui-ux-design-agency-in-leon-spain', 'basename' => 'ui-ux-design-agency-in-leon-spain'],
  ['name' => 'Madrid', 'url' => '/ui-ux-design-agency-in-madrid-spain', 'basename' => 'ui-ux-design-agency-in-madrid-spain'],
  ['name' => 'Melilla', 'url' => '/ui-ux-design-agency-in-melilla-spain', 'basename' => 'ui-ux-design-agency-in-melilla-spain'],
  ['name' => 'Murcia', 'url' => '/ui-ux-design-agency-in-murcia-spain', 'basename' => 'ui-ux-design-agency-in-murcia-spain'],
  ['name' => 'Navarra', 'url' => '/ui-ux-design-agency-in-navarra-spain', 'basename' => 'ui-ux-design-agency-in-navarra-spain'],
  ['name' => 'Palencia Province', 'url' => '/ui-ux-design-agency-in-palencia-province-spain', 'basename' => 'ui-ux-design-agency-in-palencia-province-spain'],
  ['name' => 'Salamanca Province', 'url' => '/ui-ux-design-agency-in-salamanca-province-spain', 'basename' => 'ui-ux-design-agency-in-salamanca-province-spain'],
  ['name' => 'Segovia Province', 'url' => '/ui-ux-design-agency-in-segovia-province-spain', 'basename' => 'ui-ux-design-agency-in-segovia-province-spain'],
  ['name' => 'Soria Province', 'url' => '/ui-ux-design-agency-in-soria-province-spain', 'basename' => 'ui-ux-design-agency-in-soria-province-spain'],
  ['name' => 'Valencia', 'url' => '/ui-ux-design-agency-in-valencia-spain', 'basename' => 'ui-ux-design-agency-in-valencia-spain'],
  ['name' => 'Valladolid Province', 'url' => '/ui-ux-design-agency-in-valladolid-province-spain', 'basename' => 'ui-ux-design-agency-in-valladolid-province-spain'],
  ['name' => 'Zamora Province', 'url' => '/ui-ux-design-agency-in-zamora-province-spain', 'basename' => 'ui-ux-design-agency-in-zamora-province-spain'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Spain
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Spain</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Spain startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Spain businesses.</p>
      ...
      <div class="de-grid de-grid-4" style="margin-top:1.8rem">
        ...
        <div class="de-card">
          <span class="de-card-icon">&#128737;</span>
          <h3>GDPR / LOPDGDD-Aware Approach</h3>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Spain Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          ...
          <p>High-fidelity Figma screens and interactive prototypes — responsive across desktop and mobile, built to UNE 139803 / WCAG 2.1 standards, ready for developer handoff.</p>
        </div>
        <div class="de-svc">
          <h3>GDPR / LOPDGDD-Compliant UX</h3>
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Spain regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          <h3>Accessibility (UNE 139803 / WCAG 2.1)</h3>
          <p>Design to UNE 139803 / WCAG 2.1 standards — ensuring your product reaches every user and meets Spain regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Spain.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to UNE 139803 / WCAG 2.1 standards and GDPR / LOPDGDD-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, GDPR / LOPDGDD compliance risks, and navigation problems — each prioritised by business impact.</p></div>
        ...
        <div class="de-card"><div class="de-dlv-icon">&#128187;</div><h3>UI Screens</h3><p>High-fidelity Figma screens designed to UNE 139803 / WCAG 2.1 accessibility standards, responsive across desktop and mobile — production-quality from day one.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Most agencies start with screens. We start with research. Here is what that difference looks like in practice for Spain businesses.</p>
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>GDPR / LOPDGDD and accessibility treated as afterthoughts</td><td>GDPR / LOPDGDD compliance and UNE 139803 / WCAG 2.1 accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <p class="de-sub">A structured, transparent workflow designed for Spain and international teams that need clarity, speed, and reliable communication at every stage.</p>
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and GDPR / LOPDGDD requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Spain</h2>
      <p class="de-sub">Common questions from Spain startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services Across Spain</h2>
      <p class="de-sub">We serve businesses in 28 regions, states, and cities in Spain. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Spain Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and GDPR / LOPDGDD compliance.</p></div>
          </div>
          <div class="de-proc-step">
