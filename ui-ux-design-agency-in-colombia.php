...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Colombia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Colombia</h2>
      <p class="hub-sub">We serve 33 regions, states, and cities in Colombia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
