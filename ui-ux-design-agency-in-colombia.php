...
$pageTitle       = 'UI UX Design Agency in Colombia | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Colombia. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Colombia, UI UX Agency Colombia, UX Design Colombia, UX Research Colombia, UI Design Colombia, Product Design Colombia, UX Audit Colombia, Usability Testing Colombia, UX Consultant Colombia, UX Company Colombia, Design System Colombia';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-colombia';
$ogTitle         = 'UI UX Design Agency in Colombia | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Colombia. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-colombia';
$ogImage         = 'https://www.uxpacific.com/img/og-colombia.jpg';
$ogLocale        = 'es_CO';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Colombia?', 'a' => 'Yes. UX Pacific supports Colombia businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Colombia.'],
  ['q' => 'How does Law 1581 affect UX design for Colombia businesses?', 'a' => 'Law 1581 directly shapes consent flows, data collection forms, and privacy communications. We integrate Law 1581 requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Colombia?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Colombia?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Colombia. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Colombia business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Colombia accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Colombia. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Colombia businesses expect.'],
  ['q' => 'How does remote collaboration work for Colombia clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Colombia clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Colombia?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-colombia#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-colombia',
      'name'          => 'UI UX Design Agency in Colombia | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Colombia. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
    ...
    [
      ...
      'itemListElement' => [
        ...
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Colombia',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-colombia'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Colombia',
...
$hubChildren = [
  ['name' => 'Amazonas', 'url' => '/ui-ux-design-agency-in-amazonas-colombia', 'basename' => 'ui-ux-design-agency-in-amazonas-colombia'],
  ['name' => 'Antioquia', 'url' => '/ui-ux-design-agency-in-antioquia-colombia', 'basename' => 'ui-ux-design-agency-in-antioquia-colombia'],
  ['name' => 'Arauca', 'url' => '/ui-ux-design-agency-in-arauca-colombia', 'basename' => 'ui-ux-design-agency-in-arauca-colombia'],
  ['name' => 'Archipiélago de San Andrés, Providencia y Santa Catalina', 'url' => '/ui-ux-design-agency-in-archipielago-de-san-andres-providencia-y-santa-catalina-colombia', 'basename' => 'ui-ux-design-agency-in-archipielago-de-san-andres-providencia-y-santa-catalina-colombia'],
  ['name' => 'Atlántico', 'url' => '/ui-ux-design-agency-in-atlantico-colombia', 'basename' => 'ui-ux-design-agency-in-atlantico-colombia'],
  ['name' => 'Bogotá D.C.', 'url' => '/ui-ux-design-agency-in-bogota-d-c-colombia', 'basename' => 'ui-ux-design-agency-in-bogota-d-c-colombia'],
  ['name' => 'Bolívar', 'url' => '/ui-ux-design-agency-in-bolivar-colombia', 'basename' => 'ui-ux-design-agency-in-bolivar-colombia'],
  ['name' => 'Boyacá', 'url' => '/ui-ux-design-agency-in-boyaca-colombia', 'basename' => 'ui-ux-design-agency-in-boyaca-colombia'],
  ['name' => 'Caldas', 'url' => '/ui-ux-design-agency-in-caldas-colombia', 'basename' => 'ui-ux-design-agency-in-caldas-colombia'],
  ['name' => 'Caquetá', 'url' => '/ui-ux-design-agency-in-caqueta-colombia', 'basename' => 'ui-ux-design-agency-in-caqueta-colombia'],
  ['name' => 'Casanare', 'url' => '/ui-ux-design-agency-in-casanare-colombia', 'basename' => 'ui-ux-design-agency-in-casanare-colombia'],
  ['name' => 'Cauca', 'url' => '/ui-ux-design-agency-in-cauca-colombia', 'basename' => 'ui-ux-design-agency-in-cauca-colombia'],
  ['name' => 'Cesar', 'url' => '/ui-ux-design-agency-in-cesar-colombia', 'basename' => 'ui-ux-design-agency-in-cesar-colombia'],
  ['name' => 'Chocó', 'url' => '/ui-ux-design-agency-in-choco-colombia', 'basename' => 'ui-ux-design-agency-in-choco-colombia'],
  ['name' => 'Córdoba', 'url' => '/ui-ux-design-agency-in-cordoba-colombia', 'basename' => 'ui-ux-design-agency-in-cordoba-colombia'],
  ['name' => 'Cundinamarca', 'url' => '/ui-ux-design-agency-in-cundinamarca-colombia', 'basename' => 'ui-ux-design-agency-in-cundinamarca-colombia'],
  ['name' => 'Guainía', 'url' => '/ui-ux-design-agency-in-guainia-colombia', 'basename' => 'ui-ux-design-agency-in-guainia-colombia'],
  ['name' => 'Guaviare', 'url' => '/ui-ux-design-agency-in-guaviare-colombia', 'basename' => 'ui-ux-design-agency-in-guaviare-colombia'],
  ['name' => 'Huila', 'url' => '/ui-ux-design-agency-in-huila-colombia', 'basename' => 'ui-ux-design-agency-in-huila-colombia'],
  ['name' => 'La Guajira', 'url' => '/ui-ux-design-agency-in-la-guajira-colombia', 'basename' => 'ui-ux-design-agency-in-la-guajira-colombia'],
  ['name' => 'Magdalena', 'url' => '/ui-ux-design-agency-in-magdalena-colombia', 'basename' => 'ui-ux-design-agency-in-magdalena-colombia'],
  ['name' => 'Meta', 'url' => '/ui-ux-design-agency-in-meta-colombia', 'basename' => 'ui-ux-design-agency-in-meta-colombia'],
  ['name' => 'Nariño', 'url' => '/ui-ux-design-agency-in-narino-colombia', 'basename' => 'ui-ux-design-agency-in-narino-colombia'],
  ['name' => 'Norte de Santander', 'url' => '/ui-ux-design-agency-in-norte-de-santander-colombia', 'basename' => 'ui-ux-design-agency-in-norte-de-santander-colombia'],
  ['name' => 'Putumayo', 'url' => '/ui-ux-design-agency-in-putumayo-colombia', 'basename' => 'ui-ux-design-agency-in-putumayo-colombia'],
  ['name' => 'Quindío', 'url' => '/ui-ux-design-agency-in-quindio-colombia', 'basename' => 'ui-ux-design-agency-in-quindio-colombia'],
  ['name' => 'Risaralda', 'url' => '/ui-ux-design-agency-in-risaralda-colombia', 'basename' => 'ui-ux-design-agency-in-risaralda-colombia'],
  ['name' => 'Santander', 'url' => '/ui-ux-design-agency-in-santander-colombia', 'basename' => 'ui-ux-design-agency-in-santander-colombia'],
  ['name' => 'Sucre', 'url' => '/ui-ux-design-agency-in-sucre-colombia', 'basename' => 'ui-ux-design-agency-in-sucre-colombia'],
  ['name' => 'Tolima', 'url' => '/ui-ux-design-agency-in-tolima-colombia', 'basename' => 'ui-ux-design-agency-in-tolima-colombia'],
  ['name' => 'Valle del Cauca', 'url' => '/ui-ux-design-agency-in-valle-del-cauca-colombia', 'basename' => 'ui-ux-design-agency-in-valle-del-cauca-colombia'],
  ['name' => 'Vaupés', 'url' => '/ui-ux-design-agency-in-vaupes-colombia', 'basename' => 'ui-ux-design-agency-in-vaupes-colombia'],
  ['name' => 'Vichada', 'url' => '/ui-ux-design-agency-in-vichada-colombia', 'basename' => 'ui-ux-design-agency-in-vichada-colombia'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Colombia
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Colombia</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Colombia startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Colombia businesses.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Colombia Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          ...
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Colombia regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets Colombia regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Colombia.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to WCAG 2.1 AA standards and Law 1581-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, Law 1581 compliance risks, and navigation problems — each prioritised by business impact.</p></div>
      ...
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>Law 1581 and accessibility treated as afterthoughts</td><td>Law 1581 compliance and WCAG 2.1 AA accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and Law 1581 requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Colombia</h2>
      <p class="de-sub">Common questions from Colombia startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">We serve businesses in 33 regions, states, and cities in Colombia. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Colombia Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and Law 1581 compliance.</p></div>
          </div>
          <div class="de-proc-step">
