...
$countrySlug = 'gabu-region-guinea-bissau';
...
$pageTitle    = 'UI UX Design Agency in Gabú Region, Guinea-bissau | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Gabú Region, Guinea-bissau. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-gabu-region-guinea-bissau';
$ogTitle      = 'UI UX Design Agency in Gabú Region, Guinea-bissau | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Gabú Region, Guinea-bissau? UX Pacific delivers modern, user-focused digital solutions.';
