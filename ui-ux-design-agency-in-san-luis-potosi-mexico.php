...
$countrySlug = 'san-luis-potosi-mexico';
...
$pageTitle    = 'UI UX Design Agency in San Luis Potosí, Mexico | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in San Luis Potosí, Mexico. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-san-luis-potosi-mexico';
$ogTitle      = 'UI UX Design Agency in San Luis Potosí, Mexico | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in San Luis Potosí, Mexico? UX Pacific delivers modern, user-focused digital solutions.';
