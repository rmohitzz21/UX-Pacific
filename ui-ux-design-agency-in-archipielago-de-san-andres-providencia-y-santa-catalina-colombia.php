...
$countrySlug = 'archipielago-de-san-andres-providencia-y-santa-catalina-colombia';
...
$pageTitle    = 'UI UX Design Agency in Archipiélago de San Andrés, Providencia y Santa Catalina, Colombia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Archipiélago de San Andrés, Providencia y Santa Catalina, Colombia. We create user-friendly digital experiences for businesses.';
...
$ogTitle      = 'UI UX Design Agency in Archipiélago de San Andrés, Providencia y Santa Catalina, Colombia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Archipiélago de San Andrés, Providencia y Santa Catalina, Colombia? UX Pacific delivers modern, user-focused digital solutions.';
