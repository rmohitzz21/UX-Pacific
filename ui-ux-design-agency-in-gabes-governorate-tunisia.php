...
$countrySlug = 'gabes-governorate-tunisia';
...
$pageTitle    = 'UI UX Design Agency in Gabès Governorate, Tunisia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Gabès Governorate, Tunisia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-gabes-governorate-tunisia';
$ogTitle      = 'UI UX Design Agency in Gabès Governorate, Tunisia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Gabès Governorate, Tunisia? UX Pacific delivers modern, user-focused digital solutions.';
