...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in San Marino ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across San Marino</h2>
      <p class="hub-sub">We serve 8 regions, states, and cities in San Marino. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
