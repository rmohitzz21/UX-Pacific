...
$countrySlug = 'provence-alpes-cote-d-azur-france';
...
$pageTitle    = 'UI UX Design Agency in Provence-Alpes-Côte-d’Azur, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Provence-Alpes-Côte-d’Azur, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-provence-alpes-cote-d-azur-france';
$ogTitle      = 'UI UX Design Agency in Provence-Alpes-Côte-d’Azur, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Provence-Alpes-Côte-d’Azur, France? UX Pacific delivers modern, user-focused digital solutions.';
