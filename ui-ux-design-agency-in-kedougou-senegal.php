...
$pageTitle    = 'UI UX Design Agency in Kédougou, Senegal | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Kédougou, Senegal. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-kedougou-senegal';
$ogTitle      = 'UI UX Design Agency in Kédougou, Senegal | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Kédougou, Senegal? UX Pacific delivers modern, user-focused digital solutions.';
