...
$pageTitle    = 'UI UX Design Agency in Ségou Region, Mali | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ségou Region, Mali. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-segou-region-mali';
$ogTitle      = 'UI UX Design Agency in Ségou Region, Mali | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ségou Region, Mali? UX Pacific delivers modern, user-focused digital solutions.';
