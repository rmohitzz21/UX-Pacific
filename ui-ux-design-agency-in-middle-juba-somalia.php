<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Middle Juba, Somalia | UX Pacific';
$pageDesc        = 'N/A-aware UI/UX design for businesses in Middle Juba, Somalia. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Middle Juba, UI UX Agency Middle Juba, UX Design Middle Juba Somalia, UX Research Middle Juba, UX Audit Middle Juba, Usability Testing Middle Juba, UX Agency Middle Juba';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-middle-juba-somalia';
$ogTitle         = 'UI UX Design Agency in Middle Juba, Somalia | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving Middle Juba, Somalia. N/A-compliant. UX research, usability testing, and product design. Get a free audit.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-middle-juba-somalia';
$ogImage         = 'https://www.uxpacific.com/img/og-somalia.jpg';
$ogLocale        = 'so_SO';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Middle Juba, Somalia?', 'a' => 'Yes. UX Pacific works with businesses in Middle Juba remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Somalia, including Middle Juba.'],
  ['q' => 'How does N/A affect UX design for businesses in Middle Juba?', 'a' => 'N/A shapes how consent flows, privacy notices, and data collection forms are designed. We integrate N/A requirements from day one, building user trust through transparent UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'How much does UX design cost for a business in Middle Juba?', 'a' => 'Investment varies by scope. A focused UX audit starts at a fixed fee; a full product design engagement is scoped per project. We offer transparent, milestone-based pricing. Contact us with your product details for an estimate. See the full UI/UX design services in Somalia page for more context.'],
  ...
  ['q' => 'How quickly do you respond to enquiries from Middle Juba?', 'a' => 'We respond to all qualified enquiries within one business day. We work across EAT (UTC+3) and are flexible on meeting times. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-middle-juba-somalia#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-middle-juba-somalia",
            "name": "UI UX Design Agency in Middle Juba, Somalia | UX Pacific",
            "description": "Research-led UI/UX design agency serving Middle Juba, Somalia with UX research, usability testing, and N/A-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Middle Juba",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-middle-juba-somalia"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Middle Juba, Somalia",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Middle Juba, Somalia
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Middle Juba</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping businesses in Middle Juba, Somalia make better product decisions through UX Research, Usability Testing, Product Discovery and Human-Centered UI Design. N/A-compliant. IST-friendly remote collaboration.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for businesses in Middle Juba.</p>
    ...
    <div class="t2-wrap t2-section">
      <span class="t2-label">UI/UX Design in Middle Juba</span>
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Middle Juba, Somalia</h2>
      <p class="t2-sub">Every engagement begins with users, evidence, and business goals. We serve companies in Middle Juba remotely — with structured UX research, usability testing, UI design, and N/A-compliant product design.</p>

      <div class="t2-grid t2-grid-3">
        <div class="t2-svc">
          <h3>UX Research &amp; Audit</h3>
          <p>User interviews, heuristic evaluation, journey mapping, and usability testing for products used in Middle Juba. We identify where users drop off and why.</p>
        </div>
        <div class="t2-svc">
        ...
        <div class="t2-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product is usable by every member of your audience in Middle Juba.</p>
        </div>
      </div>
    </div>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Frequently Asked Questions — UI/UX Design in Middle Juba</h2>
      <p class="t2-sub">Common questions from businesses in Middle Juba, Somalia exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Middle Juba, Somalia?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Middle Juba remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Somalia, including Middle Juba.</div>
        </div>
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How does N/A affect UX design for businesses in Middle Juba?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How much does UX design cost for a business in Middle Juba?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How quickly do you respond to enquiries from Middle Juba?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
    ...
    <div class="t2-wrap t2-section">
      <div class="t2-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Middle Juba Product</h2>
