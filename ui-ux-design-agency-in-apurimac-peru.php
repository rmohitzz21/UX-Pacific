...
$pageTitle    = 'UI UX Design Agency in Apurímac, Peru | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Apurímac, Peru. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-apurimac-peru';
$ogTitle      = 'UI UX Design Agency in Apurímac, Peru | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Apurímac, Peru? UX Pacific delivers modern, user-focused digital solutions.';
