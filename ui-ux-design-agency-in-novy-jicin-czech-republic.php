...
$countrySlug = 'novy-jicin-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Nový Jičín, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Nový Jičín, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-novy-jicin-czech-republic';
$ogTitle      = 'UI UX Design Agency in Nový Jičín, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Nový Jičín, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
