...
$pageTitle    = 'UI UX Design Agency in Béjaïa, Algeria | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Béjaïa, Algeria. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-bejaia-algeria';
$ogTitle      = 'UI UX Design Agency in Béjaïa, Algeria | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Béjaïa, Algeria? UX Pacific delivers modern, user-focused digital solutions.';
