...
$pageTitle    = 'UI UX Design Agency in Lau, Fiji Islands | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Lau, Fiji Islands. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-lau-fiji-islands';
$ogTitle      = 'UI UX Design Agency in Lau, Fiji Islands | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Lau, Fiji Islands? UX Pacific delivers modern, user-focused digital solutions.';
