...
$pageTitle    = 'UI UX Design Agency in Vĩnh Long, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Vĩnh Long, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-vinh-long-vietnam';
$ogTitle      = 'UI UX Design Agency in Vĩnh Long, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Vĩnh Long, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
