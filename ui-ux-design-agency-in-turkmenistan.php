...
// Child locations in Turkmenistan
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Turkmenistan ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Turkmenistan</h2>
      <p class="hub-sub">We serve 6 regions, states, and cities in Turkmenistan. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
