...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Monaco ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Monaco</h2>
      <p class="hub-sub">We serve 3 regions, states, and cities in Monaco. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
