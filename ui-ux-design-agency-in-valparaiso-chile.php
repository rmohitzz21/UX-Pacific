...
$pageTitle    = 'UI UX Design Agency in Valparaíso, Chile | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Valparaíso, Chile. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-valparaiso-chile';
$ogTitle      = 'UI UX Design Agency in Valparaíso, Chile | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Valparaíso, Chile? UX Pacific delivers modern, user-focused digital solutions.';
