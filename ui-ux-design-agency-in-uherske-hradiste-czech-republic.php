...
$countrySlug = 'uherske-hradiste-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Uherské Hradiště, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Uherské Hradiště, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-uherske-hradiste-czech-republic';
$ogTitle      = 'UI UX Design Agency in Uherské Hradiště, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Uherské Hradiště, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
