...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Malawi ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Malawi</h2>
      <p class="hub-sub">We serve 30 regions, states, and cities in Malawi. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
