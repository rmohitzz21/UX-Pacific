...
$countrySlug = 'praha-zapad-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Praha-západ, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Praha-západ, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-praha-zapad-czech-republic';
$ogTitle      = 'UI UX Design Agency in Praha-západ, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Praha-západ, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
