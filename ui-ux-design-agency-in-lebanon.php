...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Lebanon ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Lebanon</h2>
      <p class="hub-sub">We serve 8 regions, states, and cities in Lebanon. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
