...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Israel ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Israel</h2>
      <p class="hub-sub">We serve 6 regions, states, and cities in Israel. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
