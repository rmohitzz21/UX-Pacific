...
$countrySlug = 'pyrenees-atlantiques-france';
...
$pageTitle    = 'UI UX Design Agency in Pyrénées-Atlantiques, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Pyrénées-Atlantiques, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-pyrenees-atlantiques-france';
$ogTitle      = 'UI UX Design Agency in Pyrénées-Atlantiques, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Pyrénées-Atlantiques, France? UX Pacific delivers modern, user-focused digital solutions.';
