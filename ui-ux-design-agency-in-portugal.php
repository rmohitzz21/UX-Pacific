...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Portugal ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Portugal</h2>
      <p class="hub-sub">We serve 20 regions, states, and cities in Portugal. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
