...
$pageTitle    = 'UI UX Design Agency in Haʻapai, Tonga | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Haʻapai, Tonga. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ha-apai-tonga';
$ogTitle      = 'UI UX Design Agency in Haʻapai, Tonga | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Haʻapai, Tonga? UX Pacific delivers modern, user-focused digital solutions.';
