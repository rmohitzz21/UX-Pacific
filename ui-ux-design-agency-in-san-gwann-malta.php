...
$pageTitle    = 'UI UX Design Agency in San Ġwann, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in San Ġwann, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-san-gwann-malta';
$ogTitle      = 'UI UX Design Agency in San Ġwann, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in San Ġwann, Malta? UX Pacific delivers modern, user-focused digital solutions.';
