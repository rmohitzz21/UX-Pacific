...
$countrySlug = 'pristina-pristine-kosovo';
...
$pageTitle    = 'UI UX Design Agency in Pristina (Priştine), Kosovo | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Pristina (Priştine), Kosovo. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-pristina-pristine-kosovo';
$ogTitle      = 'UI UX Design Agency in Pristina (Priştine), Kosovo | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Pristina (Priştine), Kosovo? UX Pacific delivers modern, user-focused digital solutions.';
