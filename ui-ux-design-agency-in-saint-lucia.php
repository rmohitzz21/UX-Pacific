...
// Child locations in Saint Lucia
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Saint Lucia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Saint Lucia</h2>
      <p class="hub-sub">We serve 12 regions, states, and cities in Saint Lucia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
