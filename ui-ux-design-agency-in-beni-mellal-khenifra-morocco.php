...
$countrySlug = 'beni-mellal-khenifra-morocco';
...
$pageTitle    = 'UI UX Design Agency in Béni Mellal-Khénifra, Morocco | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Béni Mellal-Khénifra, Morocco. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-beni-mellal-khenifra-morocco';
$ogTitle      = 'UI UX Design Agency in Béni Mellal-Khénifra, Morocco | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Béni Mellal-Khénifra, Morocco? UX Pacific delivers modern, user-focused digital solutions.';
