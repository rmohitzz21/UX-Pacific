...
// Child locations in Equatorial Guinea
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Equatorial Guinea ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Equatorial Guinea</h2>
      <p class="hub-sub">We serve 9 regions, states, and cities in Equatorial Guinea. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
