<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Saint Patrick Parish, Grenada | UX Pacific';
$pageDesc        = 'ECSC Model Law-aware UI/UX design for businesses in Saint Patrick Parish, Grenada. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Saint Patrick Parish, UI UX Agency Saint Patrick Parish, UX Design Saint Patrick Parish Grenada, UX Research Saint Patrick Parish, UX Audit Saint Patrick Parish, Usability Testing Saint Patrick Parish, UX Agency Saint Patrick Parish';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-saint-patrick-parish-grenada';
$ogTitle         = 'UI UX Design Agency in Saint Patrick Parish, Grenada | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving Saint Patrick Parish, Grenada. ECSC Model Law-compliant. UX research, usability testing, and product design. Get a free';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-saint-patrick-parish-grenada';
$ogImage         = 'https://www.uxpacific.com/img/og-grenada.jpg';
$ogLocale        = 'en_GD';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Saint Patrick Parish, Grenada?', 'a' => 'Yes. UX Pacific works with businesses in Saint Patrick Parish remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Grenada, including Saint Patrick Parish.'],
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-patrick-parish-grenada#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-patrick-parish-grenada",
            "name": "UI UX Design Agency in Saint Patrick Parish, Grenada | UX Pacific",
            "description": "Research-led UI/UX design agency serving Saint Patrick Parish, Grenada with UX research, usability testing, and ECSC Model Law-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Saint Patrick Parish",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-patrick-parish-grenada"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Saint Patrick Parish, Grenada",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Saint Patrick Parish, Grenada</h2>
    ...
    <div class="t2-wrap t2-section">
      ...
      <p class="t2-sub">Common questions from businesses in Saint Patrick Parish, Grenada exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Saint Patrick Parish, Grenada?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Saint Patrick Parish remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Grenada, including Saint Patrick Parish.</div>
        </div>
        <div class="t2-faq-item">
