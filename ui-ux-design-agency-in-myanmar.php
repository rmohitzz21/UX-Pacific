...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Myanmar ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Myanmar</h2>
      <p class="hub-sub">We serve 15 regions, states, and cities in Myanmar. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
