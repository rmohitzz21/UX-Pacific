...
$countrySlug = 'marahoue-region-cote-divoire';
...
$pageTitle    = 'UI UX Design Agency in Marahoué Region, Cote d\'Ivoire | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Marahoué Region, Cote d\'Ivoire. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-marahoue-region-cote-divoire';
$ogTitle      = 'UI UX Design Agency in Marahoué Region, Cote d\'Ivoire | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Marahoué Region, Cote d\'Ivoire? UX Pacific delivers modern, user-focused digital solutions.';
