...
$pageTitle    = 'UI UX Design Agency in Nuevo León, Mexico | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Nuevo León, Mexico. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-nuevo-leon-mexico';
$ogTitle      = 'UI UX Design Agency in Nuevo León, Mexico | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Nuevo León, Mexico? UX Pacific delivers modern, user-focused digital solutions.';
