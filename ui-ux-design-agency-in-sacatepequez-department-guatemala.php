...
$countrySlug = 'sacatepequez-department-guatemala';
...
$pageTitle    = 'UI UX Design Agency in Sacatepéquez Department, Guatemala | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Sacatepéquez Department, Guatemala. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-sacatepequez-department-guatemala';
$ogTitle      = 'UI UX Design Agency in Sacatepéquez Department, Guatemala | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Sacatepéquez Department, Guatemala? UX Pacific delivers modern, user-focused digital solutions.';
