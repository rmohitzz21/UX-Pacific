...
// Child locations in Bosnia and Herzegovina
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Bosnia and Herzegovina ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Bosnia and Herzegovina</h2>
      <p class="hub-sub">We serve 13 regions, states, and cities in Bosnia and Herzegovina. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
