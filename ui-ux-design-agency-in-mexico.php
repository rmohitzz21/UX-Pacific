...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Mexico ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Mexico</h2>
      <p class="hub-sub">We serve 32 regions, states, and cities in Mexico. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
