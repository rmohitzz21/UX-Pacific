...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Qatar ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Qatar</h2>
      <p class="hub-sub">We serve 8 regions, states, and cities in Qatar. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
