...
$countrySlug = 'pinar-del-rio-province-cuba';
...
$pageTitle    = 'UI UX Design Agency in Pinar del Río Province, Cuba | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Pinar del Río Province, Cuba. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-pinar-del-rio-province-cuba';
$ogTitle      = 'UI UX Design Agency in Pinar del Río Province, Cuba | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Pinar del Río Province, Cuba? UX Pacific delivers modern, user-focused digital solutions.';
