...
$countrySlug = 'kukes-district-albania';
...
$pageTitle    = 'UI UX Design Agency in Kukës District, Albania | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Kukës District, Albania. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-kukes-district-albania';
$ogTitle      = 'UI UX Design Agency in Kukës District, Albania | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Kukës District, Albania? UX Pacific delivers modern, user-focused digital solutions.';
