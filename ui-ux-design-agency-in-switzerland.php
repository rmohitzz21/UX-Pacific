...
// Child locations in Switzerland
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Switzerland ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Switzerland</h2>
      <p class="hub-sub">We serve 26 regions, states, and cities in Switzerland. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
