...
$pageTitle       = 'UI UX Design Agency in New Zealand | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across New Zealand. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design New Zealand, UI UX Agency New Zealand, UX Design New Zealand, UX Research New Zealand, UI Design New Zealand, Product Design New Zealand, UX Audit New Zealand, Usability Testing New Zealand, UX Consultant New Zealand, UX Company New Zealand, Design System New Zealand';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-new-zealand';
$ogTitle         = 'UI UX Design Agency in New Zealand | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across New Zealand. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-new-zealand';
$ogImage         = 'https://www.uxpacific.com/img/og-new-zealand.jpg';
$ogLocale        = 'en_NZ';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in New Zealand?', 'a' => 'Yes. UX Pacific supports New Zealand businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of New Zealand.'],
  ['q' => 'How does Privacy Act 2020 affect UX design for New Zealand businesses?', 'a' => 'Privacy Act 2020 directly shapes consent flows, data collection forms, and privacy communications. We integrate Privacy Act 2020 requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for New Zealand?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in New Zealand?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across New Zealand. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a New Zealand business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for New Zealand accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for New Zealand. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards New Zealand businesses expect.'],
  ['q' => 'How does remote collaboration work for New Zealand clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. New Zealand clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from New Zealand?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-new-zealand#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-new-zealand',
      'name'          => 'UI UX Design Agency in New Zealand | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across New Zealand. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
      'datePublished' => '2026-06-26',
      'dateModified'  => '2026-06-29',
      'about'         => ['@type' => 'Country', 'name' => 'New Zealand'],
    ],
    [
      '@type'           => 'BreadcrumbList',
      'itemListElement' => [
        ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home',      'item' => 'https://www.uxpacific.com/'],
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'New Zealand',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-new-zealand'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in New Zealand',
...
$hubChildren = [
  ['name' => 'Auckland Region', 'url' => '/ui-ux-design-agency-in-auckland-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-auckland-region-new-zealand'],
  ['name' => 'Bay of Plenty Region', 'url' => '/ui-ux-design-agency-in-bay-of-plenty-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-bay-of-plenty-region-new-zealand'],
  ['name' => 'Canterbury Region', 'url' => '/ui-ux-design-agency-in-canterbury-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-canterbury-region-new-zealand'],
  ['name' => 'Chatham Islands', 'url' => '/ui-ux-design-agency-in-chatham-islands-new-zealand', 'basename' => 'ui-ux-design-agency-in-chatham-islands-new-zealand'],
  ['name' => 'Gisborne District', 'url' => '/ui-ux-design-agency-in-gisborne-district-new-zealand', 'basename' => 'ui-ux-design-agency-in-gisborne-district-new-zealand'],
  ['name' => 'Hawke\\\'s Bay Region', 'url' => '/ui-ux-design-agency-in-hawkes-bay-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-hawkes-bay-region-new-zealand'],
  ['name' => 'Manawatu-Wanganui Region', 'url' => '/ui-ux-design-agency-in-manawatu-wanganui-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-manawatu-wanganui-region-new-zealand'],
  ['name' => 'Marlborough Region', 'url' => '/ui-ux-design-agency-in-marlborough-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-marlborough-region-new-zealand'],
  ['name' => 'Nelson Region', 'url' => '/ui-ux-design-agency-in-nelson-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-nelson-region-new-zealand'],
  ['name' => 'Northland Region', 'url' => '/ui-ux-design-agency-in-northland-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-northland-region-new-zealand'],
  ['name' => 'Otago Region', 'url' => '/ui-ux-design-agency-in-otago-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-otago-region-new-zealand'],
  ['name' => 'Southland Region', 'url' => '/ui-ux-design-agency-in-southland-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-southland-region-new-zealand'],
  ['name' => 'Taranaki Region', 'url' => '/ui-ux-design-agency-in-taranaki-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-taranaki-region-new-zealand'],
  ['name' => 'Tasman District', 'url' => '/ui-ux-design-agency-in-tasman-district-new-zealand', 'basename' => 'ui-ux-design-agency-in-tasman-district-new-zealand'],
  ['name' => 'Waikato Region', 'url' => '/ui-ux-design-agency-in-waikato-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-waikato-region-new-zealand'],
  ['name' => 'Wellington Region', 'url' => '/ui-ux-design-agency-in-wellington-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-wellington-region-new-zealand'],
  ['name' => 'West Coast Region', 'url' => '/ui-ux-design-agency-in-west-coast-region-new-zealand', 'basename' => 'ui-ux-design-agency-in-west-coast-region-new-zealand'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving New Zealand
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN New Zealand</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping New Zealand startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for New Zealand businesses.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for New Zealand Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          ...
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet New Zealand regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets New Zealand regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across New Zealand.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to WCAG 2.1 AA standards and Privacy Act 2020-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, Privacy Act 2020 compliance risks, and navigation problems — each prioritised by business impact.</p></div>
      ...
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>Privacy Act 2020 and accessibility treated as afterthoughts</td><td>Privacy Act 2020 compliance and WCAG 2.1 AA accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and Privacy Act 2020 requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in New Zealand</h2>
      <p class="de-sub">Common questions from New Zealand startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">We serve businesses in 17 regions, states, and cities in New Zealand. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your New Zealand Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and Privacy Act 2020 compliance.</p></div>
          </div>
          <div class="de-proc-step">
