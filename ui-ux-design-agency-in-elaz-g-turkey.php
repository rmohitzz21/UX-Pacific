...
$pageTitle    = 'UI UX Design Agency in Elazığ, Turkey | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Elazığ, Turkey. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-elaz-g-turkey';
$ogTitle      = 'UI UX Design Agency in Elazığ, Turkey | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Elazığ, Turkey? UX Pacific delivers modern, user-focused digital solutions.';
