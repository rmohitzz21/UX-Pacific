...
$pageTitle    = 'UI UX Design Agency in Karabük, Turkey | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Karabük, Turkey. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-karabuk-turkey';
$ogTitle      = 'UI UX Design Agency in Karabük, Turkey | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Karabük, Turkey? UX Pacific delivers modern, user-focused digital solutions.';
