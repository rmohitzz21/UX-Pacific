...
$countrySlug = 'zlinsky-kraj-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Zlínský kraj, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Zlínský kraj, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-zlinsky-kraj-czech-republic';
$ogTitle      = 'UI UX Design Agency in Zlínský kraj, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Zlínský kraj, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
