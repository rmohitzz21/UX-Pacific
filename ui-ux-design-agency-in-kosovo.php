...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Kosovo ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Kosovo</h2>
      <p class="hub-sub">We serve 7 regions, states, and cities in Kosovo. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
