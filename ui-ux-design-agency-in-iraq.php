...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Iraq ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Iraq</h2>
      <p class="hub-sub">We serve 18 regions, states, and cities in Iraq. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
