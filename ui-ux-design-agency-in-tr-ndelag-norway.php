...
$pageTitle    = 'UI UX Design Agency in Trøndelag, Norway | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Trøndelag, Norway. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-tr-ndelag-norway';
$ogTitle      = 'UI UX Design Agency in Trøndelag, Norway | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Trøndelag, Norway? UX Pacific delivers modern, user-focused digital solutions.';
