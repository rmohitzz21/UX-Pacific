...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Libya ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Libya</h2>
      <p class="hub-sub">We serve 21 regions, states, and cities in Libya. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
