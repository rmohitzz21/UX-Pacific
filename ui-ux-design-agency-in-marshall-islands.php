...
// Child locations in Marshall Islands
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Marshall Islands ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Marshall Islands</h2>
      <p class="hub-sub">We serve 2 regions, states, and cities in Marshall Islands. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
