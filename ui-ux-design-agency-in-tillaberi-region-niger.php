...
$countrySlug = 'tillaberi-region-niger';
...
$pageTitle    = 'UI UX Design Agency in Tillabéri Region, Niger | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Tillabéri Region, Niger. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-tillaberi-region-niger';
$ogTitle      = 'UI UX Design Agency in Tillabéri Region, Niger | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Tillabéri Region, Niger? UX Pacific delivers modern, user-focused digital solutions.';
