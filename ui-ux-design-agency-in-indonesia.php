...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Indonesia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Indonesia</h2>
      <p class="hub-sub">We serve 34 regions, states, and cities in Indonesia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
