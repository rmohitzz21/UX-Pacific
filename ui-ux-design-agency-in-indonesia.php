...
$pageTitle       = 'UI UX Design Agency in Indonesia | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Indonesia. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Indonesia, UI UX Agency Indonesia, UX Design Indonesia, UX Research Indonesia, UI Design Indonesia, Product Design Indonesia, UX Audit Indonesia, Usability Testing Indonesia, UX Consultant Indonesia, UX Company Indonesia, Design System Indonesia';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-indonesia';
$ogTitle         = 'UI UX Design Agency in Indonesia | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Indonesia. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-indonesia';
$ogImage         = 'https://www.uxpacific.com/img/og-indonesia.jpg';
$ogLocale        = 'id_ID';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Indonesia?', 'a' => 'Yes. UX Pacific supports Indonesia businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Indonesia.'],
  ['q' => 'How does GR No. 71/2019 (PDP) affect UX design for Indonesia businesses?', 'a' => 'GR No. 71/2019 (PDP) directly shapes consent flows, data collection forms, and privacy communications. We integrate GR No. 71/2019 (PDP) requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Indonesia?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Indonesia?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Indonesia. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Indonesia business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Indonesia accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Indonesia. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Indonesia businesses expect.'],
  ['q' => 'How does remote collaboration work for Indonesia clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Indonesia clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Indonesia?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-indonesia#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-indonesia',
      'name'          => 'UI UX Design Agency in Indonesia | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Indonesia. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
      'datePublished' => '2026-06-26',
      'dateModified'  => '2026-06-29',
      'about'         => ['@type' => 'Country', 'name' => 'Indonesia'],
    ],
    [
      '@type'           => 'BreadcrumbList',
      'itemListElement' => [
        ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home',      'item' => 'https://www.uxpacific.com/'],
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Indonesia',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-indonesia'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Indonesia',
      'provider'    => ['@id' => 'https://www.uxpacific.com/#organization'],
      'areaServed'  => ['@type' => 'Country', 'name' => 'Indonesia'],
      'serviceType' => 'UI UX Design, UX Research, Usability Testing, UX Audit, Product Discovery, Design Systems, GR No. 71/2019 (PDP)-Compliant UX',
      'url'         => 'https://www.uxpacific.com/ui-ux-design-agency-in-indonesia',
    ],
...
$hubChildren = [
  ['name' => 'Aceh', 'url' => '/ui-ux-design-agency-in-aceh-indonesia', 'basename' => 'ui-ux-design-agency-in-aceh-indonesia'],
  ['name' => 'Bali', 'url' => '/ui-ux-design-agency-in-bali-indonesia', 'basename' => 'ui-ux-design-agency-in-bali-indonesia'],
  ['name' => 'Banten', 'url' => '/ui-ux-design-agency-in-banten-indonesia', 'basename' => 'ui-ux-design-agency-in-banten-indonesia'],
  ['name' => 'Bengkulu', 'url' => '/ui-ux-design-agency-in-bengkulu-indonesia', 'basename' => 'ui-ux-design-agency-in-bengkulu-indonesia'],
  ['name' => 'DI Yogyakarta', 'url' => '/ui-ux-design-agency-in-di-yogyakarta-indonesia', 'basename' => 'ui-ux-design-agency-in-di-yogyakarta-indonesia'],
  ['name' => 'DKI Jakarta', 'url' => '/ui-ux-design-agency-in-dki-jakarta-indonesia', 'basename' => 'ui-ux-design-agency-in-dki-jakarta-indonesia'],
  ['name' => 'Gorontalo', 'url' => '/ui-ux-design-agency-in-gorontalo-indonesia', 'basename' => 'ui-ux-design-agency-in-gorontalo-indonesia'],
  ['name' => 'Jambi', 'url' => '/ui-ux-design-agency-in-jambi-indonesia', 'basename' => 'ui-ux-design-agency-in-jambi-indonesia'],
  ['name' => 'Jawa Barat', 'url' => '/ui-ux-design-agency-in-jawa-barat-indonesia', 'basename' => 'ui-ux-design-agency-in-jawa-barat-indonesia'],
  ['name' => 'Jawa Tengah', 'url' => '/ui-ux-design-agency-in-jawa-tengah-indonesia', 'basename' => 'ui-ux-design-agency-in-jawa-tengah-indonesia'],
  ['name' => 'Jawa Timur', 'url' => '/ui-ux-design-agency-in-jawa-timur-indonesia', 'basename' => 'ui-ux-design-agency-in-jawa-timur-indonesia'],
  ['name' => 'Kalimantan Barat', 'url' => '/ui-ux-design-agency-in-kalimantan-barat-indonesia', 'basename' => 'ui-ux-design-agency-in-kalimantan-barat-indonesia'],
  ['name' => 'Kalimantan Selatan', 'url' => '/ui-ux-design-agency-in-kalimantan-selatan-indonesia', 'basename' => 'ui-ux-design-agency-in-kalimantan-selatan-indonesia'],
  ['name' => 'Kalimantan Tengah', 'url' => '/ui-ux-design-agency-in-kalimantan-tengah-indonesia', 'basename' => 'ui-ux-design-agency-in-kalimantan-tengah-indonesia'],
  ['name' => 'Kalimantan Timur', 'url' => '/ui-ux-design-agency-in-kalimantan-timur-indonesia', 'basename' => 'ui-ux-design-agency-in-kalimantan-timur-indonesia'],
  ['name' => 'Kalimantan Utara', 'url' => '/ui-ux-design-agency-in-kalimantan-utara-indonesia', 'basename' => 'ui-ux-design-agency-in-kalimantan-utara-indonesia'],
  ['name' => 'Kepulauan Bangka Belitung', 'url' => '/ui-ux-design-agency-in-kepulauan-bangka-belitung-indonesia', 'basename' => 'ui-ux-design-agency-in-kepulauan-bangka-belitung-indonesia'],
  ['name' => 'Kepulauan Riau', 'url' => '/ui-ux-design-agency-in-kepulauan-riau-indonesia', 'basename' => 'ui-ux-design-agency-in-kepulauan-riau-indonesia'],
  ['name' => 'Lampung', 'url' => '/ui-ux-design-agency-in-lampung-indonesia', 'basename' => 'ui-ux-design-agency-in-lampung-indonesia'],
  ['name' => 'Maluku', 'url' => '/ui-ux-design-agency-in-maluku-indonesia', 'basename' => 'ui-ux-design-agency-in-maluku-indonesia'],
  ['name' => 'Maluku Utara', 'url' => '/ui-ux-design-agency-in-maluku-utara-indonesia', 'basename' => 'ui-ux-design-agency-in-maluku-utara-indonesia'],
  ['name' => 'Nusa Tenggara Barat', 'url' => '/ui-ux-design-agency-in-nusa-tenggara-barat-indonesia', 'basename' => 'ui-ux-design-agency-in-nusa-tenggara-barat-indonesia'],
  ['name' => 'Nusa Tenggara Timur', 'url' => '/ui-ux-design-agency-in-nusa-tenggara-timur-indonesia', 'basename' => 'ui-ux-design-agency-in-nusa-tenggara-timur-indonesia'],
  ['name' => 'Papua Barat', 'url' => '/ui-ux-design-agency-in-papua-barat-indonesia', 'basename' => 'ui-ux-design-agency-in-papua-barat-indonesia'],
  ['name' => 'Papua', 'url' => '/ui-ux-design-agency-in-papua-indonesia', 'basename' => 'ui-ux-design-agency-in-papua-indonesia'],
  ['name' => 'Riau', 'url' => '/ui-ux-design-agency-in-riau-indonesia', 'basename' => 'ui-ux-design-agency-in-riau-indonesia'],
  ['name' => 'Sulawesi Barat', 'url' => '/ui-ux-design-agency-in-sulawesi-barat-indonesia', 'basename' => 'ui-ux-design-agency-in-sulawesi-barat-indonesia'],
  ['name' => 'Sulawesi Selatan', 'url' => '/ui-ux-design-agency-in-sulawesi-selatan-indonesia', 'basename' => 'ui-ux-design-agency-in-sulawesi-selatan-indonesia'],
  ['name' => 'Sulawesi Tengah', 'url' => '/ui-ux-design-agency-in-sulawesi-tengah-indonesia', 'basename' => 'ui-ux-design-agency-in-sulawesi-tengah-indonesia'],
  ['name' => 'Sulawesi Tenggara', 'url' => '/ui-ux-design-agency-in-sulawesi-tenggara-indonesia', 'basename' => 'ui-ux-design-agency-in-sulawesi-tenggara-indonesia'],
  ['name' => 'Sulawesi Utara', 'url' => '/ui-ux-design-agency-in-sulawesi-utara-indonesia', 'basename' => 'ui-ux-design-agency-in-sulawesi-utara-indonesia'],
  ['name' => 'Sumatera Barat', 'url' => '/ui-ux-design-agency-in-sumatera-barat-indonesia', 'basename' => 'ui-ux-design-agency-in-sumatera-barat-indonesia'],
  ['name' => 'Sumatera Selatan', 'url' => '/ui-ux-design-agency-in-sumatera-selatan-indonesia', 'basename' => 'ui-ux-design-agency-in-sumatera-selatan-indonesia'],
  ['name' => 'Sumatera Utara', 'url' => '/ui-ux-design-agency-in-sumatera-utara-indonesia', 'basename' => 'ui-ux-design-agency-in-sumatera-utara-indonesia'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Indonesia
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Indonesia</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Indonesia startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Indonesia businesses.</p>
      ...
      <div class="de-grid de-grid-4" style="margin-top:1.8rem">
        ...
        <div class="de-card">
          <span class="de-card-icon">&#128737;</span>
          <h3>GR No. 71/2019 (PDP)-Aware Approach</h3>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Indonesia Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          <h3>GR No. 71/2019 (PDP)-Compliant UX</h3>
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Indonesia regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets Indonesia regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Indonesia.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to WCAG 2.1 AA standards and GR No. 71/2019 (PDP)-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, GR No. 71/2019 (PDP) compliance risks, and navigation problems — each prioritised by business impact.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Most agencies start with screens. We start with research. Here is what that difference looks like in practice for Indonesia businesses.</p>
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>GR No. 71/2019 (PDP) and accessibility treated as afterthoughts</td><td>GR No. 71/2019 (PDP) compliance and WCAG 2.1 AA accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <p class="de-sub">A structured, transparent workflow designed for Indonesia and international teams that need clarity, speed, and reliable communication at every stage.</p>
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and GR No. 71/2019 (PDP) requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Indonesia</h2>
      <p class="de-sub">Common questions from Indonesia startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services Across Indonesia</h2>
      <p class="de-sub">We serve businesses in 34 regions, states, and cities in Indonesia. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Indonesia Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and GR No. 71/2019 (PDP) compliance.</p></div>
          </div>
          <div class="de-proc-step">
