...
$countrySlug = 'riscani-district-moldova';
...
$pageTitle    = 'UI UX Design Agency in Rîșcani District, Moldova | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Rîșcani District, Moldova. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-riscani-district-moldova';
$ogTitle      = 'UI UX Design Agency in Rîșcani District, Moldova | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Rîșcani District, Moldova? UX Pacific delivers modern, user-focused digital solutions.';
