...
$pageTitle       = 'UI UX Design Agency in Dominica | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Dominica. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Dominica, UI UX Agency Dominica, UX Design Dominica, UX Research Dominica, UI Design Dominica, Product Design Dominica, UX Audit Dominica, Usability Testing Dominica, UX Consultant Dominica, UX Company Dominica, Design System Dominica';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-dominica';
$ogTitle         = 'UI UX Design Agency in Dominica | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Dominica. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-dominica';
$ogImage         = 'https://www.uxpacific.com/img/og-dominica.jpg';
$ogLocale        = 'en_DM';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Dominica?', 'a' => 'Yes. UX Pacific supports Dominica businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Dominica.'],
  ['q' => 'How does ECSC Model Law affect UX design for Dominica businesses?', 'a' => 'ECSC Model Law directly shapes consent flows, data collection forms, and privacy communications. We integrate ECSC Model Law requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Dominica?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Dominica?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Dominica. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Dominica business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Dominica accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Dominica. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Dominica businesses expect.'],
  ['q' => 'How does remote collaboration work for Dominica clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Dominica clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Dominica?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-dominica#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-dominica',
      'name'          => 'UI UX Design Agency in Dominica | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Dominica. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
      'datePublished' => '2026-06-26',
      'dateModified'  => '2026-06-29',
      'about'         => ['@type' => 'Country', 'name' => 'Dominica'],
    ],
    [
      '@type'           => 'BreadcrumbList',
      'itemListElement' => [
        ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home',      'item' => 'https://www.uxpacific.com/'],
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Dominica',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-dominica'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Dominica',
      'provider'    => ['@id' => 'https://www.uxpacific.com/#organization'],
      'areaServed'  => ['@type' => 'Country', 'name' => 'Dominica'],
...
$hubChildren = [
  ['name' => 'Saint Andrew Parish', 'url' => '/ui-ux-design-agency-in-saint-andrew-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-andrew-parish-dominica'],
  ['name' => 'Saint David Parish', 'url' => '/ui-ux-design-agency-in-saint-david-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-david-parish-dominica'],
  ['name' => 'Saint George Parish', 'url' => '/ui-ux-design-agency-in-saint-george-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-george-parish-dominica'],
  ['name' => 'Saint John Parish', 'url' => '/ui-ux-design-agency-in-saint-john-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-john-parish-dominica'],
  ['name' => 'Saint Joseph Parish', 'url' => '/ui-ux-design-agency-in-saint-joseph-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-joseph-parish-dominica'],
  ['name' => 'Saint Luke Parish', 'url' => '/ui-ux-design-agency-in-saint-luke-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-luke-parish-dominica'],
  ['name' => 'Saint Mark Parish', 'url' => '/ui-ux-design-agency-in-saint-mark-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-mark-parish-dominica'],
  ['name' => 'Saint Patrick Parish', 'url' => '/ui-ux-design-agency-in-saint-patrick-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-patrick-parish-dominica'],
  ['name' => 'Saint Paul Parish', 'url' => '/ui-ux-design-agency-in-saint-paul-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-paul-parish-dominica'],
  ['name' => 'Saint Peter Parish', 'url' => '/ui-ux-design-agency-in-saint-peter-parish-dominica', 'basename' => 'ui-ux-design-agency-in-saint-peter-parish-dominica'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Dominica
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Dominica</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Dominica startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Dominica businesses.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Dominica Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          ...
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Dominica regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets Dominica regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Dominica.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Dominica</h2>
      <p class="de-sub">Common questions from Dominica startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">We serve businesses in 10 regions, states, and cities in Dominica. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Dominica Product</h2>
