...
// Child locations in Sao Tome and Principe
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Sao Tome and Principe ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Sao Tome and Principe</h2>
      <p class="hub-sub">We serve 2 regions, states, and cities in Sao Tome and Principe. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
