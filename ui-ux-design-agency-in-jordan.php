...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Jordan ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Jordan</h2>
      <p class="hub-sub">We serve 12 regions, states, and cities in Jordan. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
