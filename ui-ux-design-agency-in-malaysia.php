...
$pageTitle       = 'UI UX Design Agency in Malaysia | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Malaysia. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Malaysia, UI UX Agency Malaysia, UX Design Malaysia, UX Research Malaysia, UI Design Malaysia, Product Design Malaysia, UX Audit Malaysia, Usability Testing Malaysia, UX Consultant Malaysia, UX Company Malaysia, Design System Malaysia';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-malaysia';
$ogTitle         = 'UI UX Design Agency in Malaysia | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Malaysia. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-malaysia';
$ogImage         = 'https://www.uxpacific.com/img/og-malaysia.jpg';
$ogLocale        = 'ms_MY';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Malaysia?', 'a' => 'Yes. UX Pacific supports Malaysia businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Malaysia.'],
  ['q' => 'How does PDPA 2010 (Malaysia) affect UX design for Malaysia businesses?', 'a' => 'PDPA 2010 (Malaysia) directly shapes consent flows, data collection forms, and privacy communications. We integrate PDPA 2010 (Malaysia) requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Malaysia?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Malaysia?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Malaysia. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Malaysia business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Malaysia accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Malaysia. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Malaysia businesses expect.'],
  ['q' => 'How does remote collaboration work for Malaysia clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Malaysia clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Malaysia?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-malaysia#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-malaysia',
      'name'          => 'UI UX Design Agency in Malaysia | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Malaysia. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
      'datePublished' => '2026-06-26',
      'dateModified'  => '2026-06-29',
      'about'         => ['@type' => 'Country', 'name' => 'Malaysia'],
    ],
    [
      '@type'           => 'BreadcrumbList',
      'itemListElement' => [
        ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home',      'item' => 'https://www.uxpacific.com/'],
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Malaysia',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-malaysia'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Malaysia',
...
$hubChildren = [
  ['name' => 'Johor', 'url' => '/ui-ux-design-agency-in-johor-malaysia', 'basename' => 'ui-ux-design-agency-in-johor-malaysia'],
  ['name' => 'Kedah', 'url' => '/ui-ux-design-agency-in-kedah-malaysia', 'basename' => 'ui-ux-design-agency-in-kedah-malaysia'],
  ['name' => 'Kelantan', 'url' => '/ui-ux-design-agency-in-kelantan-malaysia', 'basename' => 'ui-ux-design-agency-in-kelantan-malaysia'],
  ['name' => 'Kuala Lumpur', 'url' => '/ui-ux-design-agency-in-kuala-lumpur-malaysia', 'basename' => 'ui-ux-design-agency-in-kuala-lumpur-malaysia'],
  ['name' => 'Labuan', 'url' => '/ui-ux-design-agency-in-labuan-malaysia', 'basename' => 'ui-ux-design-agency-in-labuan-malaysia'],
  ['name' => 'Malacca', 'url' => '/ui-ux-design-agency-in-malacca-malaysia', 'basename' => 'ui-ux-design-agency-in-malacca-malaysia'],
  ['name' => 'Negeri Sembilan', 'url' => '/ui-ux-design-agency-in-negeri-sembilan-malaysia', 'basename' => 'ui-ux-design-agency-in-negeri-sembilan-malaysia'],
  ['name' => 'Pahang', 'url' => '/ui-ux-design-agency-in-pahang-malaysia', 'basename' => 'ui-ux-design-agency-in-pahang-malaysia'],
  ['name' => 'Penang', 'url' => '/ui-ux-design-agency-in-penang-malaysia', 'basename' => 'ui-ux-design-agency-in-penang-malaysia'],
  ['name' => 'Perak', 'url' => '/ui-ux-design-agency-in-perak-malaysia', 'basename' => 'ui-ux-design-agency-in-perak-malaysia'],
  ['name' => 'Perlis', 'url' => '/ui-ux-design-agency-in-perlis-malaysia', 'basename' => 'ui-ux-design-agency-in-perlis-malaysia'],
  ['name' => 'Putrajaya', 'url' => '/ui-ux-design-agency-in-putrajaya-malaysia', 'basename' => 'ui-ux-design-agency-in-putrajaya-malaysia'],
  ['name' => 'Sabah', 'url' => '/ui-ux-design-agency-in-sabah-malaysia', 'basename' => 'ui-ux-design-agency-in-sabah-malaysia'],
  ['name' => 'Sarawak', 'url' => '/ui-ux-design-agency-in-sarawak-malaysia', 'basename' => 'ui-ux-design-agency-in-sarawak-malaysia'],
  ['name' => 'Selangor', 'url' => '/ui-ux-design-agency-in-selangor-malaysia', 'basename' => 'ui-ux-design-agency-in-selangor-malaysia'],
  ['name' => 'Terengganu', 'url' => '/ui-ux-design-agency-in-terengganu-malaysia', 'basename' => 'ui-ux-design-agency-in-terengganu-malaysia'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Malaysia
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Malaysia</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Malaysia startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Malaysia businesses.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Malaysia Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          ...
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Malaysia regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets Malaysia regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Malaysia.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to WCAG 2.1 AA standards and PDPA 2010 (Malaysia)-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, PDPA 2010 (Malaysia) compliance risks, and navigation problems — each prioritised by business impact.</p></div>
      ...
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>PDPA 2010 (Malaysia) and accessibility treated as afterthoughts</td><td>PDPA 2010 (Malaysia) compliance and WCAG 2.1 AA accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and PDPA 2010 (Malaysia) requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Malaysia</h2>
      <p class="de-sub">Common questions from Malaysia startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">We serve businesses in 16 regions, states, and cities in Malaysia. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Malaysia Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and PDPA 2010 (Malaysia) compliance.</p></div>
          </div>
          <div class="de-proc-step">
