...
$countrySlug = 'boqueron-department-paraguay';
...
$pageTitle    = 'UI UX Design Agency in Boquerón Department, Paraguay | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Boquerón Department, Paraguay. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-boqueron-department-paraguay';
$ogTitle      = 'UI UX Design Agency in Boquerón Department, Paraguay | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Boquerón Department, Paraguay? UX Pacific delivers modern, user-focused digital solutions.';
