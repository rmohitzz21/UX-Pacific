...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Sweden ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Sweden</h2>
      <p class="hub-sub">We serve 20 regions, states, and cities in Sweden. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
