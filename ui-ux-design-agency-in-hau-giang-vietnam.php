...
$pageTitle    = 'UI UX Design Agency in Hậu Giang, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Hậu Giang, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-hau-giang-vietnam';
$ogTitle      = 'UI UX Design Agency in Hậu Giang, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Hậu Giang, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
