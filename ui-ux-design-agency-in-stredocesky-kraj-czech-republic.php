...
$countrySlug = 'stredocesky-kraj-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Středočeský kraj, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Středočeský kraj, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-stredocesky-kraj-czech-republic';
$ogTitle      = 'UI UX Design Agency in Středočeský kraj, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Středočeský kraj, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
