...
$countrySlug = 'macva-district-serbia';
...
$pageTitle    = 'UI UX Design Agency in Mačva District, Serbia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Mačva District, Serbia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-macva-district-serbia';
$ogTitle      = 'UI UX Design Agency in Mačva District, Serbia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Mačva District, Serbia? UX Pacific delivers modern, user-focused digital solutions.';
