...
$countrySlug = 'magallanes-y-de-la-antartica-chilena-chile';
...
$pageTitle    = 'UI UX Design Agency in Magallanes y de la Antártica Chilena, Chile | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Magallanes y de la Antártica Chilena, Chile. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-magallanes-y-de-la-antartica-chilena-chile';
$ogTitle      = 'UI UX Design Agency in Magallanes y de la Antártica Chilena, Chile | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Magallanes y de la Antártica Chilena, Chile? UX Pacific delivers modern, user-focused digital solutions.';
