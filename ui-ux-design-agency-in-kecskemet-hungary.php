...
$pageTitle    = 'UI UX Design Agency in Kecskemét, Hungary | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Kecskemét, Hungary. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-kecskemet-hungary';
$ogTitle      = 'UI UX Design Agency in Kecskemét, Hungary | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Kecskemét, Hungary? UX Pacific delivers modern, user-focused digital solutions.';
