...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Brunei ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Brunei</h2>
      <p class="hub-sub">We serve 4 regions, states, and cities in Brunei. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
