...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Burundi ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Burundi</h2>
      <p class="hub-sub">We serve 18 regions, states, and cities in Burundi. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
