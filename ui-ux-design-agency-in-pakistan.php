...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Pakistan ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Pakistan</h2>
      <p class="hub-sub">We serve 8 regions, states, and cities in Pakistan. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
