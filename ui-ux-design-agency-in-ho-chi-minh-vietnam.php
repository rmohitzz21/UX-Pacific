...
$countrySlug = 'ho-chi-minh-vietnam';
...
$pageTitle    = 'UI UX Design Agency in Hồ Chí Minh, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Hồ Chí Minh, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ho-chi-minh-vietnam';
$ogTitle      = 'UI UX Design Agency in Hồ Chí Minh, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Hồ Chí Minh, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
