...
$countrySlug = 'gambia';
$pageTitle    = 'UI UX Design Agency in Gambia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Gambia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-gambia';
$ogTitle      = 'UI UX Design Agency in Gambia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Gambia? UX Pacific delivers modern, user-focused digital solutions.';
$ogUrl        = 'https://www.uxpacific.com/ui-ux-design-agency-in-gambia';
$currentPage  = 'Home';
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position: relative; overflow: hidden">
      ...
      <section class="hero">
        ...
        <p class="subtext">Professional UI UX Design Services in Gambia for High-Converting Digital Products</p>
        <br />
    ...
    <div class="ux-content mt-5 mb-5">
      ...
      <p class="ux-description">
       We are a UI UX design agency offering services in Gambia, helping startups and businesses build user-friendly digital products that improve engagement and conversions.
      </p>
    ...
    <div class="section-title" style="margin-top: 50px">
      ...
      <p class="ux-description">UI UX Design Services in Gambia for Web, Mobile & Product Design.</p>
    </div>
    <style>
