...
$countrySlug = 'kolasin-municipality-montenegro';
...
$pageTitle    = 'UI UX Design Agency in Kolašin Municipality, Montenegro | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Kolašin Municipality, Montenegro. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-kolasin-municipality-montenegro';
$ogTitle      = 'UI UX Design Agency in Kolašin Municipality, Montenegro | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Kolašin Municipality, Montenegro? UX Pacific delivers modern, user-focused digital solutions.';
