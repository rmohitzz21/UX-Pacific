...
$pageDesc    = 'UX Pacific delivers expert UI/UX design services across Cote d\'Ivoire. Browse our locations or book a free UX audit today.';
...
$ogDesc      = 'UX Pacific delivers expert UI/UX design services across Cote d\'Ivoire. Browse our locations or book a free UX audit today.';
...
// Child locations in Cote d\'Ivoire
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Cote d\'Ivoire ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Cote d\'Ivoire</h2>
      <p class="hub-sub">We serve 31 regions, states, and cities in Cote d\'Ivoire. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
