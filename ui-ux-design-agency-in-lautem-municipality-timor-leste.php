...
$countrySlug = 'lautem-municipality-timor-leste';
...
$pageTitle    = 'UI UX Design Agency in Lautém Municipality, Timor-Leste | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Lautém Municipality, Timor-Leste. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-lautem-municipality-timor-leste';
$ogTitle      = 'UI UX Design Agency in Lautém Municipality, Timor-Leste | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Lautém Municipality, Timor-Leste? UX Pacific delivers modern, user-focused digital solutions.';
