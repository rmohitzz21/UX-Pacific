...
$countrySlug = 'coxs-bazar-district-bangladesh';
...
$pageTitle    = 'UI UX Design Agency in Cox\'s Bazar District, Bangladesh | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Cox\'s Bazar District, Bangladesh. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-coxs-bazar-district-bangladesh';
$ogTitle      = 'UI UX Design Agency in Cox\'s Bazar District, Bangladesh | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Cox\'s Bazar District, Bangladesh? UX Pacific delivers modern, user-focused digital solutions.';
