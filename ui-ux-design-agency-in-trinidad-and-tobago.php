...
// Child locations in Trinidad and Tobago
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Trinidad and Tobago ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Trinidad and Tobago</h2>
      <p class="hub-sub">We serve 16 regions, states, and cities in Trinidad and Tobago. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
