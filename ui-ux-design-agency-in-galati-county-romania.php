...
$countrySlug = 'galati-county-romania';
...
$pageTitle    = 'UI UX Design Agency in Galați County, Romania | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Galați County, Romania. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-galati-county-romania';
$ogTitle      = 'UI UX Design Agency in Galați County, Romania | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Galați County, Romania? UX Pacific delivers modern, user-focused digital solutions.';
