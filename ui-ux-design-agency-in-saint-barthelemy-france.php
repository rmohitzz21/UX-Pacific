...
$countrySlug = 'saint-barthelemy-france';
...
$pageTitle    = 'UI UX Design Agency in Saint-Barthélemy, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Saint-Barthélemy, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-saint-barthelemy-france';
$ogTitle      = 'UI UX Design Agency in Saint-Barthélemy, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Saint-Barthélemy, France? UX Pacific delivers modern, user-focused digital solutions.';
