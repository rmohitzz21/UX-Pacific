...
$countrySlug = 'santa-barbara-department-honduras';
...
$pageTitle    = 'UI UX Design Agency in Santa Bárbara Department, Honduras | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Santa Bárbara Department, Honduras. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-santa-barbara-department-honduras';
$ogTitle      = 'UI UX Design Agency in Santa Bárbara Department, Honduras | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Santa Bárbara Department, Honduras? UX Pacific delivers modern, user-focused digital solutions.';
