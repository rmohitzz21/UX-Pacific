...
// Child locations in Liechtenstein
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Liechtenstein ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Liechtenstein</h2>
      <p class="hub-sub">We serve 11 regions, states, and cities in Liechtenstein. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
