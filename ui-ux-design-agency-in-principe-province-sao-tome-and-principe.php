...
$countrySlug = 'principe-province-sao-tome-and-principe';
...
$pageTitle    = 'UI UX Design Agency in Príncipe Province, Sao Tome and Principe | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Príncipe Province, Sao Tome and Principe. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-principe-province-sao-tome-and-principe';
$ogTitle      = 'UI UX Design Agency in Príncipe Province, Sao Tome and Principe | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Príncipe Province, Sao Tome and Principe? UX Pacific delivers modern, user-focused digital solutions.';
