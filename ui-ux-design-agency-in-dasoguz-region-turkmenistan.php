...
$countrySlug = 'dasoguz-region-turkmenistan';
...
$pageTitle    = 'UI UX Design Agency in Daşoguz Region, Turkmenistan | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Daşoguz Region, Turkmenistan. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-dasoguz-region-turkmenistan';
$ogTitle      = 'UI UX Design Agency in Daşoguz Region, Turkmenistan | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Daşoguz Region, Turkmenistan? UX Pacific delivers modern, user-focused digital solutions.';
