...
$countrySlug = 'ngobe-bugle-comarca-panama';
...
$pageTitle    = 'UI UX Design Agency in Ngöbe-Buglé Comarca, Panama | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ngöbe-Buglé Comarca, Panama. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ngobe-bugle-comarca-panama';
$ogTitle      = 'UI UX Design Agency in Ngöbe-Buglé Comarca, Panama | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ngöbe-Buglé Comarca, Panama? UX Pacific delivers modern, user-focused digital solutions.';
