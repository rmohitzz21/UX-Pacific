...
$countrySlug = 'bekes-county-hungary';
...
$pageTitle    = 'UI UX Design Agency in Békés County, Hungary | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Békés County, Hungary. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-bekes-county-hungary';
$ogTitle      = 'UI UX Design Agency in Békés County, Hungary | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Békés County, Hungary? UX Pacific delivers modern, user-focused digital solutions.';
