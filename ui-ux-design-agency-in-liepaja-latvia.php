...
$pageTitle    = 'UI UX Design Agency in Liepāja, Latvia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Liepāja, Latvia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-liepaja-latvia';
$ogTitle      = 'UI UX Design Agency in Liepāja, Latvia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Liepāja, Latvia? UX Pacific delivers modern, user-focused digital solutions.';
