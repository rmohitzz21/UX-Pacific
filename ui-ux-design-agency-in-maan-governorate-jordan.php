...
$countrySlug = 'maan-governorate-jordan';
...
$pageTitle    = 'UI UX Design Agency in Ma\'an Governorate, Jordan | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ma\'an Governorate, Jordan. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-maan-governorate-jordan';
$ogTitle      = 'UI UX Design Agency in Ma\'an Governorate, Jordan | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ma\'an Governorate, Jordan? UX Pacific delivers modern, user-focused digital solutions.';
