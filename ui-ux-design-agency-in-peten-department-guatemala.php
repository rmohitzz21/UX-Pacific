...
$countrySlug = 'peten-department-guatemala';
...
$pageTitle    = 'UI UX Design Agency in Petén Department, Guatemala | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Petén Department, Guatemala. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-peten-department-guatemala';
$ogTitle      = 'UI UX Design Agency in Petén Department, Guatemala | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Petén Department, Guatemala? UX Pacific delivers modern, user-focused digital solutions.';
