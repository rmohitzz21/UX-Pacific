...
$countrySlug = 'brno-mesto-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Brno-město, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Brno-město, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-brno-mesto-czech-republic';
$ogTitle      = 'UI UX Design Agency in Brno-město, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Brno-město, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
