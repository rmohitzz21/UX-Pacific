...
$countrySlug = 'agneby-cote-divoire';
...
$pageTitle    = 'UI UX Design Agency in Agnéby, Cote d\'Ivoire | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Agnéby, Cote d\'Ivoire. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-agneby-cote-divoire';
$ogTitle      = 'UI UX Design Agency in Agnéby, Cote d\'Ivoire | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Agnéby, Cote d\'Ivoire? UX Pacific delivers modern, user-focused digital solutions.';
