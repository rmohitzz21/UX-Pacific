...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Rwanda ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Rwanda</h2>
      <p class="hub-sub">We serve 5 regions, states, and cities in Rwanda. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
