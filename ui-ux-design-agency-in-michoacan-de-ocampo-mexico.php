...
$countrySlug = 'michoacan-de-ocampo-mexico';
...
$pageTitle    = 'UI UX Design Agency in Michoacán de Ocampo, Mexico | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Michoacán de Ocampo, Mexico. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-michoacan-de-ocampo-mexico';
$ogTitle      = 'UI UX Design Agency in Michoacán de Ocampo, Mexico | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Michoacán de Ocampo, Mexico? UX Pacific delivers modern, user-focused digital solutions.';
