...
// Child locations in Afghanistan
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Afghanistan ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Afghanistan</h2>
      <p class="hub-sub">We serve 33 regions, states, and cities in Afghanistan. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
