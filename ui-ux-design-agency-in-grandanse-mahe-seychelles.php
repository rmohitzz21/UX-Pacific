...
$countrySlug = 'grandanse-mahe-seychelles';
...
$pageTitle    = 'UI UX Design Agency in Grand\'Anse Mahé, Seychelles | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Grand\'Anse Mahé, Seychelles. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-grandanse-mahe-seychelles';
$ogTitle      = 'UI UX Design Agency in Grand\'Anse Mahé, Seychelles | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Grand\'Anse Mahé, Seychelles? UX Pacific delivers modern, user-focused digital solutions.';
