...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Croatia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Croatia</h2>
      <p class="hub-sub">We serve 20 regions, states, and cities in Croatia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
