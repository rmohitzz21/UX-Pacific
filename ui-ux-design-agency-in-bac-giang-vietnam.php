...
$pageTitle    = 'UI UX Design Agency in Bắc Giang, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Bắc Giang, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-bac-giang-vietnam';
$ogTitle      = 'UI UX Design Agency in Bắc Giang, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Bắc Giang, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
