...
$pageTitle    = 'UI UX Design Agency in Sédhiou, Senegal | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Sédhiou, Senegal. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-sedhiou-senegal';
$ogTitle      = 'UI UX Design Agency in Sédhiou, Senegal | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Sédhiou, Senegal? UX Pacific delivers modern, user-focused digital solutions.';
