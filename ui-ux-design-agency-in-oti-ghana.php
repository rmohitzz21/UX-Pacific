...
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Oti, Ghana. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-oti-ghana';
$ogTitle      = 'UI UX Design Agency in Oti, Ghana | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Oti, Ghana? UX Pacific delivers modern, user-focused digital solutions.';
