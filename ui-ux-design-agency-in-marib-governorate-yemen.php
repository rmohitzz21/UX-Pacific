...
$countrySlug = 'marib-governorate-yemen';
...
$pageTitle    = 'UI UX Design Agency in Ma\'rib Governorate, Yemen | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ma\'rib Governorate, Yemen. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-marib-governorate-yemen';
$ogTitle      = 'UI UX Design Agency in Ma\'rib Governorate, Yemen | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ma\'rib Governorate, Yemen? UX Pacific delivers modern, user-focused digital solutions.';
