...
$pageTitle    = 'UI UX Design Agency in Ħamrun, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ħamrun, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-amrun-malta';
$ogTitle      = 'UI UX Design Agency in Ħamrun, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ħamrun, Malta? UX Pacific delivers modern, user-focused digital solutions.';
