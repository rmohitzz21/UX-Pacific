...
$countrySlug = 'bourgogne-franche-comte-france';
...
$pageTitle    = 'UI UX Design Agency in Bourgogne-Franche-Comté, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Bourgogne-Franche-Comté, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-bourgogne-franche-comte-france';
$ogTitle      = 'UI UX Design Agency in Bourgogne-Franche-Comté, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Bourgogne-Franche-Comté, France? UX Pacific delivers modern, user-focused digital solutions.';
