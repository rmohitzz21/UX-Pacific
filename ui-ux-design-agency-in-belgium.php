...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Belgium ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Belgium</h2>
      <p class="hub-sub">We serve 13 regions, states, and cities in Belgium. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
