...
$pageTitle    = 'UI UX Design Agency in Agaléga, Mauritius | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Agaléga, Mauritius. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-agalega-mauritius';
$ogTitle      = 'UI UX Design Agency in Agaléga, Mauritius | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Agaléga, Mauritius? UX Pacific delivers modern, user-focused digital solutions.';
