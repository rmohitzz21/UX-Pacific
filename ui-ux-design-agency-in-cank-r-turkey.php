...
$pageTitle    = 'UI UX Design Agency in Çankırı, Turkey | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Çankırı, Turkey. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-cank-r-turkey';
$ogTitle      = 'UI UX Design Agency in Çankırı, Turkey | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Çankırı, Turkey? UX Pacific delivers modern, user-focused digital solutions.';
