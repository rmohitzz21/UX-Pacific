...
$pageTitle    = 'UI UX Design Agency in Cần Thơ, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Cần Thơ, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-can-tho-vietnam';
$ogTitle      = 'UI UX Design Agency in Cần Thơ, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Cần Thơ, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
