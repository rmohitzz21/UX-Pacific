...
$countrySlug = 'tacuarembo-department-uruguay';
...
$pageTitle    = 'UI UX Design Agency in Tacuarembó Department, Uruguay | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Tacuarembó Department, Uruguay. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-tacuarembo-department-uruguay';
$ogTitle      = 'UI UX Design Agency in Tacuarembó Department, Uruguay | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Tacuarembó Department, Uruguay? UX Pacific delivers modern, user-focused digital solutions.';
