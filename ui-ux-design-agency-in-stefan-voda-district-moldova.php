...
$countrySlug = 'stefan-voda-district-moldova';
...
$pageTitle    = 'UI UX Design Agency in Ștefan Vodă District, Moldova | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ștefan Vodă District, Moldova. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-stefan-voda-district-moldova';
$ogTitle      = 'UI UX Design Agency in Ștefan Vodă District, Moldova | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ștefan Vodă District, Moldova? UX Pacific delivers modern, user-focused digital solutions.';
