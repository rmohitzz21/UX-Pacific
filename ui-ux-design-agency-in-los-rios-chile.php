...
$pageTitle    = 'UI UX Design Agency in Los Ríos, Chile | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Los Ríos, Chile. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-los-rios-chile';
$ogTitle      = 'UI UX Design Agency in Los Ríos, Chile | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Los Ríos, Chile? UX Pacific delivers modern, user-focused digital solutions.';
