...
// Child locations in El Salvador
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in El Salvador ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across El Salvador</h2>
      <p class="hub-sub">We serve 14 regions, states, and cities in El Salvador. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
