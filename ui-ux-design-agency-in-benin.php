...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Benin ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Benin</h2>
      <p class="hub-sub">We serve 12 regions, states, and cities in Benin. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
