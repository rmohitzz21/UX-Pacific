...
$countrySlug = 'sanchez-ramirez-province-dominican-republic';
...
$pageTitle    = 'UI UX Design Agency in Sánchez Ramírez Province, Dominican Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Sánchez Ramírez Province, Dominican Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-sanchez-ramirez-province-dominican-republic';
$ogTitle      = 'UI UX Design Agency in Sánchez Ramírez Province, Dominican Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Sánchez Ramírez Province, Dominican Republic? UX Pacific delivers modern, user-focused digital solutions.';
