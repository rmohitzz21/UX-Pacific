...
$countrySlug = 'm-re-og-romsdal-norway';
...
$pageTitle    = 'UI UX Design Agency in Møre og Romsdal, Norway | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Møre og Romsdal, Norway. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-m-re-og-romsdal-norway';
$ogTitle      = 'UI UX Design Agency in Møre og Romsdal, Norway | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Møre og Romsdal, Norway? UX Pacific delivers modern, user-focused digital solutions.';
