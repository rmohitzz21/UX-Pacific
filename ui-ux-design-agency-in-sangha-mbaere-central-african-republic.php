...
$countrySlug = 'sangha-mbaere-central-african-republic';
...
$pageTitle    = 'UI UX Design Agency in Sangha-Mbaéré, Central African Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Sangha-Mbaéré, Central African Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-sangha-mbaere-central-african-republic';
$ogTitle      = 'UI UX Design Agency in Sangha-Mbaéré, Central African Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Sangha-Mbaéré, Central African Republic? UX Pacific delivers modern, user-focused digital solutions.';
