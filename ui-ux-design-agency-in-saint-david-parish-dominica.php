<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Saint David Parish, Dominica | UX Pacific';
$pageDesc        = 'ECSC Model Law-aware UI/UX design for businesses in Saint David Parish, Dominica. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Saint David Parish, UI UX Agency Saint David Parish, UX Design Saint David Parish Dominica, UX Research Saint David Parish, UX Audit Saint David Parish, Usability Testing Saint David Parish, UX Agency Saint David Parish';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-saint-david-parish-dominica';
$ogTitle         = 'UI UX Design Agency in Saint David Parish, Dominica | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving Saint David Parish, Dominica. ECSC Model Law-compliant. UX research, usability testing, and product design. Get a free ';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-saint-david-parish-dominica';
$ogImage         = 'https://www.uxpacific.com/img/og-dominica.jpg';
$ogLocale        = 'en_DM';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Saint David Parish, Dominica?', 'a' => 'Yes. UX Pacific works with businesses in Saint David Parish remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Dominica, including Saint David Parish.'],
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-david-parish-dominica#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-david-parish-dominica",
            "name": "UI UX Design Agency in Saint David Parish, Dominica | UX Pacific",
            "description": "Research-led UI/UX design agency serving Saint David Parish, Dominica with UX research, usability testing, and ECSC Model Law-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Saint David Parish",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-david-parish-dominica"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Saint David Parish, Dominica",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Saint David Parish, Dominica</h2>
    ...
    <div class="t2-wrap t2-section">
      ...
      <p class="t2-sub">Common questions from businesses in Saint David Parish, Dominica exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Saint David Parish, Dominica?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Saint David Parish remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Dominica, including Saint David Parish.</div>
        </div>
        <div class="t2-faq-item">
