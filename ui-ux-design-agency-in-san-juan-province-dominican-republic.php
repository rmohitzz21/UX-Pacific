<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in San Juan Province, Dominican Republic | UX Pacific';
$pageDesc        = 'Law 172-13-aware UI/UX design for businesses in San Juan Province, Dominican Republic. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design San Juan Province, UI UX Agency San Juan Province, UX Design San Juan Province Dominican Republic, UX Research San Juan Province, UX Audit San Juan Province, Usability Testing San Juan Province, UX Agency San Juan Province';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-san-juan-province-dominican-republic';
$ogTitle         = 'UI UX Design Agency in San Juan Province, Dominican Republic | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving San Juan Province, Dominican Republic. Law 172-13-compliant. UX research, usability testing, and product design. Get a ';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-san-juan-province-dominican-republic';
$ogImage         = 'https://www.uxpacific.com/img/og-dominican-republic.jpg';
$ogLocale        = 'es_DO';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in San Juan Province, Dominican Republic?', 'a' => 'Yes. UX Pacific works with businesses in San Juan Province remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Dominican Republic, including San Juan Province.'],
  ['q' => 'How does Law 172-13 affect UX design for businesses in San Juan Province?', 'a' => 'Law 172-13 shapes how consent flows, privacy notices, and data collection forms are designed. We integrate Law 172-13 requirements from day one, building user trust through transparent UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'How much does UX design cost for a business in San Juan Province?', 'a' => 'Investment varies by scope. A focused UX audit starts at a fixed fee; a full product design engagement is scoped per project. We offer transparent, milestone-based pricing. Contact us with your product details for an estimate. See the full UI/UX design services in Dominican Republic page for more context.'],
  ...
  ['q' => 'How quickly do you respond to enquiries from San Juan Province?', 'a' => 'We respond to all qualified enquiries within one business day. We work across AST (UTC-4) and are flexible on meeting times. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-san-juan-province-dominican-republic#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-san-juan-province-dominican-republic",
            "name": "UI UX Design Agency in San Juan Province, Dominican Republic | UX Pacific",
            "description": "Research-led UI/UX design agency serving San Juan Province, Dominican Republic with UX research, usability testing, and Law 172-13-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "San Juan Province",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-san-juan-province-dominican-republic"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in San Juan Province, Dominican Republic",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving San Juan Province, Dominican Republic
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN San Juan Province</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping businesses in San Juan Province, Dominican Republic make better product decisions through UX Research, Usability Testing, Product Discovery and Human-Centered UI Design. Law 172-13-compliant. IST-friendly remote collaboration.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for businesses in San Juan Province.</p>
    ...
    <div class="t2-wrap t2-section">
      <span class="t2-label">UI/UX Design in San Juan Province</span>
      <h2 class="t2-h2">Research-Led UX Design for Businesses in San Juan Province, Dominican Republic</h2>
      <p class="t2-sub">Every engagement begins with users, evidence, and business goals. We serve companies in San Juan Province remotely — with structured UX research, usability testing, UI design, and Law 172-13-compliant product design.</p>

      <div class="t2-grid t2-grid-3">
        <div class="t2-svc">
          <h3>UX Research &amp; Audit</h3>
          <p>User interviews, heuristic evaluation, journey mapping, and usability testing for products used in San Juan Province. We identify where users drop off and why.</p>
        </div>
        <div class="t2-svc">
        ...
        <div class="t2-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product is usable by every member of your audience in San Juan Province.</p>
        </div>
      </div>
    </div>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Frequently Asked Questions — UI/UX Design in San Juan Province</h2>
      <p class="t2-sub">Common questions from businesses in San Juan Province, Dominican Republic exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in San Juan Province, Dominican Republic?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in San Juan Province remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Dominican Republic, including San Juan Province.</div>
        </div>
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How does Law 172-13 affect UX design for businesses in San Juan Province?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How much does UX design cost for a business in San Juan Province?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How quickly do you respond to enquiries from San Juan Province?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
    ...
    <div class="t2-wrap t2-section">
      <div class="t2-cta-box">
        ...
        <h2>Book a Free UX Audit for Your San Juan Province Product</h2>
