...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Guyana ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Guyana</h2>
      <p class="hub-sub">We serve 10 regions, states, and cities in Guyana. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
