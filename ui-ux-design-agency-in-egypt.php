...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Egypt ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Egypt</h2>
      <p class="hub-sub">We serve 27 regions, states, and cities in Egypt. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
