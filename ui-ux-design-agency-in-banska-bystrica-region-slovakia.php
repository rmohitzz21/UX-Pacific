...
$countrySlug = 'banska-bystrica-region-slovakia';
...
$pageTitle    = 'UI UX Design Agency in Banská Bystrica Region, Slovakia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Banská Bystrica Region, Slovakia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-banska-bystrica-region-slovakia';
$ogTitle      = 'UI UX Design Agency in Banská Bystrica Region, Slovakia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Banská Bystrica Region, Slovakia? UX Pacific delivers modern, user-focused digital solutions.';
