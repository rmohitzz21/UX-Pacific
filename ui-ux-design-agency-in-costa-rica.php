...
$pageTitle       = 'UI UX Design Agency in Costa Rica | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Costa Rica. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Costa Rica, UI UX Agency Costa Rica, UX Design Costa Rica, UX Research Costa Rica, UI Design Costa Rica, Product Design Costa Rica, UX Audit Costa Rica, Usability Testing Costa Rica, UX Consultant Costa Rica, UX Company Costa Rica, Design System Costa Rica';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-costa-rica';
$ogTitle         = 'UI UX Design Agency in Costa Rica | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Costa Rica. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-costa-rica';
$ogImage         = 'https://www.uxpacific.com/img/og-costa-rica.jpg';
$ogLocale        = 'es_CR';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Costa Rica?', 'a' => 'Yes. UX Pacific supports Costa Rica businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Costa Rica.'],
  ['q' => 'How does Law 8968 affect UX design for Costa Rica businesses?', 'a' => 'Law 8968 directly shapes consent flows, data collection forms, and privacy communications. We integrate Law 8968 requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Costa Rica?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Costa Rica?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Costa Rica. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Costa Rica business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Costa Rica accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Costa Rica. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Costa Rica businesses expect.'],
  ['q' => 'How does remote collaboration work for Costa Rica clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Costa Rica clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Costa Rica?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-costa-rica#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-costa-rica',
      'name'          => 'UI UX Design Agency in Costa Rica | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Costa Rica. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
    ...
    [
      ...
      'itemListElement' => [
        ...
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Costa Rica',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-costa-rica'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Costa Rica',
...
$hubChildren = [
  ['name' => 'Alajuela Province', 'url' => '/ui-ux-design-agency-in-alajuela-province-costa-rica', 'basename' => 'ui-ux-design-agency-in-alajuela-province-costa-rica'],
  ['name' => 'Guanacaste Province', 'url' => '/ui-ux-design-agency-in-guanacaste-province-costa-rica', 'basename' => 'ui-ux-design-agency-in-guanacaste-province-costa-rica'],
  ['name' => 'Heredia Province', 'url' => '/ui-ux-design-agency-in-heredia-province-costa-rica', 'basename' => 'ui-ux-design-agency-in-heredia-province-costa-rica'],
  ['name' => 'Limón Province', 'url' => '/ui-ux-design-agency-in-limon-province-costa-rica', 'basename' => 'ui-ux-design-agency-in-limon-province-costa-rica'],
  ['name' => 'Provincia de Cartago', 'url' => '/ui-ux-design-agency-in-provincia-de-cartago-costa-rica', 'basename' => 'ui-ux-design-agency-in-provincia-de-cartago-costa-rica'],
  ['name' => 'Puntarenas Province', 'url' => '/ui-ux-design-agency-in-puntarenas-province-costa-rica', 'basename' => 'ui-ux-design-agency-in-puntarenas-province-costa-rica'],
  ['name' => 'San José Province', 'url' => '/ui-ux-design-agency-in-san-jose-province-costa-rica', 'basename' => 'ui-ux-design-agency-in-san-jose-province-costa-rica'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Costa Rica
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Costa Rica</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Costa Rica startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Costa Rica businesses.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Costa Rica Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          ...
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Costa Rica regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets Costa Rica regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Costa Rica.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to WCAG 2.1 AA standards and Law 8968-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, Law 8968 compliance risks, and navigation problems — each prioritised by business impact.</p></div>
      ...
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>Law 8968 and accessibility treated as afterthoughts</td><td>Law 8968 compliance and WCAG 2.1 AA accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and Law 8968 requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Costa Rica</h2>
      <p class="de-sub">Common questions from Costa Rica startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">We serve businesses in 7 regions, states, and cities in Costa Rica. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Costa Rica Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and Law 8968 compliance.</p></div>
          </div>
          <div class="de-proc-step">
