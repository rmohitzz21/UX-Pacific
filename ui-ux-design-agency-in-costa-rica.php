...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Costa Rica ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Costa Rica</h2>
      <p class="hub-sub">We serve 7 regions, states, and cities in Costa Rica. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
