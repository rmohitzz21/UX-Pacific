...
$countrySlug = 'paysandu-department-uruguay';
...
$pageTitle    = 'UI UX Design Agency in Paysandú Department, Uruguay | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Paysandú Department, Uruguay. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-paysandu-department-uruguay';
$ogTitle      = 'UI UX Design Agency in Paysandú Department, Uruguay | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Paysandú Department, Uruguay? UX Pacific delivers modern, user-focused digital solutions.';
