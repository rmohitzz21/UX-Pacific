...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Seychelles ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Seychelles</h2>
      <p class="hub-sub">We serve 24 regions, states, and cities in Seychelles. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
