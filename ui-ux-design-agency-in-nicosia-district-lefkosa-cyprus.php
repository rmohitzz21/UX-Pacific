...
$countrySlug = 'nicosia-district-lefkosa-cyprus';
...
$pageTitle    = 'UI UX Design Agency in Nicosia District (Lefkoşa), Cyprus | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Nicosia District (Lefkoşa), Cyprus. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-nicosia-district-lefkosa-cyprus';
$ogTitle      = 'UI UX Design Agency in Nicosia District (Lefkoşa), Cyprus | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Nicosia District (Lefkoşa), Cyprus? UX Pacific delivers modern, user-focused digital solutions.';
