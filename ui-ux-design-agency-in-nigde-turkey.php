...
$pageTitle    = 'UI UX Design Agency in Niğde, Turkey | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Niğde, Turkey. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-nigde-turkey';
$ogTitle      = 'UI UX Design Agency in Niğde, Turkey | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Niğde, Turkey? UX Pacific delivers modern, user-focused digital solutions.';
