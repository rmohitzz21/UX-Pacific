...
$pageTitle       = 'UI UX Design Agency in Sri Lanka | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Sri Lanka. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Sri Lanka, UI UX Agency Sri Lanka, UX Design Sri Lanka, UX Research Sri Lanka, UI Design Sri Lanka, Product Design Sri Lanka, UX Audit Sri Lanka, Usability Testing Sri Lanka, UX Consultant Sri Lanka, UX Company Sri Lanka, Design System Sri Lanka';
$metaAuthor      = 'UXPACIFIC';
$metaRobots      = 'index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1';
$themeColor      = '#080808';
$geoRegion       = 'LK';
$geoCountry      = 'Sri Lanka';
$contentLanguage = 'en-LK';
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-sri-lanka';
$ogTitle         = 'UI UX Design Agency in Sri Lanka | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Sri Lanka. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-sri-lanka';
$ogImage         = 'https://www.uxpacific.com/img/og-sri-lanka.jpg';
$ogLocale        = 'en_LK';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Sri Lanka?', 'a' => 'Yes. UX Pacific supports Sri Lanka businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Sri Lanka.'],
  ['q' => 'How does PDPA (Sri Lanka) affect UX design for Sri Lanka businesses?', 'a' => 'PDPA (Sri Lanka) directly shapes consent flows, data collection forms, and privacy communications. We integrate PDPA (Sri Lanka) requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Sri Lanka?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Sri Lanka?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Sri Lanka. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Sri Lanka business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Sri Lanka accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Sri Lanka. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Sri Lanka businesses expect.'],
  ['q' => 'How does remote collaboration work for Sri Lanka clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Sri Lanka clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Sri Lanka?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-sri-lanka#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-sri-lanka',
      'name'          => 'UI UX Design Agency in Sri Lanka | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Sri Lanka. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
      'datePublished' => '2026-06-26',
      'dateModified'  => '2026-06-29',
      'about'         => ['@type' => 'Country', 'name' => 'Sri Lanka'],
    ],
    [
      '@type'           => 'BreadcrumbList',
      'itemListElement' => [
        ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home',      'item' => 'https://www.uxpacific.com/'],
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Sri Lanka',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-sri-lanka'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Sri Lanka',
      'provider'    => ['@id' => 'https://www.uxpacific.com/#organization'],
      'areaServed'  => ['@type' => 'Country', 'name' => 'Sri Lanka'],
      'serviceType' => 'UI UX Design, UX Research, Usability Testing, UX Audit, Product Discovery, Design Systems, PDPA (Sri Lanka)-Compliant UX',
      'url'         => 'https://www.uxpacific.com/ui-ux-design-agency-in-sri-lanka',
    ],
...
$hubChildren = [
  ['name' => 'Ampara District', 'url' => '/ui-ux-design-agency-in-ampara-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-ampara-district-sri-lanka'],
  ['name' => 'Anuradhapura District', 'url' => '/ui-ux-design-agency-in-anuradhapura-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-anuradhapura-district-sri-lanka'],
  ['name' => 'Badulla District', 'url' => '/ui-ux-design-agency-in-badulla-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-badulla-district-sri-lanka'],
  ['name' => 'Batticaloa District', 'url' => '/ui-ux-design-agency-in-batticaloa-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-batticaloa-district-sri-lanka'],
  ['name' => 'Central Province', 'url' => '/ui-ux-design-agency-in-central-province-sri-lanka', 'basename' => 'ui-ux-design-agency-in-central-province-sri-lanka'],
  ['name' => 'Colombo District', 'url' => '/ui-ux-design-agency-in-colombo-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-colombo-district-sri-lanka'],
  ['name' => 'Eastern Province', 'url' => '/ui-ux-design-agency-in-eastern-province-sri-lanka', 'basename' => 'ui-ux-design-agency-in-eastern-province-sri-lanka'],
  ['name' => 'Galle District', 'url' => '/ui-ux-design-agency-in-galle-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-galle-district-sri-lanka'],
  ['name' => 'Gampaha District', 'url' => '/ui-ux-design-agency-in-gampaha-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-gampaha-district-sri-lanka'],
  ['name' => 'Hambantota District', 'url' => '/ui-ux-design-agency-in-hambantota-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-hambantota-district-sri-lanka'],
  ['name' => 'Jaffna District', 'url' => '/ui-ux-design-agency-in-jaffna-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-jaffna-district-sri-lanka'],
  ['name' => 'Kalutara District', 'url' => '/ui-ux-design-agency-in-kalutara-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-kalutara-district-sri-lanka'],
  ['name' => 'Kandy District', 'url' => '/ui-ux-design-agency-in-kandy-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-kandy-district-sri-lanka'],
  ['name' => 'Kegalle District', 'url' => '/ui-ux-design-agency-in-kegalle-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-kegalle-district-sri-lanka'],
  ['name' => 'Kilinochchi District', 'url' => '/ui-ux-design-agency-in-kilinochchi-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-kilinochchi-district-sri-lanka'],
  ['name' => 'Mannar District', 'url' => '/ui-ux-design-agency-in-mannar-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-mannar-district-sri-lanka'],
  ['name' => 'Matale District', 'url' => '/ui-ux-design-agency-in-matale-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-matale-district-sri-lanka'],
  ['name' => 'Matara District', 'url' => '/ui-ux-design-agency-in-matara-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-matara-district-sri-lanka'],
  ['name' => 'Monaragala District', 'url' => '/ui-ux-design-agency-in-monaragala-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-monaragala-district-sri-lanka'],
  ['name' => 'Mullaitivu District', 'url' => '/ui-ux-design-agency-in-mullaitivu-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-mullaitivu-district-sri-lanka'],
  ['name' => 'North Central Province', 'url' => '/ui-ux-design-agency-in-north-central-province-sri-lanka', 'basename' => 'ui-ux-design-agency-in-north-central-province-sri-lanka'],
  ['name' => 'North Western Province', 'url' => '/ui-ux-design-agency-in-north-western-province-sri-lanka', 'basename' => 'ui-ux-design-agency-in-north-western-province-sri-lanka'],
  ['name' => 'Northern Province', 'url' => '/ui-ux-design-agency-in-northern-province-sri-lanka', 'basename' => 'ui-ux-design-agency-in-northern-province-sri-lanka'],
  ['name' => 'Nuwara Eliya District', 'url' => '/ui-ux-design-agency-in-nuwara-eliya-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-nuwara-eliya-district-sri-lanka'],
  ['name' => 'Polonnaruwa District', 'url' => '/ui-ux-design-agency-in-polonnaruwa-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-polonnaruwa-district-sri-lanka'],
  ['name' => 'Puttalam District', 'url' => '/ui-ux-design-agency-in-puttalam-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-puttalam-district-sri-lanka'],
  ['name' => 'Ratnapura district', 'url' => '/ui-ux-design-agency-in-ratnapura-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-ratnapura-district-sri-lanka'],
  ['name' => 'Sabaragamuwa Province', 'url' => '/ui-ux-design-agency-in-sabaragamuwa-province-sri-lanka', 'basename' => 'ui-ux-design-agency-in-sabaragamuwa-province-sri-lanka'],
  ['name' => 'Southern Province', 'url' => '/ui-ux-design-agency-in-southern-province-sri-lanka', 'basename' => 'ui-ux-design-agency-in-southern-province-sri-lanka'],
  ['name' => 'Trincomalee District', 'url' => '/ui-ux-design-agency-in-trincomalee-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-trincomalee-district-sri-lanka'],
  ['name' => 'Uva Province', 'url' => '/ui-ux-design-agency-in-uva-province-sri-lanka', 'basename' => 'ui-ux-design-agency-in-uva-province-sri-lanka'],
  ['name' => 'Vavuniya District', 'url' => '/ui-ux-design-agency-in-vavuniya-district-sri-lanka', 'basename' => 'ui-ux-design-agency-in-vavuniya-district-sri-lanka'],
  ['name' => 'Western Province', 'url' => '/ui-ux-design-agency-in-western-province-sri-lanka', 'basename' => 'ui-ux-design-agency-in-western-province-sri-lanka'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Sri Lanka
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Sri Lanka</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Sri Lanka startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Sri Lanka businesses.</p>
      ...
      <div class="de-grid de-grid-4" style="margin-top:1.8rem">
        ...
        <div class="de-card">
          <span class="de-card-icon">&#128737;</span>
          <h3>PDPA (Sri Lanka)-Aware Approach</h3>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Sri Lanka Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          <h3>PDPA (Sri Lanka)-Compliant UX</h3>
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Sri Lanka regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets Sri Lanka regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Sri Lanka.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to WCAG 2.1 AA standards and PDPA (Sri Lanka)-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, PDPA (Sri Lanka) compliance risks, and navigation problems — each prioritised by business impact.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Most agencies start with screens. We start with research. Here is what that difference looks like in practice for Sri Lanka businesses.</p>
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>PDPA (Sri Lanka) and accessibility treated as afterthoughts</td><td>PDPA (Sri Lanka) compliance and WCAG 2.1 AA accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <p class="de-sub">A structured, transparent workflow designed for Sri Lanka and international teams that need clarity, speed, and reliable communication at every stage.</p>
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and PDPA (Sri Lanka) requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Sri Lanka</h2>
      <p class="de-sub">Common questions from Sri Lanka startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services Across Sri Lanka</h2>
      <p class="de-sub">We serve businesses in 33 regions, states, and cities in Sri Lanka. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Sri Lanka Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and PDPA (Sri Lanka) compliance.</p></div>
          </div>
          <div class="de-proc-step">
