...
$countrySlug = 'gagaifomauga-samoa';
...
$pageTitle    = 'UI UX Design Agency in Gaga\'ifomauga, Samoa | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Gaga\'ifomauga, Samoa. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-gagaifomauga-samoa';
$ogTitle      = 'UI UX Design Agency in Gaga\'ifomauga, Samoa | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Gaga\'ifomauga, Samoa? UX Pacific delivers modern, user-focused digital solutions.';
