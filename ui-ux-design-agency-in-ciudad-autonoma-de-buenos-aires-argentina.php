...
$countrySlug = 'ciudad-autonoma-de-buenos-aires-argentina';
...
$pageTitle    = 'UI UX Design Agency in Ciudad Autónoma de Buenos Aires, Argentina | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ciudad Autónoma de Buenos Aires, Argentina. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ciudad-autonoma-de-buenos-aires-argentina';
$ogTitle      = 'UI UX Design Agency in Ciudad Autónoma de Buenos Aires, Argentina | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ciudad Autónoma de Buenos Aires, Argentina? UX Pacific delivers modern, user-focused digital solutions.';
