...
// Child locations in Papua New Guinea
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Papua New Guinea ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Papua New Guinea</h2>
      <p class="hub-sub">We serve 21 regions, states, and cities in Papua New Guinea. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
