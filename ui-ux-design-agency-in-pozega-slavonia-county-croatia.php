...
$countrySlug = 'pozega-slavonia-county-croatia';
...
$pageTitle    = 'UI UX Design Agency in Požega-Slavonia County, Croatia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Požega-Slavonia County, Croatia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-pozega-slavonia-county-croatia';
$ogTitle      = 'UI UX Design Agency in Požega-Slavonia County, Croatia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Požega-Slavonia County, Croatia? UX Pacific delivers modern, user-focused digital solutions.';
