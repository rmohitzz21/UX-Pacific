...
$countrySlug = 'trebic-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Třebíč, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Třebíč, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-trebic-czech-republic';
$ogTitle      = 'UI UX Design Agency in Třebíč, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Třebíč, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
