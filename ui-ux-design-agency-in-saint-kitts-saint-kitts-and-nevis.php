<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Saint Kitts, Saint Kitts and Nevis | UX Pacific';
$pageDesc        = 'OECS Digital Economy Framework-aware UI/UX design for businesses in Saint Kitts, Saint Kitts and Nevis. UX research, usability testing & product design. Book a ';
$metaKeywords    = 'UI UX Design Saint Kitts, UI UX Agency Saint Kitts, UX Design Saint Kitts Saint Kitts and Nevis, UX Research Saint Kitts, UX Audit Saint Kitts, Usability Testing Saint Kitts, UX Agency Saint Kitts';
...
$_gFaqs = [
  ...
  ['q' => 'How quickly do you respond to enquiries from Saint Kitts?', 'a' => 'We respond to all qualified enquiries within one business day. We work across AST (UTC-4) and are flexible on meeting times. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-kitts-saint-kitts-and-nevis#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-kitts-saint-kitts-and-nevis",
            "name": "UI UX Design Agency in Saint Kitts, Saint Kitts and Nevis | UX Pacific",
            "description": "Research-led UI/UX design agency serving Saint Kitts, Saint Kitts and Nevis with UX research, usability testing, and OECS Digital Economy Framework-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Saint Kitts",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-kitts-saint-kitts-and-nevis"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Saint Kitts, Saint Kitts and Nevis",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Saint Kitts, Saint Kitts and Nevis
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Saint Kitts</span></h1>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for businesses in Saint Kitts.</p>
    ...
    <div class="t2-wrap t2-section">
      <span class="t2-label">UI/UX Design in Saint Kitts</span>
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Saint Kitts, Saint Kitts and Nevis</h2>
      <p class="t2-sub">Every engagement begins with users, evidence, and business goals. We serve companies in Saint Kitts remotely — with structured UX research, usability testing, UI design, and OECS Digital Economy Framework-compliant product design.</p>

      <div class="t2-grid t2-grid-3">
        <div class="t2-svc">
          <h3>UX Research &amp; Audit</h3>
          <p>User interviews, heuristic evaluation, journey mapping, and usability testing for products used in Saint Kitts. We identify where users drop off and why.</p>
        </div>
        <div class="t2-svc">
        ...
        <div class="t2-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product is usable by every member of your audience in Saint Kitts.</p>
        </div>
      </div>
    </div>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Frequently Asked Questions — UI/UX Design in Saint Kitts</h2>
      <p class="t2-sub">Common questions from businesses in Saint Kitts, Saint Kitts and Nevis exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Saint Kitts, Saint Kitts and Nevis?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Saint Kitts remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Saint Kitts and Nevis, including Saint Kitts.</div>
        </div>
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How does OECS Digital Economy Framework affect UX design for businesses in Saint Kitts?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How much does UX design cost for a business in Saint Kitts?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How quickly do you respond to enquiries from Saint Kitts?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
    ...
    <div class="t2-wrap t2-section">
      <div class="t2-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Saint Kitts Product</h2>
