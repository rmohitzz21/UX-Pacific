<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Hobart, Australia | UX Pacific';
$pageDesc        = 'Privacy Act 1988-aware UI/UX design for businesses in Hobart, Australia. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Hobart, UI UX Agency Hobart, UX Design Hobart Australia, UX Research Hobart, UX Audit Hobart, Usability Testing Hobart, UX Agency Hobart';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-hobart-australia';
$ogTitle         = 'UI UX Design Agency in Hobart, Australia | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving Hobart, Australia. Privacy Act 1988-compliant. UX research, usability testing, and product design. Get a free audit.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-hobart-australia';
$ogImage         = 'https://www.uxpacific.com/img/og-australia.jpg';
$ogLocale        = 'en_AU';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Hobart, Australia?', 'a' => 'Yes. UX Pacific works with businesses in Hobart remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Australia, including Hobart.'],
  ['q' => 'How does Privacy Act 1988 affect UX design for businesses in Hobart?', 'a' => 'Privacy Act 1988 shapes how consent flows, privacy notices, and data collection forms are designed. We integrate Privacy Act 1988 requirements from day one, building user trust through transparent UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'How much does UX design cost for a business in Hobart?', 'a' => 'Investment varies by scope. A focused UX audit starts at a fixed fee; a full product design engagement is scoped per project. We offer transparent, milestone-based pricing. Contact us with your product details for an estimate. See the full UI/UX design services in Australia page for more context.'],
  ...
  ['q' => 'How quickly do you respond to enquiries from Hobart?', 'a' => 'We respond to all qualified enquiries within one business day. We work across AEST / AWST and are flexible on meeting times. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-hobart-australia#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-hobart-australia",
            "name": "UI UX Design Agency in Hobart, Australia | UX Pacific",
            "description": "Research-led UI/UX design agency serving Hobart, Australia with UX research, usability testing, and Privacy Act 1988-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Hobart",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-hobart-australia"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Hobart, Australia",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Hobart, Australia
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Hobart</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping businesses in Hobart, Australia make better product decisions through UX Research, Usability Testing, Product Discovery and Human-Centered UI Design. Privacy Act 1988-compliant. IST-friendly remote collaboration.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for businesses in Hobart.</p>
    ...
    <div class="t2-wrap t2-section">
      <span class="t2-label">UI/UX Design in Hobart</span>
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Hobart, Australia</h2>
      <p class="t2-sub">Every engagement begins with users, evidence, and business goals. We serve companies in Hobart remotely — with structured UX research, usability testing, UI design, and Privacy Act 1988-compliant product design.</p>

      <div class="t2-grid t2-grid-3">
        <div class="t2-svc">
          <h3>UX Research &amp; Audit</h3>
          <p>User interviews, heuristic evaluation, journey mapping, and usability testing for products used in Hobart. We identify where users drop off and why.</p>
        </div>
        <div class="t2-svc">
        ...
        <div class="t2-svc">
          ...
          <p>Design to DDA / WCAG 2.1 standards — ensuring your product is usable by every member of your audience in Hobart.</p>
        </div>
      </div>
    </div>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Frequently Asked Questions — UI/UX Design in Hobart</h2>
      <p class="t2-sub">Common questions from businesses in Hobart, Australia exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Hobart, Australia?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Hobart remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Australia, including Hobart.</div>
        </div>
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How does Privacy Act 1988 affect UX design for businesses in Hobart?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How much does UX design cost for a business in Hobart?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How quickly do you respond to enquiries from Hobart?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
    ...
    <div class="t2-wrap t2-section">
      <div class="t2-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Hobart Product</h2>
