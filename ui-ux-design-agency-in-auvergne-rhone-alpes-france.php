...
$countrySlug = 'auvergne-rhone-alpes-france';
...
$pageTitle    = 'UI UX Design Agency in Auvergne-Rhône-Alpes, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Auvergne-Rhône-Alpes, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-auvergne-rhone-alpes-france';
$ogTitle      = 'UI UX Design Agency in Auvergne-Rhône-Alpes, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Auvergne-Rhône-Alpes, France? UX Pacific delivers modern, user-focused digital solutions.';
