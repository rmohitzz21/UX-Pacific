...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Ghana ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Ghana</h2>
      <p class="hub-sub">We serve 16 regions, states, and cities in Ghana. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
