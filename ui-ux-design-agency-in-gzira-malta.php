...
$pageTitle    = 'UI UX Design Agency in Gżira, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Gżira, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-gzira-malta';
$ogTitle      = 'UI UX Design Agency in Gżira, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Gżira, Malta? UX Pacific delivers modern, user-focused digital solutions.';
