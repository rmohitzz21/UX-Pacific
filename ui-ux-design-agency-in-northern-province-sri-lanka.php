<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Northern Province, Sri Lanka | UX Pacific';
$pageDesc        = 'PDPA (Sri Lanka)-aware UI/UX design for businesses in Northern Province, Sri Lanka. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Northern Province, UI UX Agency Northern Province, UX Design Northern Province Sri Lanka, UX Research Northern Province, UX Audit Northern Province, Usability Testing Northern Province, UX Agency Northern Province';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-northern-province-sri-lanka';
$ogTitle         = 'UI UX Design Agency in Northern Province, Sri Lanka | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving Northern Province, Sri Lanka. PDPA (Sri Lanka)-compliant. UX research, usability testing, and product design. Get a fre';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-northern-province-sri-lanka';
$ogImage         = 'https://www.uxpacific.com/img/og-sri-lanka.jpg';
$ogLocale        = 'en_LK';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Northern Province, Sri Lanka?', 'a' => 'Yes. UX Pacific works with businesses in Northern Province remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Sri Lanka, including Northern Province.'],
  ['q' => 'How does PDPA (Sri Lanka) affect UX design for businesses in Northern Province?', 'a' => 'PDPA (Sri Lanka) shapes how consent flows, privacy notices, and data collection forms are designed. We integrate PDPA (Sri Lanka) requirements from day one, building user trust through transparent UX patterns rather than treating compliance as an afterthought.'],
  ...
  ['q' => 'How quickly do you respond to enquiries from Northern Province?', 'a' => 'We respond to all qualified enquiries within one business day. We work across IST (UTC+5:30) and are flexible on meeting times. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-northern-province-sri-lanka#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-northern-province-sri-lanka",
            "name": "UI UX Design Agency in Northern Province, Sri Lanka | UX Pacific",
            "description": "Research-led UI/UX design agency serving Northern Province, Sri Lanka with UX research, usability testing, and PDPA (Sri Lanka)-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Northern Province",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-northern-province-sri-lanka"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Northern Province, Sri Lanka",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Northern Province, Sri Lanka
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Northern Province</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping businesses in Northern Province, Sri Lanka make better product decisions through UX Research, Usability Testing, Product Discovery and Human-Centered UI Design. PDPA (Sri Lanka)-compliant. IST-friendly remote collaboration.</p>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Northern Province, Sri Lanka</h2>
      <p class="t2-sub">Every engagement begins with users, evidence, and business goals. We serve companies in Northern Province remotely — with structured UX research, usability testing, UI design, and PDPA (Sri Lanka)-compliant product design.</p>
    ...
    <div class="t2-wrap t2-section">
      ...
      <p class="t2-sub">Common questions from businesses in Northern Province, Sri Lanka exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Northern Province, Sri Lanka?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Northern Province remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Sri Lanka, including Northern Province.</div>
        </div>
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How does PDPA (Sri Lanka) affect UX design for businesses in Northern Province?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
