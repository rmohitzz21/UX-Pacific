...
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Lima, Peru. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-lima-peru';
$ogTitle      = 'UI UX Design Agency in Lima, Peru | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Lima, Peru? UX Pacific delivers modern, user-focused digital solutions.';
