...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Jamaica ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Jamaica</h2>
      <p class="hub-sub">We serve 14 regions, states, and cities in Jamaica. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
