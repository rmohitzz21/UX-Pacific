...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Mongolia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Mongolia</h2>
      <p class="hub-sub">We serve 21 regions, states, and cities in Mongolia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
