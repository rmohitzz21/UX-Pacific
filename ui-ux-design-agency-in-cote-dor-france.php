...
$pageTitle    = 'UI UX Design Agency in Côte-d\'Or, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Côte-d\'Or, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-cote-dor-france';
$ogTitle      = 'UI UX Design Agency in Côte-d\'Or, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Côte-d\'Or, France? UX Pacific delivers modern, user-focused digital solutions.';
