...
$pageTitle    = 'UI UX Design Agency in Şırnak, Turkey | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Şırnak, Turkey. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-s-rnak-turkey';
$ogTitle      = 'UI UX Design Agency in Şırnak, Turkey | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Şırnak, Turkey? UX Pacific delivers modern, user-focused digital solutions.';
