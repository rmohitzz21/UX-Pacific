...
$countrySlug = 'morazan-department-el-salvador';
...
$pageTitle    = 'UI UX Design Agency in Morazán Department, El Salvador | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Morazán Department, El Salvador. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-morazan-department-el-salvador';
$ogTitle      = 'UI UX Design Agency in Morazán Department, El Salvador | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Morazán Department, El Salvador? UX Pacific delivers modern, user-focused digital solutions.';
