...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Senegal ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Senegal</h2>
      <p class="hub-sub">We serve 14 regions, states, and cities in Senegal. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
