...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Honduras ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Honduras</h2>
      <p class="hub-sub">We serve 18 regions, states, and cities in Honduras. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
