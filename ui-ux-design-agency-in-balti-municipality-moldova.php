...
$countrySlug = 'balti-municipality-moldova';
...
$pageTitle    = 'UI UX Design Agency in Bălți Municipality, Moldova | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Bălți Municipality, Moldova. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-balti-municipality-moldova';
$ogTitle      = 'UI UX Design Agency in Bălți Municipality, Moldova | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Bălți Municipality, Moldova? UX Pacific delivers modern, user-focused digital solutions.';
