...
$countrySlug = 'tien-giang-vietnam';
...
$pageTitle    = 'UI UX Design Agency in Tiền Giang, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Tiền Giang, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-tien-giang-vietnam';
$ogTitle      = 'UI UX Design Agency in Tiền Giang, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Tiền Giang, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
