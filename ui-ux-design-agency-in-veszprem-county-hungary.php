...
$countrySlug = 'veszprem-county-hungary';
...
$pageTitle    = 'UI UX Design Agency in Veszprém County, Hungary | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Veszprém County, Hungary. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-veszprem-county-hungary';
$ogTitle      = 'UI UX Design Agency in Veszprém County, Hungary | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Veszprém County, Hungary? UX Pacific delivers modern, user-focused digital solutions.';
