...
$countrySlug = 'el-paraiso-department-honduras';
...
$pageTitle    = 'UI UX Design Agency in El Paraíso Department, Honduras | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in El Paraíso Department, Honduras. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-el-paraiso-department-honduras';
$ogTitle      = 'UI UX Design Agency in El Paraíso Department, Honduras | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in El Paraíso Department, Honduras? UX Pacific delivers modern, user-focused digital solutions.';
