...
$pageTitle    = 'UI UX Design Agency in Hải Phòng, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Hải Phòng, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-hai-phong-vietnam';
$ogTitle      = 'UI UX Design Agency in Hải Phòng, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Hải Phòng, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
