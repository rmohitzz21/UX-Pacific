...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Micronesia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Micronesia</h2>
      <p class="hub-sub">We serve 4 regions, states, and cities in Micronesia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
