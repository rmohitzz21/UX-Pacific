...
$pageDesc    = 'UX Pacific delivers expert UI/UX design services across The Gambia. Browse our locations or book a free UX audit today.';
...
$ogDesc      = 'UX Pacific delivers expert UI/UX design services across The Gambia. Browse our locations or book a free UX audit today.';
  ...
  '@graph'   => [
    ...
    ['@type' => 'BreadcrumbList',
     'itemListElement' => [
       ...
       ['@type' => 'ListItem', 'position' => 2, 'name' => 'The Gambia', 'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-the-gambia'],
     ],
    ],
  ],
...
// Child locations in The Gambia
$hubChildren = [
  ['name' => 'Banjul', 'url' => '/ui-ux-design-agency-in-banjul-the-gambia', 'basename' => 'ui-ux-design-agency-in-banjul-the-gambia'],
  ['name' => 'Central River Division', 'url' => '/ui-ux-design-agency-in-central-river-division-the-gambia', 'basename' => 'ui-ux-design-agency-in-central-river-division-the-gambia'],
  ['name' => 'Lower River Division', 'url' => '/ui-ux-design-agency-in-lower-river-division-the-gambia', 'basename' => 'ui-ux-design-agency-in-lower-river-division-the-gambia'],
  ['name' => 'North Bank Division', 'url' => '/ui-ux-design-agency-in-north-bank-division-the-gambia', 'basename' => 'ui-ux-design-agency-in-north-bank-division-the-gambia'],
  ['name' => 'Upper River Division', 'url' => '/ui-ux-design-agency-in-upper-river-division-the-gambia', 'basename' => 'ui-ux-design-agency-in-upper-river-division-the-gambia'],
  ['name' => 'West Coast Division', 'url' => '/ui-ux-design-agency-in-west-coast-division-the-gambia', 'basename' => 'ui-ux-design-agency-in-west-coast-division-the-gambia'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in The Gambia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across The Gambia</h2>
      <p class="hub-sub">We serve 6 regions, states, and cities in The Gambia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
