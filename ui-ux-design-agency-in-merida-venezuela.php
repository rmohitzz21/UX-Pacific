...
$pageTitle    = 'UI UX Design Agency in Mérida, Venezuela | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Mérida, Venezuela. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-merida-venezuela';
$ogTitle      = 'UI UX Design Agency in Mérida, Venezuela | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Mérida, Venezuela? UX Pacific delivers modern, user-focused digital solutions.';
