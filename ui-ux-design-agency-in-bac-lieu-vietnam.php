...
$pageTitle    = 'UI UX Design Agency in Bạc Liêu, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Bạc Liêu, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-bac-lieu-vietnam';
$ogTitle      = 'UI UX Design Agency in Bạc Liêu, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Bạc Liêu, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
