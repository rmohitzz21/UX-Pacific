...
$countrySlug = 'quang-ninh-vietnam';
...
$pageTitle    = 'UI UX Design Agency in Quảng Ninh, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Quảng Ninh, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-quang-ninh-vietnam';
$ogTitle      = 'UI UX Design Agency in Quảng Ninh, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Quảng Ninh, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
