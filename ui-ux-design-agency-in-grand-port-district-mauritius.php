<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Grand Port District, Mauritius | UX Pacific';
$pageDesc        = 'DPA 2017 (Mauritius)-aware UI/UX design for businesses in Grand Port District, Mauritius. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Grand Port District, UI UX Agency Grand Port District, UX Design Grand Port District Mauritius, UX Research Grand Port District, UX Audit Grand Port District, Usability Testing Grand Port District, UX Agency Grand Port District';
...
$_gFaqs = [
  ...
  ['q' => 'How quickly do you respond to enquiries from Grand Port District?', 'a' => 'We respond to all qualified enquiries within one business day. We work across MUT (UTC+4) and are flexible on meeting times. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-grand-port-district-mauritius#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-grand-port-district-mauritius",
            "name": "UI UX Design Agency in Grand Port District, Mauritius | UX Pacific",
            "description": "Research-led UI/UX design agency serving Grand Port District, Mauritius with UX research, usability testing, and DPA 2017 (Mauritius)-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Grand Port District",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-grand-port-district-mauritius"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Grand Port District, Mauritius",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Grand Port District, Mauritius
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Grand Port District</span></h1>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for businesses in Grand Port District.</p>
    ...
    <div class="t2-wrap t2-section">
      <span class="t2-label">UI/UX Design in Grand Port District</span>
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Grand Port District, Mauritius</h2>
      <p class="t2-sub">Every engagement begins with users, evidence, and business goals. We serve companies in Grand Port District remotely — with structured UX research, usability testing, UI design, and DPA 2017 (Mauritius)-compliant product design.</p>

      <div class="t2-grid t2-grid-3">
        <div class="t2-svc">
          <h3>UX Research &amp; Audit</h3>
          <p>User interviews, heuristic evaluation, journey mapping, and usability testing for products used in Grand Port District. We identify where users drop off and why.</p>
        </div>
        <div class="t2-svc">
        ...
        <div class="t2-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product is usable by every member of your audience in Grand Port District.</p>
        </div>
      </div>
    </div>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Frequently Asked Questions — UI/UX Design in Grand Port District</h2>
      <p class="t2-sub">Common questions from businesses in Grand Port District, Mauritius exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Grand Port District, Mauritius?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Grand Port District remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Mauritius, including Grand Port District.</div>
        </div>
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How does DPA 2017 (Mauritius) affect UX design for businesses in Grand Port District?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How much does UX design cost for a business in Grand Port District?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
        ...
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How quickly do you respond to enquiries from Grand Port District?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
    ...
    <div class="t2-wrap t2-section">
      <div class="t2-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Grand Port District Product</h2>
