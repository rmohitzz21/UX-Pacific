...
$countrySlug = 'metropole-de-lyon-france';
...
$pageTitle    = 'UI UX Design Agency in Métropole de Lyon, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Métropole de Lyon, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-metropole-de-lyon-france';
$ogTitle      = 'UI UX Design Agency in Métropole de Lyon, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Métropole de Lyon, France? UX Pacific delivers modern, user-focused digital solutions.';
