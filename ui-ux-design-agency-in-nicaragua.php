...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Nicaragua ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Nicaragua</h2>
      <p class="hub-sub">We serve 17 regions, states, and cities in Nicaragua. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
