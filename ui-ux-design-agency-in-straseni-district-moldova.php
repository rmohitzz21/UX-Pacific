...
$countrySlug = 'straseni-district-moldova';
...
$pageTitle    = 'UI UX Design Agency in Strășeni District, Moldova | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Strășeni District, Moldova. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-straseni-district-moldova';
$ogTitle      = 'UI UX Design Agency in Strășeni District, Moldova | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Strășeni District, Moldova? UX Pacific delivers modern, user-focused digital solutions.';
