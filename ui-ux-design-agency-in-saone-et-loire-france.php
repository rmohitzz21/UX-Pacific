...
$countrySlug = 'saone-et-loire-france';
...
$pageTitle    = 'UI UX Design Agency in Saône-et-Loire, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Saône-et-Loire, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-saone-et-loire-france';
$ogTitle      = 'UI UX Design Agency in Saône-et-Loire, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Saône-et-Loire, France? UX Pacific delivers modern, user-focused digital solutions.';
