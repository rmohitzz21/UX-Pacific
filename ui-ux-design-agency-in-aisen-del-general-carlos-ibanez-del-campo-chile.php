...
$countrySlug = 'aisen-del-general-carlos-ibanez-del-campo-chile';
...
$pageTitle    = 'UI UX Design Agency in Aisén del General Carlos Ibañez del Campo, Chile | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Aisén del General Carlos Ibañez del Campo, Chile. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-aisen-del-general-carlos-ibanez-del-campo-chile';
$ogTitle      = 'UI UX Design Agency in Aisén del General Carlos Ibañez del Campo, Chile | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Aisén del General Carlos Ibañez del Campo, Chile? UX Pacific delivers modern, user-focused digital solutions.';
