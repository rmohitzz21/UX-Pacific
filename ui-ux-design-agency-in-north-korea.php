...
// Child locations in North Korea
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in North Korea ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across North Korea</h2>
      <p class="hub-sub">We serve 11 regions, states, and cities in North Korea. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
