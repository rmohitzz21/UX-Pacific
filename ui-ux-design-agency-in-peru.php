...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Peru ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Peru</h2>
      <p class="hub-sub">We serve 25 regions, states, and cities in Peru. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
