<?php
$countrySlug     = 'peru';
$pageTitle       = 'UI UX Design Agency in Peru | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Peru. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Peru, UI UX Agency Peru, UX Design Peru, UX Research Peru, UI Design Peru, Product Design Peru, UX Audit Peru, Usability Testing Peru, UX Consultant Peru, UX Company Peru, Design System Peru';
$metaAuthor      = 'UXPACIFIC';
$metaRobots      = 'index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1';
$themeColor      = '#080808';
$geoRegion       = 'PE';
$geoCountry      = 'Peru';
$contentLanguage = 'es-PE';
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-peru';
$ogTitle         = 'UI UX Design Agency in Peru | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Peru. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-peru';
$ogImage         = 'https://www.uxpacific.com/img/og-peru.jpg';
$ogLocale        = 'es_PE';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Peru?', 'a' => 'Yes. UX Pacific supports Peru businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Peru.'],
  ['q' => 'How does Law 29733 affect UX design for Peru businesses?', 'a' => 'Law 29733 directly shapes consent flows, data collection forms, and privacy communications. We integrate Law 29733 requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Peru?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Peru?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Peru. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Peru business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Peru accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Peru. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Peru businesses expect.'],
  ['q' => 'How does remote collaboration work for Peru clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Peru clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Peru?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-peru#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-peru',
      'name'          => 'UI UX Design Agency in Peru | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Peru. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
      'datePublished' => '2026-06-26',
      'dateModified'  => '2026-06-29',
      'about'         => ['@type' => 'Country', 'name' => 'Peru'],
    ],
    [
      '@type'           => 'BreadcrumbList',
      'itemListElement' => [
        ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home',      'item' => 'https://www.uxpacific.com/'],
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Peru',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-peru'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Peru',
      'provider'    => ['@id' => 'https://www.uxpacific.com/#organization'],
      'areaServed'  => ['@type' => 'Country', 'name' => 'Peru'],
      'serviceType' => 'UI UX Design, UX Research, Usability Testing, UX Audit, Product Discovery, Design Systems, Law 29733-Compliant UX',
      'url'         => 'https://www.uxpacific.com/ui-ux-design-agency-in-peru',
    ],
...
$hubChildren = [
  ['name' => 'Amazonas', 'url' => '/ui-ux-design-agency-in-amazonas-peru', 'basename' => 'ui-ux-design-agency-in-amazonas-peru'],
  ['name' => 'Áncash', 'url' => '/ui-ux-design-agency-in-ancash-peru', 'basename' => 'ui-ux-design-agency-in-ancash-peru'],
  ['name' => 'Apurímac', 'url' => '/ui-ux-design-agency-in-apurimac-peru', 'basename' => 'ui-ux-design-agency-in-apurimac-peru'],
  ['name' => 'Arequipa', 'url' => '/ui-ux-design-agency-in-arequipa-peru', 'basename' => 'ui-ux-design-agency-in-arequipa-peru'],
  ['name' => 'Ayacucho', 'url' => '/ui-ux-design-agency-in-ayacucho-peru', 'basename' => 'ui-ux-design-agency-in-ayacucho-peru'],
  ['name' => 'Cajamarca', 'url' => '/ui-ux-design-agency-in-cajamarca-peru', 'basename' => 'ui-ux-design-agency-in-cajamarca-peru'],
  ['name' => 'Callao', 'url' => '/ui-ux-design-agency-in-callao-peru', 'basename' => 'ui-ux-design-agency-in-callao-peru'],
  ['name' => 'Cusco', 'url' => '/ui-ux-design-agency-in-cusco-peru', 'basename' => 'ui-ux-design-agency-in-cusco-peru'],
  ['name' => 'Huancavelica', 'url' => '/ui-ux-design-agency-in-huancavelica-peru', 'basename' => 'ui-ux-design-agency-in-huancavelica-peru'],
  ['name' => 'Huanuco', 'url' => '/ui-ux-design-agency-in-huanuco-peru', 'basename' => 'ui-ux-design-agency-in-huanuco-peru'],
  ['name' => 'Ica', 'url' => '/ui-ux-design-agency-in-ica-peru', 'basename' => 'ui-ux-design-agency-in-ica-peru'],
  ['name' => 'Junín', 'url' => '/ui-ux-design-agency-in-junin-peru', 'basename' => 'ui-ux-design-agency-in-junin-peru'],
  ['name' => 'La Libertad', 'url' => '/ui-ux-design-agency-in-la-libertad-peru', 'basename' => 'ui-ux-design-agency-in-la-libertad-peru'],
  ['name' => 'Lambayeque', 'url' => '/ui-ux-design-agency-in-lambayeque-peru', 'basename' => 'ui-ux-design-agency-in-lambayeque-peru'],
  ['name' => 'Lima', 'url' => '/ui-ux-design-agency-in-lima-peru', 'basename' => 'ui-ux-design-agency-in-lima-peru'],
  ['name' => 'Loreto', 'url' => '/ui-ux-design-agency-in-loreto-peru', 'basename' => 'ui-ux-design-agency-in-loreto-peru'],
  ['name' => 'Madre de Dios', 'url' => '/ui-ux-design-agency-in-madre-de-dios-peru', 'basename' => 'ui-ux-design-agency-in-madre-de-dios-peru'],
  ['name' => 'Moquegua', 'url' => '/ui-ux-design-agency-in-moquegua-peru', 'basename' => 'ui-ux-design-agency-in-moquegua-peru'],
  ['name' => 'Pasco', 'url' => '/ui-ux-design-agency-in-pasco-peru', 'basename' => 'ui-ux-design-agency-in-pasco-peru'],
  ['name' => 'Piura', 'url' => '/ui-ux-design-agency-in-piura-peru', 'basename' => 'ui-ux-design-agency-in-piura-peru'],
  ['name' => 'Puno', 'url' => '/ui-ux-design-agency-in-puno-peru', 'basename' => 'ui-ux-design-agency-in-puno-peru'],
  ['name' => 'San Martín', 'url' => '/ui-ux-design-agency-in-san-martin-peru', 'basename' => 'ui-ux-design-agency-in-san-martin-peru'],
  ['name' => 'Tacna', 'url' => '/ui-ux-design-agency-in-tacna-peru', 'basename' => 'ui-ux-design-agency-in-tacna-peru'],
  ['name' => 'Tumbes', 'url' => '/ui-ux-design-agency-in-tumbes-peru', 'basename' => 'ui-ux-design-agency-in-tumbes-peru'],
  ['name' => 'Ucayali', 'url' => '/ui-ux-design-agency-in-ucayali-peru', 'basename' => 'ui-ux-design-agency-in-ucayali-peru'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Peru
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Peru</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Peru startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Peru businesses.</p>
      ...
      <div class="de-grid de-grid-4" style="margin-top:1.8rem">
        ...
        <div class="de-card">
          <span class="de-card-icon">&#128737;</span>
          <h3>Law 29733-Aware Approach</h3>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Peru Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          <h3>Law 29733-Compliant UX</h3>
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Peru regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets Peru regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Peru.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to WCAG 2.1 AA standards and Law 29733-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, Law 29733 compliance risks, and navigation problems — each prioritised by business impact.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Most agencies start with screens. We start with research. Here is what that difference looks like in practice for Peru businesses.</p>
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>Law 29733 and accessibility treated as afterthoughts</td><td>Law 29733 compliance and WCAG 2.1 AA accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <p class="de-sub">A structured, transparent workflow designed for Peru and international teams that need clarity, speed, and reliable communication at every stage.</p>
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and Law 29733 requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Peru</h2>
      <p class="de-sub">Common questions from Peru startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services Across Peru</h2>
      <p class="de-sub">We serve businesses in 25 regions, states, and cities in Peru. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Peru Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and Law 29733 compliance.</p></div>
          </div>
          <div class="de-proc-step">
