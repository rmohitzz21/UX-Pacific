...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Botswana ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Botswana</h2>
      <p class="hub-sub">We serve 10 regions, states, and cities in Botswana. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
