...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Mozambique ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Mozambique</h2>
      <p class="hub-sub">We serve 11 regions, states, and cities in Mozambique. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
