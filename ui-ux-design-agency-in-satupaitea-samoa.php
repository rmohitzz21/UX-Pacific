...
$pageTitle    = 'UI UX Design Agency in Satupa\'itea, Samoa | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Satupa\'itea, Samoa. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-satupaitea-samoa';
$ogTitle      = 'UI UX Design Agency in Satupa\'itea, Samoa | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Satupa\'itea, Samoa? UX Pacific delivers modern, user-focused digital solutions.';
