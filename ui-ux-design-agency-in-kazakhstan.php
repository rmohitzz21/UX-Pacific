...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Kazakhstan ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Kazakhstan</h2>
      <p class="hub-sub">We serve 17 regions, states, and cities in Kazakhstan. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
