...
$pageTitle       = 'UI UX Design Agency in Kazakhstan | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Kazakhstan. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Kazakhstan, UI UX Agency Kazakhstan, UX Design Kazakhstan, UX Research Kazakhstan, UI Design Kazakhstan, Product Design Kazakhstan, UX Audit Kazakhstan, Usability Testing Kazakhstan, UX Consultant Kazakhstan, UX Company Kazakhstan, Design System Kazakhstan';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-kazakhstan';
$ogTitle         = 'UI UX Design Agency in Kazakhstan | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Kazakhstan. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-kazakhstan';
$ogImage         = 'https://www.uxpacific.com/img/og-kazakhstan.jpg';
$ogLocale        = 'kk_KZ';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Kazakhstan?', 'a' => 'Yes. UX Pacific supports Kazakhstan businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Kazakhstan.'],
  ['q' => 'How does Law on Personal Data affect UX design for Kazakhstan businesses?', 'a' => 'Law on Personal Data directly shapes consent flows, data collection forms, and privacy communications. We integrate Law on Personal Data requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Kazakhstan?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Kazakhstan?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Kazakhstan. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Kazakhstan business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Kazakhstan accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Kazakhstan. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Kazakhstan businesses expect.'],
  ['q' => 'How does remote collaboration work for Kazakhstan clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Kazakhstan clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Kazakhstan?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-kazakhstan#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-kazakhstan',
      'name'          => 'UI UX Design Agency in Kazakhstan | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Kazakhstan. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
    ...
    [
      ...
      'itemListElement' => [
        ...
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Kazakhstan',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-kazakhstan'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Kazakhstan',
...
$hubChildren = [
  ['name' => 'Akmola Region', 'url' => '/ui-ux-design-agency-in-akmola-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-akmola-region-kazakhstan'],
  ['name' => 'Aktobe Region', 'url' => '/ui-ux-design-agency-in-aktobe-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-aktobe-region-kazakhstan'],
  ['name' => 'Almaty', 'url' => '/ui-ux-design-agency-in-almaty-kazakhstan', 'basename' => 'ui-ux-design-agency-in-almaty-kazakhstan'],
  ['name' => 'Almaty Region', 'url' => '/ui-ux-design-agency-in-almaty-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-almaty-region-kazakhstan'],
  ['name' => 'Atyrau Region', 'url' => '/ui-ux-design-agency-in-atyrau-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-atyrau-region-kazakhstan'],
  ['name' => 'Baikonur', 'url' => '/ui-ux-design-agency-in-baikonur-kazakhstan', 'basename' => 'ui-ux-design-agency-in-baikonur-kazakhstan'],
  ['name' => 'East Kazakhstan Region', 'url' => '/ui-ux-design-agency-in-east-kazakhstan-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-east-kazakhstan-region-kazakhstan'],
  ['name' => 'Jambyl Region', 'url' => '/ui-ux-design-agency-in-jambyl-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-jambyl-region-kazakhstan'],
  ['name' => 'Karaganda Region', 'url' => '/ui-ux-design-agency-in-karaganda-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-karaganda-region-kazakhstan'],
  ['name' => 'Kostanay Region', 'url' => '/ui-ux-design-agency-in-kostanay-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-kostanay-region-kazakhstan'],
  ['name' => 'Kyzylorda Region', 'url' => '/ui-ux-design-agency-in-kyzylorda-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-kyzylorda-region-kazakhstan'],
  ['name' => 'Mangystau Region', 'url' => '/ui-ux-design-agency-in-mangystau-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-mangystau-region-kazakhstan'],
  ['name' => 'North Kazakhstan Region', 'url' => '/ui-ux-design-agency-in-north-kazakhstan-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-north-kazakhstan-region-kazakhstan'],
  ['name' => 'Nur-Sultan', 'url' => '/ui-ux-design-agency-in-nur-sultan-kazakhstan', 'basename' => 'ui-ux-design-agency-in-nur-sultan-kazakhstan'],
  ['name' => 'Pavlodar Region', 'url' => '/ui-ux-design-agency-in-pavlodar-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-pavlodar-region-kazakhstan'],
  ['name' => 'Turkestan Region', 'url' => '/ui-ux-design-agency-in-turkestan-region-kazakhstan', 'basename' => 'ui-ux-design-agency-in-turkestan-region-kazakhstan'],
  ['name' => 'West Kazakhstan Province', 'url' => '/ui-ux-design-agency-in-west-kazakhstan-province-kazakhstan', 'basename' => 'ui-ux-design-agency-in-west-kazakhstan-province-kazakhstan'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Kazakhstan
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Kazakhstan</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Kazakhstan startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Kazakhstan businesses.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Kazakhstan Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          ...
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Kazakhstan regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets Kazakhstan regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Kazakhstan.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Kazakhstan</h2>
      <p class="de-sub">Common questions from Kazakhstan startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">We serve businesses in 17 regions, states, and cities in Kazakhstan. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Kazakhstan Product</h2>
