...
$countrySlug = 'kraj-vysocina-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Kraj Vysočina, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Kraj Vysočina, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-kraj-vysocina-czech-republic';
$ogTitle      = 'UI UX Design Agency in Kraj Vysočina, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Kraj Vysočina, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
