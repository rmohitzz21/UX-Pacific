...
$countrySlug = 'ogooue-maritime-province-gabon';
...
$pageTitle    = 'UI UX Design Agency in Ogooué-Maritime Province, Gabon | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ogooué-Maritime Province, Gabon. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ogooue-maritime-province-gabon';
$ogTitle      = 'UI UX Design Agency in Ogooué-Maritime Province, Gabon | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ogooué-Maritime Province, Gabon? UX Pacific delivers modern, user-focused digital solutions.';
