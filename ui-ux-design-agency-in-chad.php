...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Chad ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Chad</h2>
      <p class="hub-sub">We serve 23 regions, states, and cities in Chad. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
