...
$countrySlug = 'hodonin-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Hodonín, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Hodonín, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-hodonin-czech-republic';
$ogTitle      = 'UI UX Design Agency in Hodonín, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Hodonín, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
