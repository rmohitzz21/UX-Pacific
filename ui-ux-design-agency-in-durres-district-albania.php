...
$countrySlug = 'durres-district-albania';
...
$pageTitle    = 'UI UX Design Agency in Durrës District, Albania | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Durrës District, Albania. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-durres-district-albania';
$ogTitle      = 'UI UX Design Agency in Durrës District, Albania | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Durrës District, Albania? UX Pacific delivers modern, user-focused digital solutions.';
