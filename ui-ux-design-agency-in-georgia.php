...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Georgia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Georgia</h2>
      <p class="hub-sub">We serve 14 regions, states, and cities in Georgia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
