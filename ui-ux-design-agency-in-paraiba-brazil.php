...
$pageTitle    = 'UI UX Design Agency in Paraíba, Brazil | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Paraíba, Brazil. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-paraiba-brazil';
$ogTitle      = 'UI UX Design Agency in Paraíba, Brazil | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Paraíba, Brazil? UX Pacific delivers modern, user-focused digital solutions.';
