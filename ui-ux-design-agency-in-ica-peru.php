...
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ica, Peru. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ica-peru';
$ogTitle      = 'UI UX Design Agency in Ica, Peru | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ica, Peru? UX Pacific delivers modern, user-focused digital solutions.';
