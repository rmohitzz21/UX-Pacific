...
$countrySlug = 'rio-san-juan-nicaragua';
...
$pageTitle    = 'UI UX Design Agency in Río San Juan, Nicaragua | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Río San Juan, Nicaragua. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-rio-san-juan-nicaragua';
$ogTitle      = 'UI UX Design Agency in Río San Juan, Nicaragua | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Río San Juan, Nicaragua? UX Pacific delivers modern, user-focused digital solutions.';
