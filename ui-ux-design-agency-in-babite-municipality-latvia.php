...
$countrySlug = 'babite-municipality-latvia';
...
$pageTitle    = 'UI UX Design Agency in Babīte Municipality, Latvia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Babīte Municipality, Latvia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-babite-municipality-latvia';
$ogTitle      = 'UI UX Design Agency in Babīte Municipality, Latvia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Babīte Municipality, Latvia? UX Pacific delivers modern, user-focused digital solutions.';
