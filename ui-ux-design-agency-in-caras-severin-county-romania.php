...
$countrySlug = 'caras-severin-county-romania';
...
$pageTitle    = 'UI UX Design Agency in Caraș-Severin County, Romania | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Caraș-Severin County, Romania. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-caras-severin-county-romania';
$ogTitle      = 'UI UX Design Agency in Caraș-Severin County, Romania | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Caraș-Severin County, Romania? UX Pacific delivers modern, user-focused digital solutions.';
