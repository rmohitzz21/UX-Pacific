...
$countrySlug = 'frydek-mistek-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Frýdek-Místek, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Frýdek-Místek, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-frydek-mistek-czech-republic';
$ogTitle      = 'UI UX Design Agency in Frýdek-Místek, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Frýdek-Místek, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
