...
$countrySlug = 'zurich-switzerland';
...
$pageTitle    = 'UI UX Design Agency in Zürich, Switzerland | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Zürich, Switzerland. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-zurich-switzerland';
$ogTitle      = 'UI UX Design Agency in Zürich, Switzerland | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Zürich, Switzerland? UX Pacific delivers modern, user-focused digital solutions.';
