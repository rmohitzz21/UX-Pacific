...
$countrySlug = 's-r-tr-ndelag-norway';
...
$pageTitle    = 'UI UX Design Agency in Sør-Trøndelag, Norway | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Sør-Trøndelag, Norway. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-s-r-tr-ndelag-norway';
$ogTitle      = 'UI UX Design Agency in Sør-Trøndelag, Norway | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Sør-Trøndelag, Norway? UX Pacific delivers modern, user-focused digital solutions.';
