...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Maldives ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Maldives</h2>
      <p class="hub-sub">We serve 26 regions, states, and cities in Maldives. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
