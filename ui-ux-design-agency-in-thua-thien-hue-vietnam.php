...
$countrySlug = 'thua-thien-hue-vietnam';
...
$pageTitle    = 'UI UX Design Agency in Thừa Thiên-Huế, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Thừa Thiên-Huế, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-thua-thien-hue-vietnam';
$ogTitle      = 'UI UX Design Agency in Thừa Thiên-Huế, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Thừa Thiên-Huế, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
