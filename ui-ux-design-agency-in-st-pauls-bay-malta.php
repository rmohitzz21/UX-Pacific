...
$countrySlug = 'st-pauls-bay-malta';
...
$pageTitle    = 'UI UX Design Agency in St. Paul\'s Bay, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in St. Paul\'s Bay, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-st-pauls-bay-malta';
$ogTitle      = 'UI UX Design Agency in St. Paul\'s Bay, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in St. Paul\'s Bay, Malta? UX Pacific delivers modern, user-focused digital solutions.';
