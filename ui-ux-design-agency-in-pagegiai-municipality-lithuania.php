...
$countrySlug = 'pagegiai-municipality-lithuania';
...
$pageTitle    = 'UI UX Design Agency in Pagėgiai municipality, Lithuania | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Pagėgiai municipality, Lithuania. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-pagegiai-municipality-lithuania';
$ogTitle      = 'UI UX Design Agency in Pagėgiai municipality, Lithuania | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Pagėgiai municipality, Lithuania? UX Pacific delivers modern, user-focused digital solutions.';
