...
$pageTitle    = 'UI UX Design Agency in Mohéli, Comoros | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Mohéli, Comoros. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-moheli-comoros';
$ogTitle      = 'UI UX Design Agency in Mohéli, Comoros | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Mohéli, Comoros? UX Pacific delivers modern, user-focused digital solutions.';
