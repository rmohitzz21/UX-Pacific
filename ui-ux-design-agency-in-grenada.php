...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Grenada ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Grenada</h2>
      <p class="hub-sub">We serve 7 regions, states, and cities in Grenada. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
