...
// Child locations in United Arab Emirates
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in United Arab Emirates ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across United Arab Emirates</h2>
      <p class="hub-sub">We serve 7 regions, states, and cities in United Arab Emirates. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
