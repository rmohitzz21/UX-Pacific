...
$countrySlug = 'panevezys-city-municipality-lithuania';
...
$pageTitle    = 'UI UX Design Agency in Panevėžys City Municipality, Lithuania | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Panevėžys City Municipality, Lithuania. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-panevezys-city-municipality-lithuania';
$ogTitle      = 'UI UX Design Agency in Panevėžys City Municipality, Lithuania | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Panevėžys City Municipality, Lithuania? UX Pacific delivers modern, user-focused digital solutions.';
