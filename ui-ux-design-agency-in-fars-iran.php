...
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Fars, Iran. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-fars-iran';
$ogTitle      = 'UI UX Design Agency in Fars, Iran | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Fars, Iran? UX Pacific delivers modern, user-focused digital solutions.';
