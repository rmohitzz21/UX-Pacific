...
$countrySlug = 'ciego-de-avila-province-cuba';
...
$pageTitle    = 'UI UX Design Agency in Ciego de Ávila Province, Cuba | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ciego de Ávila Province, Cuba. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ciego-de-avila-province-cuba';
$ogTitle      = 'UI UX Design Agency in Ciego de Ávila Province, Cuba | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ciego de Ávila Province, Cuba? UX Pacific delivers modern, user-focused digital solutions.';
