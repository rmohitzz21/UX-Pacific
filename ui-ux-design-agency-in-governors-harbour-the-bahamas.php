...
$countrySlug = 'governors-harbour-the-bahamas';
...
$pageTitle    = 'UI UX Design Agency in Governor\'s Harbour, The Bahamas | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Governor\'s Harbour, The Bahamas. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-governors-harbour-the-bahamas';
$ogTitle      = 'UI UX Design Agency in Governor\'s Harbour, The Bahamas | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Governor\'s Harbour, The Bahamas? UX Pacific delivers modern, user-focused digital solutions.';
