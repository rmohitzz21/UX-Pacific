...
$pageTitle    = 'UI UX Design Agency in El M\'ghair, Algeria | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in El M\'ghair, Algeria. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-el-mghair-algeria';
$ogTitle      = 'UI UX Design Agency in El M\'ghair, Algeria | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in El M\'ghair, Algeria? UX Pacific delivers modern, user-focused digital solutions.';
