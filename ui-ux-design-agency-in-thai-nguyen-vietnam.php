...
$countrySlug = 'thai-nguyen-vietnam';
...
$pageTitle    = 'UI UX Design Agency in Thái Nguyên, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Thái Nguyên, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-thai-nguyen-vietnam';
$ogTitle      = 'UI UX Design Agency in Thái Nguyên, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Thái Nguyên, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
