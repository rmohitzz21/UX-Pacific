...
$countrySlug = 'libertador-general-bernardo-ohiggins-chile';
...
$pageTitle    = 'UI UX Design Agency in Libertador General Bernardo O\'Higgins, Chile | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Libertador General Bernardo O\'Higgins, Chile. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-libertador-general-bernardo-ohiggins-chile';
$ogTitle      = 'UI UX Design Agency in Libertador General Bernardo O\'Higgins, Chile | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Libertador General Bernardo O\'Higgins, Chile? UX Pacific delivers modern, user-focused digital solutions.';
