...
$pageTitle       = 'UI UX Design Agency in Cambodia | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Cambodia. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Cambodia, UI UX Agency Cambodia, UX Design Cambodia, UX Research Cambodia, UI Design Cambodia, Product Design Cambodia, UX Audit Cambodia, Usability Testing Cambodia, UX Consultant Cambodia, UX Company Cambodia, Design System Cambodia';
$metaAuthor      = 'UXPACIFIC';
$metaRobots      = 'index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1';
$themeColor      = '#080808';
$geoRegion       = 'KH';
$geoCountry      = 'Cambodia';
$contentLanguage = 'en-KH';
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-cambodia';
$ogTitle         = 'UI UX Design Agency in Cambodia | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Cambodia. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-cambodia';
$ogImage         = 'https://www.uxpacific.com/img/og-cambodia.jpg';
$ogLocale        = 'km_KH';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Cambodia?', 'a' => 'Yes. UX Pacific supports Cambodia businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Cambodia.'],
  ['q' => 'How does Data Privacy Law (2023) affect UX design for Cambodia businesses?', 'a' => 'Data Privacy Law (2023) directly shapes consent flows, data collection forms, and privacy communications. We integrate Data Privacy Law (2023) requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Cambodia?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Cambodia?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Cambodia. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Cambodia business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Cambodia accessibility standards like WCAG 2.1 AA?', 'a' => 'Yes. We design to WCAG 2.1 AA as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Cambodia. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Cambodia businesses expect.'],
  ['q' => 'How does remote collaboration work for Cambodia clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Cambodia clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Cambodia?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-cambodia#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-cambodia',
      'name'          => 'UI UX Design Agency in Cambodia | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Cambodia. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
    ...
    [
      ...
      'itemListElement' => [
        ...
        ['@type' => 'ListItem', 'position' => 2, 'name' => 'Cambodia',  'item' => 'https://www.uxpacific.com/ui-ux-design-agency-in-cambodia'],
      ],
    ],
    [
      '@type'  => 'Organization',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Cambodia',
      'provider'    => ['@id' => 'https://www.uxpacific.com/#organization'],
      'areaServed'  => ['@type' => 'Country', 'name' => 'Cambodia'],
      'serviceType' => 'UI UX Design, UX Research, Usability Testing, UX Audit, Product Discovery, Design Systems, Data Privacy Law (2023)-Compliant UX',
      'url'         => 'https://www.uxpacific.com/ui-ux-design-agency-in-cambodia',
    ],
...
$hubChildren = [
  ['name' => 'Banteay Meanchey', 'url' => '/ui-ux-design-agency-in-banteay-meanchey-cambodia', 'basename' => 'ui-ux-design-agency-in-banteay-meanchey-cambodia'],
  ['name' => 'Battambang', 'url' => '/ui-ux-design-agency-in-battambang-cambodia', 'basename' => 'ui-ux-design-agency-in-battambang-cambodia'],
  ['name' => 'Kampong Cham', 'url' => '/ui-ux-design-agency-in-kampong-cham-cambodia', 'basename' => 'ui-ux-design-agency-in-kampong-cham-cambodia'],
  ['name' => 'Kampong Chhnang', 'url' => '/ui-ux-design-agency-in-kampong-chhnang-cambodia', 'basename' => 'ui-ux-design-agency-in-kampong-chhnang-cambodia'],
  ['name' => 'Kampong Speu', 'url' => '/ui-ux-design-agency-in-kampong-speu-cambodia', 'basename' => 'ui-ux-design-agency-in-kampong-speu-cambodia'],
  ['name' => 'Kampong Thom', 'url' => '/ui-ux-design-agency-in-kampong-thom-cambodia', 'basename' => 'ui-ux-design-agency-in-kampong-thom-cambodia'],
  ['name' => 'Kampot', 'url' => '/ui-ux-design-agency-in-kampot-cambodia', 'basename' => 'ui-ux-design-agency-in-kampot-cambodia'],
  ['name' => 'Kandal', 'url' => '/ui-ux-design-agency-in-kandal-cambodia', 'basename' => 'ui-ux-design-agency-in-kandal-cambodia'],
  ['name' => 'Kep', 'url' => '/ui-ux-design-agency-in-kep-cambodia', 'basename' => 'ui-ux-design-agency-in-kep-cambodia'],
  ['name' => 'Koh Kong', 'url' => '/ui-ux-design-agency-in-koh-kong-cambodia', 'basename' => 'ui-ux-design-agency-in-koh-kong-cambodia'],
  ['name' => 'Kratie', 'url' => '/ui-ux-design-agency-in-kratie-cambodia', 'basename' => 'ui-ux-design-agency-in-kratie-cambodia'],
  ['name' => 'Mondulkiri', 'url' => '/ui-ux-design-agency-in-mondulkiri-cambodia', 'basename' => 'ui-ux-design-agency-in-mondulkiri-cambodia'],
  ['name' => 'Oddar Meanchey', 'url' => '/ui-ux-design-agency-in-oddar-meanchey-cambodia', 'basename' => 'ui-ux-design-agency-in-oddar-meanchey-cambodia'],
  ['name' => 'Pailin', 'url' => '/ui-ux-design-agency-in-pailin-cambodia', 'basename' => 'ui-ux-design-agency-in-pailin-cambodia'],
  ['name' => 'Phnom Penh', 'url' => '/ui-ux-design-agency-in-phnom-penh-cambodia', 'basename' => 'ui-ux-design-agency-in-phnom-penh-cambodia'],
  ['name' => 'Preah Vihear', 'url' => '/ui-ux-design-agency-in-preah-vihear-cambodia', 'basename' => 'ui-ux-design-agency-in-preah-vihear-cambodia'],
  ['name' => 'Prey Veng', 'url' => '/ui-ux-design-agency-in-prey-veng-cambodia', 'basename' => 'ui-ux-design-agency-in-prey-veng-cambodia'],
  ['name' => 'Pursat', 'url' => '/ui-ux-design-agency-in-pursat-cambodia', 'basename' => 'ui-ux-design-agency-in-pursat-cambodia'],
  ['name' => 'Ratanakiri', 'url' => '/ui-ux-design-agency-in-ratanakiri-cambodia', 'basename' => 'ui-ux-design-agency-in-ratanakiri-cambodia'],
  ['name' => 'Siem Reap', 'url' => '/ui-ux-design-agency-in-siem-reap-cambodia', 'basename' => 'ui-ux-design-agency-in-siem-reap-cambodia'],
  ['name' => 'Sihanoukville', 'url' => '/ui-ux-design-agency-in-sihanoukville-cambodia', 'basename' => 'ui-ux-design-agency-in-sihanoukville-cambodia'],
  ['name' => 'Stung Treng', 'url' => '/ui-ux-design-agency-in-stung-treng-cambodia', 'basename' => 'ui-ux-design-agency-in-stung-treng-cambodia'],
  ['name' => 'Svay Rieng', 'url' => '/ui-ux-design-agency-in-svay-rieng-cambodia', 'basename' => 'ui-ux-design-agency-in-svay-rieng-cambodia'],
  ['name' => 'Tai Po District', 'url' => '/ui-ux-design-agency-in-tai-po-district-cambodia', 'basename' => 'ui-ux-design-agency-in-tai-po-district-cambodia'],
  ['name' => 'Takeo', 'url' => '/ui-ux-design-agency-in-takeo-cambodia', 'basename' => 'ui-ux-design-agency-in-takeo-cambodia'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Cambodia
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Cambodia</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Cambodia startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Cambodia businesses.</p>
      ...
      <div class="de-grid de-grid-4" style="margin-top:1.8rem">
        ...
        <div class="de-card">
          <span class="de-card-icon">&#128737;</span>
          <h3>Data Privacy Law (2023)-Aware Approach</h3>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Cambodia Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          <h3>Data Privacy Law (2023)-Compliant UX</h3>
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Cambodia regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product reaches every user and meets Cambodia regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Cambodia.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to WCAG 2.1 AA standards and Data Privacy Law (2023)-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, Data Privacy Law (2023) compliance risks, and navigation problems — each prioritised by business impact.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Most agencies start with screens. We start with research. Here is what that difference looks like in practice for Cambodia businesses.</p>
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>Data Privacy Law (2023) and accessibility treated as afterthoughts</td><td>Data Privacy Law (2023) compliance and WCAG 2.1 AA accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <p class="de-sub">A structured, transparent workflow designed for Cambodia and international teams that need clarity, speed, and reliable communication at every stage.</p>
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and Data Privacy Law (2023) requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Cambodia</h2>
      <p class="de-sub">Common questions from Cambodia startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services Across Cambodia</h2>
      <p class="de-sub">We serve businesses in 25 regions, states, and cities in Cambodia. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Cambodia Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and Data Privacy Law (2023) compliance.</p></div>
          </div>
          <div class="de-proc-step">
