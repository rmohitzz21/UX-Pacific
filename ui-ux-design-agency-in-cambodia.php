...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Cambodia ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Cambodia</h2>
      <p class="hub-sub">We serve 25 regions, states, and cities in Cambodia. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
