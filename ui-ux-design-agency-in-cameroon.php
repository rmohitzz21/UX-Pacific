...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Cameroon ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Cameroon</h2>
      <p class="hub-sub">We serve 10 regions, states, and cities in Cameroon. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
