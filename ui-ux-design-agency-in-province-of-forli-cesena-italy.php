...
$countrySlug = 'province-of-forli-cesena-italy';
...
$pageTitle    = 'UI UX Design Agency in Province of Forlì-Cesena, Italy | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Province of Forlì-Cesena, Italy. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-province-of-forli-cesena-italy';
$ogTitle      = 'UI UX Design Agency in Province of Forlì-Cesena, Italy | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Province of Forlì-Cesena, Italy? UX Pacific delivers modern, user-focused digital solutions.';
