...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Cyprus ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Cyprus</h2>
      <p class="hub-sub">We serve 6 regions, states, and cities in Cyprus. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
