...
$pageTitle    = 'UI UX Design Agency in Nghệ An, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Nghệ An, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-nghe-an-vietnam';
$ogTitle      = 'UI UX Design Agency in Nghệ An, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Nghệ An, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
