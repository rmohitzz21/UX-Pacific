...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Uruguay ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Uruguay</h2>
      <p class="hub-sub">We serve 19 regions, states, and cities in Uruguay. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
