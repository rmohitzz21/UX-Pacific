...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Ireland ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Ireland</h2>
      <p class="hub-sub">We serve 29 regions, states, and cities in Ireland. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
