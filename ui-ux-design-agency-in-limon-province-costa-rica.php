...
$countrySlug = 'limon-province-costa-rica';
...
$pageTitle    = 'UI UX Design Agency in Limón Province, Costa Rica | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Limón Province, Costa Rica. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-limon-province-costa-rica';
$ogTitle      = 'UI UX Design Agency in Limón Province, Costa Rica | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Limón Province, Costa Rica? UX Pacific delivers modern, user-focused digital solutions.';
