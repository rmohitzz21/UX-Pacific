...
$countrySlug = 'pyrenees-orientales-france';
...
$pageTitle    = 'UI UX Design Agency in Pyrénées-Orientales, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Pyrénées-Orientales, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-pyrenees-orientales-france';
$ogTitle      = 'UI UX Design Agency in Pyrénées-Orientales, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Pyrénées-Orientales, France? UX Pacific delivers modern, user-focused digital solutions.';
