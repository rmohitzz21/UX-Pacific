...
$pageTitle    = 'UI UX Design Agency in Cao Bằng, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Cao Bằng, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-cao-bang-vietnam';
$ogTitle      = 'UI UX Design Agency in Cao Bằng, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Cao Bằng, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
