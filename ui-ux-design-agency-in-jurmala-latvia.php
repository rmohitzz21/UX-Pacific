...
$pageTitle    = 'UI UX Design Agency in Jūrmala, Latvia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Jūrmala, Latvia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-jurmala-latvia';
$ogTitle      = 'UI UX Design Agency in Jūrmala, Latvia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Jūrmala, Latvia? UX Pacific delivers modern, user-focused digital solutions.';
