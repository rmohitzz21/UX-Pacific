...
$pageTitle    = 'UI UX Design Agency in Żurrieq, Malta | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Żurrieq, Malta. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-zurrieq-malta';
$ogTitle      = 'UI UX Design Agency in Żurrieq, Malta | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Żurrieq, Malta? UX Pacific delivers modern, user-focused digital solutions.';
