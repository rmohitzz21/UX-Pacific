...
$pageTitle    = 'UI UX Design Agency in Hérault, France | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Hérault, France. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-herault-france';
$ogTitle      = 'UI UX Design Agency in Hérault, France | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Hérault, France? UX Pacific delivers modern, user-focused digital solutions.';
