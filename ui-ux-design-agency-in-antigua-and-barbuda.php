...
// Child locations in Antigua and Barbuda
$hubChildren = [
...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Antigua and Barbuda ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Antigua and Barbuda</h2>
      <p class="hub-sub">We serve 8 regions, states, and cities in Antigua and Barbuda. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
