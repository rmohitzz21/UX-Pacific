...
$countrySlug = 'san-jose-de-ocoa-province-dominican-republic';
...
$pageTitle    = 'UI UX Design Agency in San José de Ocoa Province, Dominican Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in San José de Ocoa Province, Dominican Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-san-jose-de-ocoa-province-dominican-republic';
$ogTitle      = 'UI UX Design Agency in San José de Ocoa Province, Dominican Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in San José de Ocoa Province, Dominican Republic? UX Pacific delivers modern, user-focused digital solutions.';
