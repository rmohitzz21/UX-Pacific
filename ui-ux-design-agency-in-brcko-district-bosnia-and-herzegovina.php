...
$countrySlug = 'brcko-district-bosnia-and-herzegovina';
...
$pageTitle    = 'UI UX Design Agency in Brčko District, Bosnia and Herzegovina | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Brčko District, Bosnia and Herzegovina. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-brcko-district-bosnia-and-herzegovina';
$ogTitle      = 'UI UX Design Agency in Brčko District, Bosnia and Herzegovina | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Brčko District, Bosnia and Herzegovina? UX Pacific delivers modern, user-focused digital solutions.';
