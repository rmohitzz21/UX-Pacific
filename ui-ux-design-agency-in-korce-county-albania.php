...
$countrySlug = 'korce-county-albania';
...
$pageTitle    = 'UI UX Design Agency in Korçë County, Albania | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Korçë County, Albania. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-korce-county-albania';
$ogTitle      = 'UI UX Design Agency in Korçë County, Albania | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Korçë County, Albania? UX Pacific delivers modern, user-focused digital solutions.';
