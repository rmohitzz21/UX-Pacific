...
$countrySlug = 'cocle-province-panama';
...
$pageTitle    = 'UI UX Design Agency in Coclé Province, Panama | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Coclé Province, Panama. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-cocle-province-panama';
$ogTitle      = 'UI UX Design Agency in Coclé Province, Panama | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Coclé Province, Panama? UX Pacific delivers modern, user-focused digital solutions.';
