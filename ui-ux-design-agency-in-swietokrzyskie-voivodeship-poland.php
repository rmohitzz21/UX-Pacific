...
$countrySlug = 'swietokrzyskie-voivodeship-poland';
...
$pageTitle    = 'UI UX Design Agency in Świętokrzyskie Voivodeship, Poland | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Świętokrzyskie Voivodeship, Poland. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-swietokrzyskie-voivodeship-poland';
$ogTitle      = 'UI UX Design Agency in Świętokrzyskie Voivodeship, Poland | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Świętokrzyskie Voivodeship, Poland? UX Pacific delivers modern, user-focused digital solutions.';
