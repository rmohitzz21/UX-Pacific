...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Oman ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Oman</h2>
      <p class="hub-sub">We serve 13 regions, states, and cities in Oman. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
