...
$countrySlug = 'estado-de-mexico-mexico';
...
$pageTitle    = 'UI UX Design Agency in Estado de México, Mexico | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Estado de México, Mexico. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-estado-de-mexico-mexico';
$ogTitle      = 'UI UX Design Agency in Estado de México, Mexico | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Estado de México, Mexico? UX Pacific delivers modern, user-focused digital solutions.';
