...
$countrySlug = 'ombella-mpoko-prefecture-central-african-republic';
...
$pageTitle    = 'UI UX Design Agency in Ombella-M\'Poko Prefecture, Central African Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ombella-M\'Poko Prefecture, Central African Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ombella-mpoko-prefecture-central-african-republic';
$ogTitle      = 'UI UX Design Agency in Ombella-M\'Poko Prefecture, Central African Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ombella-M\'Poko Prefecture, Central African Republic? UX Pacific delivers modern, user-focused digital solutions.';
