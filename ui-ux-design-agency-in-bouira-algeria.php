...
$pageTitle    = 'UI UX Design Agency in Bouïra, Algeria | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Bouïra, Algeria. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-bouira-algeria';
$ogTitle      = 'UI UX Design Agency in Bouïra, Algeria | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Bouïra, Algeria? UX Pacific delivers modern, user-focused digital solutions.';
