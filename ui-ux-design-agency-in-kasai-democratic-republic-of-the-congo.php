...
$countrySlug = 'kasai-democratic-republic-of-the-congo';
...
$pageTitle    = 'UI UX Design Agency in Kasaï, Democratic Republic of the Congo | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Kasaï, Democratic Republic of the Congo. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-kasai-democratic-republic-of-the-congo';
$ogTitle      = 'UI UX Design Agency in Kasaï, Democratic Republic of the Congo | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Kasaï, Democratic Republic of the Congo? UX Pacific delivers modern, user-focused digital solutions.';
