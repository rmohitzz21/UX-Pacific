...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Yemen ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Yemen</h2>
      <p class="hub-sub">We serve 21 regions, states, and cities in Yemen. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
