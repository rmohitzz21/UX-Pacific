...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Djibouti ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Djibouti</h2>
      <p class="hub-sub">We serve 5 regions, states, and cities in Djibouti. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
