...
$pageTitle    = 'UI UX Design Agency in Ávila, Spain | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Ávila, Spain. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-avila-spain';
$ogTitle      = 'UI UX Design Agency in Ávila, Spain | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Ávila, Spain? UX Pacific delivers modern, user-focused digital solutions.';
