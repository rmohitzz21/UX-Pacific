...
$countrySlug = 'zilina-region-slovakia';
...
$pageTitle    = 'UI UX Design Agency in Žilina Region, Slovakia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Žilina Region, Slovakia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-zilina-region-slovakia';
$ogTitle      = 'UI UX Design Agency in Žilina Region, Slovakia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Žilina Region, Slovakia? UX Pacific delivers modern, user-focused digital solutions.';
