...
$pageTitle    = 'UI UX Design Agency in Đắk Nông, Vietnam | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Đắk Nông, Vietnam. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-ak-nong-vietnam';
$ogTitle      = 'UI UX Design Agency in Đắk Nông, Vietnam | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Đắk Nông, Vietnam? UX Pacific delivers modern, user-focused digital solutions.';
