...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Gabon ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Gabon</h2>
      <p class="hub-sub">We serve 9 regions, states, and cities in Gabon. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
