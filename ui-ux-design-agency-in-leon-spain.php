...
$pageTitle    = 'UI UX Design Agency in Léon, Spain | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Léon, Spain. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-leon-spain';
$ogTitle      = 'UI UX Design Agency in Léon, Spain | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Léon, Spain? UX Pacific delivers modern, user-focused digital solutions.';
