<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Santa Catarina, Cape Verde | UX Pacific';
$pageDesc        = 'Law 133/V/2001-aware UI/UX design for businesses in Santa Catarina, Cape Verde. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Santa Catarina, UI UX Agency Santa Catarina, UX Design Santa Catarina Cape Verde, UX Research Santa Catarina, UX Audit Santa Catarina, Usability Testing Santa Catarina, UX Agency Santa Catarina';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-santa-catarina-cape-verde';
$ogTitle         = 'UI UX Design Agency in Santa Catarina, Cape Verde | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving Santa Catarina, Cape Verde. Law 133/V/2001-compliant. UX research, usability testing, and product design. Get a free au';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-santa-catarina-cape-verde';
$ogImage         = 'https://www.uxpacific.com/img/og-cape-verde.jpg';
$ogLocale        = 'pt_CV';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Santa Catarina, Cape Verde?', 'a' => 'Yes. UX Pacific works with businesses in Santa Catarina remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Cape Verde, including Santa Catarina.'],
  ['q' => 'How does Law 133/V/2001 affect UX design for businesses in Santa Catarina?', 'a' => 'Law 133/V/2001 shapes how consent flows, privacy notices, and data collection forms are designed. We integrate Law 133/V/2001 requirements from day one, building user trust through transparent UX patterns rather than treating compliance as an afterthought.'],
  ...
  ['q' => 'How quickly do you respond to enquiries from Santa Catarina?', 'a' => 'We respond to all qualified enquiries within one business day. We work across CVT (UTC-1) and are flexible on meeting times. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-santa-catarina-cape-verde#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-santa-catarina-cape-verde",
            "name": "UI UX Design Agency in Santa Catarina, Cape Verde | UX Pacific",
            "description": "Research-led UI/UX design agency serving Santa Catarina, Cape Verde with UX research, usability testing, and Law 133/V/2001-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Santa Catarina",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-santa-catarina-cape-verde"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Santa Catarina, Cape Verde",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Santa Catarina, Cape Verde
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Santa Catarina</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping businesses in Santa Catarina, Cape Verde make better product decisions through UX Research, Usability Testing, Product Discovery and Human-Centered UI Design. Law 133/V/2001-compliant. IST-friendly remote collaboration.</p>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Santa Catarina, Cape Verde</h2>
      <p class="t2-sub">Every engagement begins with users, evidence, and business goals. We serve companies in Santa Catarina remotely — with structured UX research, usability testing, UI design, and Law 133/V/2001-compliant product design.</p>
      ...
      <div class="t2-grid t2-grid-3">
        ...
        <div class="t2-svc">
          ...
          <p>Design to WCAG 2.1 AA standards — ensuring your product is usable by every member of your audience in Santa Catarina.</p>
        </div>
      </div>
    </div>
    ...
    <div class="t2-wrap t2-section">
      ...
      <p class="t2-sub">Common questions from businesses in Santa Catarina, Cape Verde exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Santa Catarina, Cape Verde?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Santa Catarina remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Cape Verde, including Santa Catarina.</div>
        </div>
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">How does Law 133/V/2001 affect UX design for businesses in Santa Catarina?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
