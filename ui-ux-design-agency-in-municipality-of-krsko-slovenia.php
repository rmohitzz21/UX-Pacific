...
$countrySlug = 'municipality-of-krsko-slovenia';
...
$pageTitle    = 'UI UX Design Agency in Municipality of Krško, Slovenia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Municipality of Krško, Slovenia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-municipality-of-krsko-slovenia';
$ogTitle      = 'UI UX Design Agency in Municipality of Krško, Slovenia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Municipality of Krško, Slovenia? UX Pacific delivers modern, user-focused digital solutions.';
