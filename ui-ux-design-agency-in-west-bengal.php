...
$pageTitle    = 'UI UX Design Agency in West Bengal | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in West Bengal. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-west-bengal';
$ogTitle      = 'UI UX Design Agency in West Bengal | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in West Bengal? UX Pacific delivers modern, user-focused digital solutions.';
