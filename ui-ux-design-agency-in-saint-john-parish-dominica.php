<?php
// <!-- tier2-v1 -->
$pageTitle       = 'UI UX Design Agency in Saint John Parish, Dominica | UX Pacific';
$pageDesc        = 'ECSC Model Law-aware UI/UX design for businesses in Saint John Parish, Dominica. UX research, usability testing & product design. Book a free audit.';
$metaKeywords    = 'UI UX Design Saint John Parish, UI UX Agency Saint John Parish, UX Design Saint John Parish Dominica, UX Research Saint John Parish, UX Audit Saint John Parish, Usability Testing Saint John Parish, UX Agency Saint John Parish';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-saint-john-parish-dominica';
$ogTitle         = 'UI UX Design Agency in Saint John Parish, Dominica | UX Pacific';
$ogDesc          = 'Research-led UI/UX design agency serving Saint John Parish, Dominica. ECSC Model Law-compliant. UX research, usability testing, and product design. Get a free a';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-saint-john-parish-dominica';
$ogImage         = 'https://www.uxpacific.com/img/og-dominica.jpg';
$ogLocale        = 'en_DM';
$currentPage     = '';
$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Saint John Parish, Dominica?', 'a' => 'Yes. UX Pacific works with businesses in Saint John Parish remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Dominica, including Saint John Parish.'],
...
$ldJson          = '{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "@id": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-john-parish-dominica#webpage",
            "url": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-john-parish-dominica",
            "name": "UI UX Design Agency in Saint John Parish, Dominica | UX Pacific",
            "description": "Research-led UI/UX design agency serving Saint John Parish, Dominica with UX research, usability testing, and ECSC Model Law-compliant product design.",
            "inLanguage": "en",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Saint John Parish",
                    "item": "https://www.uxpacific.com/ui-ux-design-agency-in-saint-john-parish-dominica"
                }
            ]
        },
        {
        ...
        {
            "@type": "Service",
            "name": "UI/UX Design Services in Saint John Parish, Dominica",
            "provider": {
                "@id": "https://www.uxpacific.com/#organization"
            },
            "areaServed": {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Saint John Parish, Dominica
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Saint John Parish</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping businesses in Saint John Parish, Dominica make better product decisions through UX Research, Usability Testing, Product Discovery and Human-Centered UI Design. ECSC Model Law-compliant. IST-friendly remote collaboration.</p>
    ...
    <div class="t2-wrap t2-section">
      ...
      <h2 class="t2-h2">Research-Led UX Design for Businesses in Saint John Parish, Dominica</h2>
    ...
    <div class="t2-wrap t2-section">
      ...
      <p class="t2-sub">Common questions from businesses in Saint John Parish, Dominica exploring UI/UX design and user research services.</p>
      <div class="t2-faq-list" id="t2FaqList">
        <div class="t2-faq-item">
          <button class="t2-faq-q" type="button" aria-expanded="false">Do you provide UI UX design services in Saint John Parish, Dominica?<span class="t2-faq-icon" aria-hidden="true">+</span></button>
          <div class="t2-faq-a">Yes. UX Pacific works with businesses in Saint John Parish remotely — delivering UX research, UI design, usability testing, UX audits, product discovery, and design systems. We serve clients across all of Dominica, including Saint John Parish.</div>
        </div>
        <div class="t2-faq-item">
