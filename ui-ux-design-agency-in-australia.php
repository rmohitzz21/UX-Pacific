...
$pageTitle       = 'UI UX Design Agency in Australia | UX Pacific';
$pageDesc        = 'UX Pacific delivers expert UI/UX design services across Australia. Browse our locations or book a free UX audit today.';
$metaKeywords    = 'UI UX Design Australia, UI UX Agency Australia, UX Design Australia, UX Research Australia, UI Design Australia, Product Design Australia, UX Audit Australia, Usability Testing Australia, UX Consultant Australia, UX Company Australia, Design System Australia';
...
$canonicalUrl    = 'https://www.uxpacific.com/ui-ux-design-agency-in-australia';
$ogTitle         = 'UI UX Design Agency in Australia | UX Pacific';
$ogDesc          = 'UX Pacific delivers expert UI/UX design services across Australia. Browse our locations or book a free UX audit today.';
$ogUrl           = 'https://www.uxpacific.com/ui-ux-design-agency-in-australia';
$ogImage         = 'https://www.uxpacific.com/img/og-australia.jpg';
$ogLocale        = 'en_AU';
$currentPage     = '';

$_gFaqs = [
  ['q' => 'Do you provide UI UX design services in Australia?', 'a' => 'Yes. UX Pacific supports Australia businesses remotely with UX research, UI design, usability testing, UX audits, product discovery, and design systems, serving businesses across all major regions of Australia.'],
  ['q' => 'How does Privacy Act 1988 affect UX design for Australia businesses?', 'a' => 'Privacy Act 1988 directly shapes consent flows, data collection forms, and privacy communications. We integrate Privacy Act 1988 requirements into the design process from day one, building trust through honest UX patterns rather than treating compliance as an afterthought.'],
  ['q' => 'Can you design multilingual and localised interfaces for Australia?', 'a' => 'Yes. We design for local language and cultural requirements from the first wireframe, not as a retrofit after an English design is finalised. All layout, text expansion, and regional adaptations are considered from the start.'],
  ['q' => 'Can you work with startups and scaleups in Australia?', 'a' => 'Yes. We work with early-stage startups through to growth-stage scaleups across Australia. Our sprint-based model adapts to startup timelines and budgets without sacrificing research quality or design rigour.'],
  ['q' => 'How much does UX design cost for a Australia business?', 'a' => 'Investment ranges from around $5,000 for a focused audit to $50,000+ for a full product design engagement, depending on scope. We offer transparent, milestone-based pricing. Contact us for a scoped estimate.'],
  ['q' => 'Does UX Pacific design for Australia accessibility standards like DDA / WCAG 2.1?', 'a' => 'Yes. We design to DDA / WCAG 2.1 as standard — ensuring your product is accessible and meets the relevant regulatory requirements for Australia. Accessible design is built into our core process, not offered as an optional add-on.'],
  ...
  ['q' => 'Can you sign an NDA before we discuss our project?', 'a' => 'Yes. We sign an NDA before any confidential product, user, or business information is shared, in line with the data protection standards Australia businesses expect.'],
  ['q' => 'How does remote collaboration work for Australia clients?', 'a' => 'We use Figma for shared design workspaces, structured workshops via video, and async updates between sessions. Australia clients consistently find our process more organised than many local agency relationships.'],
  ['q' => 'How quickly do you respond to project enquiries from Australia?', 'a' => 'We respond to all qualified enquiries within one business day. Book a free UX audit via the button on this page to start immediately.'],
];
...
$ldJson = json_encode([
  ...
  '@graph'   => [
    [
      '@type'         => 'WebPage',
      '@id'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-australia#webpage',
      'url'           => 'https://www.uxpacific.com/ui-ux-design-agency-in-australia',
      'name'          => 'UI UX Design Agency in Australia | UX Pacific',
      'description'   => 'UX Pacific delivers expert UI/UX design services across Australia. Browse our locations or book a free UX audit today.',
      'inLanguage'    => 'en',
    ...
    [
      '@type'       => 'Service',
      'name'        => 'UI/UX Design Services in Australia',
...
$hubChildren = [
  ['name' => 'Australian Capital Territory', 'url' => '/ui-ux-design-agency-in-australian-capital-territory-australia', 'basename' => 'ui-ux-design-agency-in-australian-capital-territory-australia'],
  ['name' => 'New South Wales', 'url' => '/ui-ux-design-agency-in-new-south-wales-australia', 'basename' => 'ui-ux-design-agency-in-new-south-wales-australia'],
  ['name' => 'Northern Territory', 'url' => '/ui-ux-design-agency-in-northern-territory-australia', 'basename' => 'ui-ux-design-agency-in-northern-territory-australia'],
  ['name' => 'Queensland', 'url' => '/ui-ux-design-agency-in-queensland-australia', 'basename' => 'ui-ux-design-agency-in-queensland-australia'],
  ['name' => 'South Australia', 'url' => '/ui-ux-design-agency-in-south-australia-australia', 'basename' => 'ui-ux-design-agency-in-south-australia-australia'],
  ['name' => 'Sydney', 'url' => '/ui-ux-design-agency-in-sydney-australia', 'basename' => 'ui-ux-design-agency-in-sydney-australia'],
  ['name' => 'Tasmania', 'url' => '/ui-ux-design-agency-in-tasmania-australia', 'basename' => 'ui-ux-design-agency-in-tasmania-australia'],
  ['name' => 'Victoria', 'url' => '/ui-ux-design-agency-in-victoria-australia', 'basename' => 'ui-ux-design-agency-in-victoria-australia'],
  ['name' => 'Western Australia', 'url' => '/ui-ux-design-agency-in-western-australia-australia', 'basename' => 'ui-ux-design-agency-in-western-australia-australia'],
];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrapper" style="position:relative;overflow:hidden">
      ...
      <section class="hero">
        <div style="display:inline-block;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.04);padding:8px 20px;border-radius:40px;color:rgba(200,200,220,.8);font-size:13px;font-weight:500;letter-spacing:.05em;margin-bottom:24px;">
          Research-Led UI UX Design Agency Serving Australia
        </div>
        <h1 id="heading">UI UX DESIGN AGENCY<br /><span style="font-weight:800">IN Australia</span></h1>
        <p class="subtext" style="max-width:780px;margin:0.4rem auto 0;line-height:1.75;">Helping Australia startups, SaaS teams, SMEs and enterprises make better product decisions through UX Research, Market Research, Usability Testing, Product Discovery and Human-Centered UI Design.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">Every engagement begins with users, evidence, and business goals — not assumptions. Here is what that means in practice for Australia businesses.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">UI/UX Design Services for Australia Businesses</h2>
      ...
      <div class="de-grid de-grid-3">
        ...
        <div class="de-svc">
          ...
          <p>High-fidelity Figma screens and interactive prototypes — responsive across desktop and mobile, built to DDA / WCAG 2.1 standards, ready for developer handoff.</p>
        </div>
        <div class="de-svc">
          <h3>Privacy Act 1988-Compliant UX</h3>
          <p>Consent flows, cookie banners, data collection forms, and privacy communication designed to meet Australia regulatory requirements without harming the user experience.</p>
        </div>
        <div class="de-svc">
        ...
        <div class="de-svc">
          ...
          <p>Design to DDA / WCAG 2.1 standards — ensuring your product reaches every user and meets Australia regulatory accessibility requirements.</p>
        </div>
      </div>
    ...
    <div class="de-wrap de-section" id="framework">
      ...
      <div class="de-fw-grid">
        ...
        <div class="de-fw-step"><span class="de-fw-num">02 &mdash; Observe</span><h3>Research Real Users</h3><p>Interviews, surveys, usability sessions, and behavioural data collection — conducted with actual users in your target market across Australia.</p></div>
        ...
        <div class="de-fw-step"><span class="de-fw-num">05 &mdash; Design</span><h3>Create and Iterate</h3><p>Wireframes, high-fidelity UI screens, and interactive prototypes — designed to DDA / WCAG 2.1 standards and Privacy Act 1988-compliant interface patterns.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <div class="de-grid de-grid-3" style="margin-top:1.8rem">
        <div class="de-card"><div class="de-dlv-icon">&#128203;</div><h3>UX Audit Report</h3><p>A detailed written review of usability issues, conversion barriers, accessibility gaps, Privacy Act 1988 compliance risks, and navigation problems — each prioritised by business impact.</p></div>
        ...
        <div class="de-card"><div class="de-dlv-icon">&#128187;</div><h3>UI Screens</h3><p>High-fidelity Figma screens designed to DDA / WCAG 2.1 accessibility standards, responsive across desktop and mobile — production-quality from day one.</p></div>
      ...
      <div class="de-compare-wrap">
        <table class="de-compare">
          ...
          <tbody>
            ...
            <tr><td>Privacy Act 1988 and accessibility treated as afterthoughts</td><td>Privacy Act 1988 compliance and DDA / WCAG 2.1 accessibility designed in from day one</td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div class="de-wrap de-section" id="process">
      ...
      <div class="de-proc-grid">
        ...
        <div class="de-proc-card"><span class="de-proc-label">Step 05</span><h3>UI Design</h3><p>Craft modern, accessible, and scalable interfaces aligned with your brand and Privacy Act 1988 requirements.</p></div>
    ...
    <div class="de-wrap de-section">
      ...
      <h2 class="de-h2">Frequently Asked Questions — UI/UX Design in Australia</h2>
      <p class="de-sub">Common questions from Australia startups, SMEs, and enterprises exploring UI/UX design and user research services.</p>
    ...
    <div class="de-wrap de-section">
      ...
      <p class="de-sub">We serve businesses in 9 regions, states, and cities in Australia. Select your location to see how UX Pacific supports companies in your specific area.</p>
    ...
    <div class="de-wrap de-section">
      <div class="de-cta-box">
        ...
        <h2>Book a Free UX Audit for Your Australia Product</h2>
        ...
        <div class="de-process" style="text-align:left;margin-bottom:1.8rem">
          ...
          <div class="de-proc-step">
            ...
            <div><h4>We Review Your Product</h4><p>Our team evaluates usability, trust signals, conversion flow, and Privacy Act 1988 compliance.</p></div>
          </div>
          <div class="de-proc-step">
