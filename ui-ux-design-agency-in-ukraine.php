...
<html lang="en">
  ...
  <body>
    ...
    <!-- ── Hub: Browse all regions in Ukraine ── -->
    ...
    <div class="hub-section">
      <h2>Browse UI/UX Design Services Across Ukraine</h2>
      <p class="hub-sub">We serve 26 regions, states, and cities in Ukraine. Select a location to see how UX Pacific can help your business.</p>
      <div class="hub-grid">
