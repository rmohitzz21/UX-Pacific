...
$countrySlug = 'santo-domingo-de-los-tsachilas-ecuador';
...
$pageTitle    = 'UI UX Design Agency in Santo Domingo de los Tsáchilas, Ecuador | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Santo Domingo de los Tsáchilas, Ecuador. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-santo-domingo-de-los-tsachilas-ecuador';
$ogTitle      = 'UI UX Design Agency in Santo Domingo de los Tsáchilas, Ecuador | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Santo Domingo de los Tsáchilas, Ecuador? UX Pacific delivers modern, user-focused digital solutions.';
