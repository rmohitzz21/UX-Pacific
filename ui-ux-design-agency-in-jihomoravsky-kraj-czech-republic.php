...
$countrySlug = 'jihomoravsky-kraj-czech-republic';
...
$pageTitle    = 'UI UX Design Agency in Jihomoravský kraj, Czech Republic | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Jihomoravský kraj, Czech Republic. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-jihomoravsky-kraj-czech-republic';
$ogTitle      = 'UI UX Design Agency in Jihomoravský kraj, Czech Republic | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Jihomoravský kraj, Czech Republic? UX Pacific delivers modern, user-focused digital solutions.';
