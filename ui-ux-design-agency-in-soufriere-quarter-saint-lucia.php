...
$countrySlug = 'soufriere-quarter-saint-lucia';
...
$pageTitle    = 'UI UX Design Agency in Soufrière Quarter, Saint Lucia | UX Pacific';
$pageDesc     = 'UX Pacific offers professional UI/UX design services in Soufrière Quarter, Saint Lucia. We create user-friendly digital experiences for businesses.';
$canonicalUrl = 'https://www.uxpacific.com/ui-ux-design-agency-in-soufriere-quarter-saint-lucia';
$ogTitle      = 'UI UX Design Agency in Soufrière Quarter, Saint Lucia | UX Pacific';
$ogDesc       = 'Looking for UI UX design services in Soufrière Quarter, Saint Lucia? UX Pacific delivers modern, user-focused digital solutions.';
